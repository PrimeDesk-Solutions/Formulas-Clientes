		...
		if(eaa01 == null) {
			...
			if(eaa01.eaa01central == null) {
				...
				for(Eaa0103 eaa0103 : eaa0103s) {
					...
					if(camposLivresItem == null) throw new ValidacaoException("Existe algum item sem informações de campos livres no documento");
...
//							}
	...
	private void comporFilhosDocumento() {
		...
		if(eaa01.eaa01sitDoc == null ) interromper("O Documento " + abb01.abb01num.toString() + " encontra-se sem situação do documento informado.")
