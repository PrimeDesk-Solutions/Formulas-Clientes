...
class ImportarXmlNFe_Saida extends FormulaBase {
	...
	public void executar() {
		...
		if(det != null && det.size() > 0) {
			for(ElementXml elementnItem : det) {
				...
				uCom = uCom.toUpperCase().contains("CX") ? "CX" : uCom;
				...
				if(elementICMS00 != null) {
					String cst00 = "0" + elementICMS00.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst00 ", Parametro.criar("cst00", cst00))
					
					eaa0103.eaa0103cstIcms = aaj10;
				...
				if(elementICMS10 != null) {
					...
					String cst10 = "0" + elementICMS10.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst10 ", Parametro.criar("cst10", cst10))
				...
				if(elementICMS20 != null) {
					String cst20 = "0" + elementICMS20.getChildValue("CST");
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst20 ", Parametro.criar("cst20", cst20))
				...
				if(elementICMS30 != null) {
					String cst30 = "0" + elementICMS30.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst30 ", Parametro.criar("cst30", cst30))
				...
				if(elementICMS40 != null) {
					String cst40 = "0" + elementICMS40.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst40 ", Parametro.criar("cst40", cst40))
				...
				if(elementICMS51 != null) {
					String cst51 = "0" + elementICMS51.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst51 ", Parametro.criar("cst51", cst51))
				...
				if(elementICMS60 != null) {
					String cst60 = "0" + elementICMS60.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst60 ", Parametro.criar("cst60", cst60))
				...
				if(elementICMS70 != null) {
					String cst70 = "0" + elementICMS70.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst70 ", Parametro.criar("cst70", cst70))
					...
					setarValorJson(eaa0103json, getCampo("223-N16","pICMS"), obterValorXml(elementICMS70, "pICMS", 2));
					setarValorJson(eaa0103json, getCampo("223-N17","vICMS"), obterValorXml(elementICMS70, "vICMS", 2));
				...
				if(elementICMS90 != null) {
					String cst90 = "0" + elementICMS10.getChildValue("CST");
					
					// CST ICMS
					Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnico("SELECT * FROM aaj10 WHERE aaj10codigo = :cst90 ", Parametro.criar("cst90", cst90))
...
//				
//				Eaa0103 eaa0103 = obterItemDoDocumentoPelaSeqItemXml(eaa01, 1,uCom);
//				if(eaa0103 != null) {
//					TableMap eaa0103json = eaa0103.getEaa0103json();
//					
