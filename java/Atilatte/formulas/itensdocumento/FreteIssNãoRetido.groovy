...
private void calcularItem() {
	...
	// Converte Qt Venda para quantidade SCE
...
//		jsonEaa0103.put("desconto", (jsonEaa0103.getBigDecimal_Zero("qt_documento") * eaa0103.eaa0103unit * jsonEaa0103.getBigDecimal_Zero("desc_unit")) / 100);
//	}else if(jsonEaa0103.getBigDecimal_Zero("desc_unit") <= 0 && jsonEaa0103.getBigDecimal_Zero("desconto") > 0 ){
//		jsonEaa0103.put("desconto", (jsonEaa0103.getBigDecimal_Zero("desconto") / (jsonEaa0103.getBigDecimal_Zero("qt_documento") * eaa0103.eaa0103unit)) * 100);
//	}else{
//		jsonEaa0103.put("desconto", 0);
//	}
	...
	if(jsonEaa0103.getBigDecimal_Zero("ipi") == 0 ){
		jsonEaa0103.put("ipi_isento",  eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") +
	...
	// Pessoas fisicas ou não contribuinte- Não tem redução de base cálculo de ICMS
	...
	if(jsonEaa0103.getBigDecimal_Zero("icms") == 0){
		jsonEaa0103.put("icms_isentas",  eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") +
		jsonEaa0103.getBigDecimal_Zero("seguro") +
		jsonEaa0103.getBigDecimal_Zero("outras_despesas"));
	}
	...
	//BC ISS
	jsonEaa0103.put("bc_iss", eaa0103.eaa0103total);
	...
	if(jsonEaa0103.getBigDecimal_Zero("_pis") == 0){
		if(jsonAbm0101.getBigDecimal_Zero("_pis") != null){
	...
	if(jsonEaa0103.getBigDecimal_Zero("_cofins") == 0){
		if(jsonAbm0101.getBigDecimal_Zero("_cofins") != null){
