...
public class PedidoVendaLeite extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            //Define Data de Entrega do Pedido de Acordo com Data de Entrega dos Itens
            eaa01.eaa01dtEntrega = eaa0103.eaa0103dtEntrega;
            ...
            //TotalItem(9) = QuantidadeVenda(1) * PreçoUnit(6)
            eaa0103.eaa0103total = jsonEaa0103.getBigDecimal_Zero("qt_convertida") * eaa0103.eaa0103unit;
            ...
            def aliq;
            TableMap registroCamposCustom = getAcessoAoBanco().buscarUnicoTableMap(sql, Parametro.criar("abm01id", abm01.abm01id), Parametro.criar("eaa0103tipo", eaa0103.eaa0103tipo), Parametro.criar("aac10id", aac10.aac10id));

            if (registroCamposCustom != null) {
                TableMap abg01camposcustom = registroCamposCustom.getTableMap("abg01camposcustom");
            ...
            if (eaa0103.eaa0103cstIcms != null) {
                ...
                if (aaj10_cstIcms.aaj10codigo.substring(1) == "51") {
                    ...
                    jsonEaa0103.put("_diferimento", 0);
                }
            }
            ...
            txdesc = jsonAbe01.getBigDecimal_Zero("tx_fixa");
            ...
            jsonEaa0103.put("_reduc_bcicms_sped", jsonEaa0103.getBigDecimal_Zero("_reduc_bc_icms"));
