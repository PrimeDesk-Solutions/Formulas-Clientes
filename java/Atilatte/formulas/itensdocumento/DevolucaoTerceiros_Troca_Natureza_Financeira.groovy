...
public class PedidoDeVendaIogurteCreme extends FormulaBase {
	...
	public void executar() {
		...
		private void calcularItem() {
			...
			//Define Quantidade Convertida com a Quantidade Comercial
			...
			//Converte CX para FR
			if(eaa0103.eaa0103umComl.aam06codigo == 'CX'){
				if(jsonAbm0101.getBigDecimal_Zero("cvdnf") == 0) throw new ValidacaoException("A capacidade volumétrica no cadastro do item " + abm01.abm01codigo + " é inválida. Necessário um valor diferente de zero.")
			...
			//}
				...
				if(jsonEaa0103.getString("umv") == 'UN'){
					if(jsonAbm0101.getBigDecimal_Zero("cvdnf") != null && jsonAbm0101.getBigDecimal_Zero("cvdnf") > 0 ){
				...
				//BC ICMS = Valor do Item + Frete + Seguro + Outras Desp. - Desconto Incondicional
			     ...
			     if(vareOuAtac != null){
					abe01camposcustom = vareOuAtac.getTableMap("abe01camposcustom");
			     }
...
//							interromper(jsonEaa0103.getBigDecimal_Zero("bc_icms_st").toString())
...
//								interromper(jsonEaa0103.getBigDecimal_Zero("vlr_icms_fcp_").toString())
							}
		...
		eaa0103.eaa0103totFinanc = eaa0103.eaa0103totDoc.round(2);
				...
				jsonEaa0103.put("bc_comissao", (eaa0103.eaa0103total - vlrtxdesc).round(2));    
