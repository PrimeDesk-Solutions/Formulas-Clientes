...
public class Acordo extends FormulaBase {
	...
	private void calcularItem() {
		...
		if (eaa0103.eaa0103qtComl > 0) {
			...
			// Define os representantes do documento de acordo com os representantes da entidade
			if(abe02 != null){
				if(abe02.abe02rep0 != null) eaa01.eaa01rep0 = abe02.abe02rep0;
				if(abe02.abe02rep1 != null) eaa01.eaa01rep1 = abe02.abe02rep1;
				if(abe02.abe02rep2 != null) eaa01.eaa01rep2 = abe02.abe02rep2;
				if(abe02.abe02rep3 != null) eaa01.eaa01rep3 = abe02.abe02rep3;
				if(abe02.abe02rep4 != null) eaa01.eaa01rep4 = abe02.abe02rep4;
			}

			// Representantes
			Abe01 abe01rep0 = eaa01.eaa01rep0;
			Abe01 abe01rep1 = eaa01.eaa01rep1;
			Abe01 abe01rep2 = eaa01.eaa01rep2;
			Abe01 abe01rep3 = eaa01.eaa01rep3;
			Abe01 abe01rep4 = eaa01.eaa01rep4;

			// Obtendo a taxa de comissão de cada representante
			eaa01.eaa01txComis0 = obterTaxaDoRepresentante(abe01rep0);
			eaa01.eaa01txComis1 = obterTaxaDoRepresentante(abe01rep1);
			eaa01.eaa01txComis2 = obterTaxaDoRepresentante(abe01rep2);
			eaa01.eaa01txComis3 = obterTaxaDoRepresentante(abe01rep3);
			eaa01.eaa01txComis4 = obterTaxaDoRepresentante(abe01rep4);
