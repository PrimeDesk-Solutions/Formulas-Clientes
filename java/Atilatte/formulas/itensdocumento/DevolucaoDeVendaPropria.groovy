...
public class DevolucaoDeVendaPropria extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        // CFOP
        if (eaa0103.eaa0103cfop == null) aaj15_cfop = getSession().get(Aaj15.class, Criterions.eq("aaj15codigo", "1410"));
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            //Verificando se a entidade é varejista ou atacadista
            ...
            jsonEaa0103.put("qt_convertida", eaa0103.eaa0103qtComl.round(2));
            ...
            eaa0103.eaa0103totDoc = eaa0103.eaa0103total +
                    ...
                    jsonEaa0103.getBigDecimal_Zero("vlr_icms_fcp_") - jsonEaa0103.getBigDecimal_Zero("desconto");
            ...
            jsonEaa0103.put("vlr_icms_dest", 0);
            jsonEaa0103.put("bc_icms_dest", 0);
            jsonEaa0103.put("_icms_dest", 0);
            jsonEaa0103.put("_part_destino", 0);
            jsonEaa0103.put("icmsremet", 0);
