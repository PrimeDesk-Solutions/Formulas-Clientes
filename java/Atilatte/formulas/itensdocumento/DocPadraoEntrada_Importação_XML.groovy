...
private void calcularItem() {
	if(eaa0103.eaa0103qtComl > 0 && eaa0103.eaa0103unit > 0 ){
		...
		if(abm1301.abm1301fcCU != null){
			eaa0103.eaa0103qtUso = eaa0103.eaa0103qtComl
		}else{
			throw new ValidacaoException("Não foi informado unidade de medida importada através do XML, no cadastro do item: " + abm01.abm01codigo)
		}
		...
		//Verifica se o PCD Gera Financeiro
	...
	//	jsonEaa0103.put("bc_icms", jsonEaa0103.getBigDecimal_Zero("bc_icms_sped"));
		...
		jsonEaa0103.put("_reduc_bcicms", jsonEaa0103.getBigDecimal_Zero("_reduc_bcicms_sped"));
		...
		jsonEaa0103.put("icmsisento", jsonEaa0103.getBigDecimal_Zero("icmsisento_sped"));
		...
		jsonEaa0103.put("icms_st", jsonEaa0103.getBigDecimal_Zero("icmsst_sped"));
		...
		//BC IPI SPED = BC IPI
		jsonEaa0103.put("bcipi", jsonEaa0103.getBigDecimal_Zero("bcipi_sped"));
