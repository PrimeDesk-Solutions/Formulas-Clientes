...
public class DocPadraoEntradaServicoRetido extends FormulaBase {
	...
	private void calcularItem() {
		if(eaa0103.eaa0103qtComl > 0){
			...
			throw new ValidacaoException("Esse item não está caracterizado como SERVIÇO!")
		}
	    ...
	    if(jsonAbm0101.getBigDecimal_Zero("_ir") != null){
			...
			//Base de Cálculo IR
	    		...
	    		throw new ValidacaoException("Insira a % de IR no item selecionado.");
	    	}
	    ...
	    if(jsonAbm0101.getBigDecimal_Zero("_inss") != null){
	    	...
	    	throw new ValidacaoException("Insira a % de INSS no item selecionado.");
	    }
	    ...
	    jsonEaa0103.put("total_servico", jsonEaa0103.getBigDecimal_Zero("total_servico").round(2))
	    ...
	    eaa0103.eaa0103total = jsonEaa0103.getBigDecimal_Zero("total_servico").round(2);
	    eaa0103.eaa0103totFinanc = jsonEaa0103.getBigDecimal_Zero("total_servico");
