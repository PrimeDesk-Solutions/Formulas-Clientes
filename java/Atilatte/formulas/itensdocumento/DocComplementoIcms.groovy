...
public class DocComplementoIcms extends FormulaBase {
    ...
    private void calcularItem() {
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            //Ordem de separação itens
            jsonEaa0103.put("ordem_separacao", jsonAbm0101.getInteger("ordem_separacao"));
            ...
            // DEfine o Total do Documento como ICMS ICMS
            eaa0103.eaa0103totDoc = jsonEaa0103.getBigDecimal_Zero("icms_st");

            //Verifica se o Item soma no Total do Item da NFe
            jsonEaa0103.put("soma_nfe", 1);

            //Verifica se o PCD Gera Financeiro e Cria o Valor no Campo Total Financeiro
