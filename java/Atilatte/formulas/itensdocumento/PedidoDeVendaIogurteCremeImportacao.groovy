...
public class PedidoDeVendaIogurteCremeImportacao extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if (jsonEaa0103.getBigDecimal_Zero("calculado") == 0) {
                // Converte a quantidade comercial para a quantidade de frascos
                if (jsonEaa0103.getString("umv") == 'CX') {
                    eaa0103.eaa0103qtComl = (eaa0103.eaa0103qtComl * jsonAbm0101.getBigDecimal_Zero("cvdnf")).round(2);
                }

                // Converte o preço unitario em frascos
                if (jsonEaa0103.getString("umv") == 'CX') {
                    eaa0103.eaa0103unit = (eaa0103.eaa0103unit / jsonAbm0101.getBigDecimal_Zero("cvdnf")).round(4);
                }
            ...
            // Peso Bruto
            if (abm01.abm01pesoLiq_Zero > 0) jsonEaa0103.put("peso_bruto", (eaa0103.eaa0103qtUso * abm01.abm01pesoBruto).round(2));

            // Peso Líquido
            if (abm01.abm01pesoBruto_Zero > 0) jsonEaa0103.put("peso_liquido", (eaa0103.eaa0103qtUso * abm01.abm01pesoLiq).round(2));

            // Quantidade de caixa e frasco
            if (jsonAbm0101.getBigDecimal_Zero("volume_caixa") == 0) throw new ValidacaoException("Volume Caixa no cadastro do item " + abm01.abm01codigo + " é inválido.")

            if (jsonEaa0103.getString("umv") == 'CX') {
                jsonEaa0103.put("caixa", eaa0103.eaa0103qtComl / jsonAbm0101.getBigDecimal_Zero("volume_caixa"));

                //Define Volume como sendo a quantidade de caixas
                jsonEaa0103.put("volumes", jsonEaa0103.getBigDecimal_Zero("caixa"));
            } else {
                def int fatorUM = jsonAbm0101.getBigDecimal_Zero("volume_caixa");
                def int qtd = eaa0103.eaa0103qtComl;
                def int caixa;
                def int frasco;
            ...
            if (jsonEaa0103.getString("umv") == 'CX') {
                jsonEaa0103.put("qt_convertida", jsonEaa0103.getBigDecimal_Zero("caixa"));
            } else {
            ...
            // Unitario convertido
            if (jsonEaa0103.getString("umv") == 'CX') {
                jsonEaa0103.put("unitario_conv", (eaa0103.eaa0103unit * jsonAbm0101.getBigDecimal_Zero("volume_caixa")).round(4))
            } else {
            ...
            jsonEaa0103.put("bc_icms", jsonEaa0103.getBigDecimal_Zero("total_conv") + jsonEaa0103.getBigDecimal_Zero("frete_dest") +
            ...
            eaa0103.eaa0103totDoc = jsonEaa0103.getBigDecimal_Zero("total_conv") + jsonEaa0103.getBigDecimal_Zero("ipi") +
            ...
            if (jsonAbe01.getBigDecimal_Zero("consufinal") == 0) {
                ...
                jsonEaa0103.put("carga_trib", (jsonEaa0103.getBigDecimal_Zero("bc_carga_trib") * jsonEaa0103.getBigDecimal_Zero("carga_trib_") / 100).round(2));
            }
            ...
            //Comissão
            jsonEaa0103.put("bc_comissao", eaa0103.eaa0103total);
...
// total de IBS
        ...
        if (aaj09.aaj09codigo == "200") {
            ...
            if (jsonAaj07clasTrib.getBigDecimal_Zero("perc_red_ibs_munic")) {
                jsonEaa0103.put("perc_red_ibs_munic", jsonAaj07clasTrib.getBigDecimal_Zero("perc_red_ibs_munic"))
                // Criar campo
            }
