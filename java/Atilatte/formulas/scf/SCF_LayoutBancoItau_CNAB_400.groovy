...
class SCF_LayoutBancoItau_CNAB_400 extends FormulaBase{
    ...
    public void executar() {
        ...
        for(Daa01 daa01 : daa01s) {
            ...
            txt.print(daa01json.getDate("dt_limite_desc") == null ? "000000" : daa01json.getDate("dt_limite_desc").format(PATTERN_DDMMYY)); //174-179
            ...
            //txt.print(abf01.abf01json.get("multa").multiply(100).intValue(), 13);												//011-023
		  txt.print(daa01json.getBigDecimal("multa") == null ? "0000000000000" : daa01json.getBigDecimal("multa").multiply(100).intValue(), 13);												//011-023
