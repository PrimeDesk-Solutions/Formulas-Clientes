...
class BradescoRemessa extends FormulaBase{
...
//		txt.print(abf01.abf01json.get(getCampo("0","cod_emp")), 20, (char) '0', true);                       	  				//027-046
		...
		for(Daa01 daa01 : daa01s) {
			...
			def multa = jsonDaa01.getBigDecimal_Zero("multa");
			//def semMulta = jsonDaa01.getBigDecimal("multa") == null || multa.equals(0);
			def semMulta = abf01.abf01json.get("multa") == null || multa.equals(0);
			txt.print(semMulta ? "0" : "2");																					//066-066
			txt.print(semMulta ? "0000" : abf01.abf01json.get("multa").multiply(100).intValue(), 4, (char) '0', true); 								//067-070
			...
			txt.print(abf01.abf01json.get("ident_ocorrencia"), 2);												//109-110
			...
			txt.print(jsonDaa01.getBigDecimal("juros") == null ? "0000000000000" : jsonDaa01.getBigDecimal("juros").multiply(100).intValue(), 13); //161-173
			//txt.print(jsonDaa01.getDate("dt_limite_desc") == null ? "000000" : jsonDaa01.getDate("dt_limite_desc").format(PATTERN_DDMMYY)); //174-179
			txt.print(jsonDaa01.getDate("dt_limite_desc") == null ? "000000" : jsonDaa01.getDate("dt_limite_desc") != null && jsonDaa01.getBigDecimal_Zero("desconto") == 0 ? "000000" : jsonDaa01.getDate("dt_limite_desc").format(PATTERN_DDMMYY)); //174-179
			txt.print(jsonDaa01.getBigDecimal("desconto") == null ? "0000000000000" : jsonDaa01.getBigDecimal("desconto").multiply(100).abs().intValue(), 13); //180-192
