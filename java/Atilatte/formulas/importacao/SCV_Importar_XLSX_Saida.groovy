...
public class SCV_Importar_XLSX_Saida extends FormulaBase {
        ...
        while(rowIterator.hasNext()) {
            ...
            if(registro == "01" || registro == "02"){
                if(registro == "01") { // 01 - "cabeça" do documento
                    ...
                    String abe01codigo = row.getCell(2).getStringCellValue();
                    String abd01codigo = row.getCell(3).getStringCellValue();
                    ...
                    int eaa0103seq = seqItem
                    Integer eaa0103tipo = 1
                    String eaa0103codigo = row.getCell(1).getStringCellValue();
                    BigDecimal eaa0103qtComl = new BigDecimal(row.getCell(2).getNumericCellValue())//new BigDecimal(row.getCell(2).getStringCellValue().replace(",", "."));
