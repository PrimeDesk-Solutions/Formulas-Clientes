...
public class ServletPedidosBloqueados extends ServletBase {
    ...
    public ResponseEntity<Object> executar() {
        ...
        UiDto dto = buscarComponenteCustomizado("Atilatte.paineis.scv.RecursoPedidosBloqueados.html",valores)
...
//meta-sis-eyJ0aXBvIjoicmVzb3VyY2UifQ==