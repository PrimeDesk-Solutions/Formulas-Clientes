...
public class CST_ordemEnvase extends RelatorioBase {
	...
	private List<TableMap>buscarDadosRelatorio(Long idDocIni, Long idDocFin, LocalDate[] datas, LocalDate[] datasEntrega, Integer numOpIni, Integer numOpFin){
		...
		Query query = getSession().createQuery ("select umuEnvase.aam06codigo as umuPrincipal, abb01num as numOrdem,abb01id, abp10codigo, baa01id,itemEnvase.abm01id,itemEnvase.abm01codigo as codigoItemEnvase, itemEnvase.abm01na as naItemEnvase, bab01qt as qtProduzir, baa01descr as descrPlano, abb01data as dataPlano,bab01dte as dataPrevPlano,bab01lote as lotePrincipal,bab01ctdti as ba10realdti, bab01cthri as ba10realhi, bab01cthrf as ba10realhf, umuEnvase.aam06codigo as unidade, "+
				"CAST(itemEnvase.abm01camposcustom ->>'desvio_1' AS numeric(10,2)) as desvio1, CAST(itemEnvase.abm01camposcustom ->>'desvio_2' AS numeric(10,2)) as desvio2,CAST(itemEnvase.abm01camposcustom ->>'desvio_3' AS numeric(10,2)) as desvio3, CAST(itemEnvase.abm01camposcustom ->>'desvio_4' AS numeric(10,2)) as desvio4,CAST(itemEnvase.abm01camposcustom ->>'desvio_5' AS numeric(10,2)) as desvio5,CAST(itemEnvase.abm01camposcustom ->>'desvio_6' AS numeric(10,2)) as desvio6,CAST(itemEnvase.abm01camposcustom ->>'desvio_7' AS numeric(10,2)) as desvio7,CAST(itemEnvase.abm01camposcustom ->>'desvio_8' AS numeric(10,2)) as desvio8, CAST(itemEnvase.abm01camposcustom ->>'desvio_9' AS numeric(10,2)) as desvio9, "+
				"itemComp.abm01tipo as tipoComponentePesagem,itemComp.abm01codigo as codItemComponentePesagem,itemComp.abm01na as naItemComponentePesagem,umuComp.aam06codigo as umuPesagem,bab01011lote as lotePesagem, bab01011validade as validadePesagem, bab0101qtp as qtPlanPesagem, bab01lote as loteEnvase from bab01  "+
