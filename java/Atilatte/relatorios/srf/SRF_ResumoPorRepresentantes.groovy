...
public class SRF_ResumoPorRepresentantes extends RelatorioBase {
    ...
    public DadosParaDownload executar() {
        ...
        if(impressao == 0) return gerarPDF("SRF_ResumoPorRepresentantes(PDF)",documentos);
        return gerarXLSX("SRF_ResumoPorRepresentantes(Excel)",documentos);
    }
    ...
    private List<TableMap> buscarDadosDocumentos(Long idRepresentante, Integer numDocIni, Integer numDocFin, List<Long> idsTipoDoc, List<Long> idsPcd, Integer resumoOperacao, LocalDate[] dtEmissao, LocalDate[] dtEntradaSaida,
        ...
        String sql =    "select "+campo1 + campo2 + campo3 + campo4 + campo5 + campo6 +
                        campoDev1 + campoDev2+ campoDev3+ campoDev4 + campoDev5 + campoDev6 +
