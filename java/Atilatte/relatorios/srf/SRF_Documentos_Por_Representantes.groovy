...
public class SRF_Documentos_Por_Representantes extends RelatorioBase {
    ...
    private List<TableMap> buscarDadosDocumentos(Long idRepresentante, Integer numDocIni, Integer numDocFin, List<Long> idsTipoDoc, List<Long> idsPcd, Integer resumoOperacao, LocalDate[] dtEmissao, LocalDate[] dtEntradaSaida,
        ...
        String sql =    "select aah01codigo as tipoDocNota, abb01num as numNota, abb01data as dtEmissaoNota, eaa01esdata as esDataNota,\n" +
                        " be01codigo as codEnt,abe01na as naEnt, abe30codigo as codCondPgto, abe30nome as nomeCondPgto,\n" +
                        "abe40nome as tabelaPreco, eaa0103qtcoml, eaa0103unit, eaa0103total,\n" +
                        "eaa0103totdoc,eaa0103totfinanc "+
