...
public class SRF_DocumentosDevolvidos extends RelatorioBase {
    ...
    private Long buscarGCEmpresaAtiva(String tabela, Long idEmpresa){
        ...
        Parametro parametroTabela = Parametro.criar("tabela", tabela);

        return getAcessoAoBanco().obterLong(sql, parametroEmpresa, parametroTabela);
    }
