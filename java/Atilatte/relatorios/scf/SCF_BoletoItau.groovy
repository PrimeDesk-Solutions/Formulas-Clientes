...
class SCF_BoletoItau extends RelatorioBase {
	Integer DAC = 0
	Integer peso = 2
	...
	public DadosParaDownload executar() {
		...
		if(eaa01id != null || daa01id != null ){
			List<Long> daa01ids = eaa01id != null ? buscarIdsDocsSCFPeloIdDocSRF(eaa01id) : new ArrayList();
			// ID documento vindo do botão customizado da tarefa SCF0101
			if(daa01id != null) daa01ids.add(daa01id)
