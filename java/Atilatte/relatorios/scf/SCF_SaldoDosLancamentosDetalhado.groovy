...
public class SCF_SaldoDosLancamentosDetalhado extends RelatorioBase {

    @Override
    public String getNomeTarefa() {
        return "SCF - Saldo dos Lançamentos (Detalhados)";
    }
    ...
    public DadosParaDownload executar() {
        ...
        params.put("titulo", "SCF - Saldo dos Lançamentos (Detalhado)" );

        if(impressao == 1 ) return gerarXLSX("SCF_SaldoDosLancamentosDetalhado_Excel", dados)
        return gerarPDF("SCF_SaldoDosLancamentosDetalhado_PDF", dados, "codigoConta", isSaltarPagina)
    }
