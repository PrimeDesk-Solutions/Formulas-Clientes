...
public class CUBO_StatusPedidoVenda extends RelatorioBase {
    @Override
    public String getNomeTarefa() {
        return "CUBO - SRF - Status Pedido Venda";
    }
    @Override
    ...
    public DadosParaDownload executar() {
        ...
        return gerarXLSX("CUBO_StatusPedidoVenda",documentos)
    }
    ...
    private List<TableMap>dadosRelatorio(){
        ...
        sql = getSession().createQuery("select sum(bfc1001valor) as freteAgregado,cast(eaa01nota.eaa01json ->> 'valor_frete_redesp' as numeric(18,6)) as freteRedesp,TO_DATE(cast(eaa01nota.eaa01json ->> 'dt_entrega_redesp' as text), 'YYYYMMDD') as dtEntregaRedesp,eaa01nota.eaa01totdoc as totDocNota, cast(eaa01nota.eaa01json ->> 'peso_liquido' as numeric(16,2)) as pesoLiquidoNota,   "+
                ...
                whereOperDocumento +
                "group by dtEntregaRedesp,eaa01nota.eaa01totdoc, pesoLiquidoNota,   "+
                ...
                " numCarga, statusEntrega, codDepto,descrDepto,codMotivo, descrMotivo,bfc1002entrega,aag02uf, eaa01nota.eaa01hrentrega, eaa0115arquivo ")
...
//meta-sis-eyJkZXNjciI6IkNVQk8gLSBTUkYgLSBTdGF0dXMgUGVkaWRvIFZlbmRhIiwidGlwbyI6InJlbGF0b3JpbyJ9