...
public class servlet_entregasForaDoPrazo extends ServletBase {
	...
	public ResponseEntity<Object> executar() {
		...
		int percentualForaPrazo = 0;
		
		if(countForaPrazo > 0 && totEntregas > 0 ){
			percentualForaPrazo = (countForaPrazo / totEntregas) * 100;
		}
		
		Map<String, Object> valoresDefault = Utils.map("totalEntregas",countForaPrazo,
												"foraPrazo",percentualForaPrazo+"%")
		
		UiDto dto = buscarComponenteCustomizado("Atilatte.dashboards.slm.recurso_entregasForaDoPrazo.html", valoresDefault);
...
//meta-sis-eyJkZXNjciI6IkF0aWxhdHRlIC0gRW50cmVnYXMgRm9yYSBkbyBQcmF6byIsInRpcG8iOiJzZXJ2bGV0IiwidyI6NCwiaCI6NywicmVzaXplIjoidHJ1ZSIsInRpcG9kYXNoYm9hcmQiOiJjb21wb25lbnRlIn0=