...
public class CST_EtiquetaPadrao extends RelatorioBase {
    ...
    public DadosParaDownload executar() {
        ...
        return gerarPDF("CST_EtiquetaPadrao", tmEtiquetas);
    }
    ...
    private  buscarEtiquetasID(List<Long> ids){
        ...
        String sql = "select abm01codigo as coditem, abm01na as descrItem, abm70lote as lote, abm70num, abm70dv, abm70qt as qtd " +
                "from abm70 " +
                "inner join abm01 on abm01id = abm70item " +
...
//meta-sis-eyJkZXNjciI6IkNTVCAtIEV0aXF1ZXRhIFBhZHLDo28iLCJ0aXBvIjoicmVsYXRvcmlvIn0=