...
public class SCE_Lancamentos extends RelatorioBase {
	...
	public List<TableMap> obterDadosRelatorio (List<Long> idEntidade, List<Long> idTipoDocumento, List<Long> idPLE, LocalDate[] data, Integer movimentoEntSai, List<Long> criteriosItem, List<Integer> mpm, String itemIni, String itemFim,List<Long>idsStatus,List<Long>idsLocal,String loteIni,String loteFin,String serieIni,String serieFin, Integer numDocIni, Integer numDocFin) {
		...
		String sql = " select distinct aah01.aah01codigo,aah01.aah01na, aam04.aam04codigo, aam06.aam06codigo, abb11.abb11codigo, abm01.abm01codigo, " +
				"   abm01.abm01na, abm01.abm01tipo, abm20.abm20codigo, abm20.abm20descr," +
				"   (cast(abm0101json ->> 'precolivre' as numeric(18,6)) * bcc01.bcc01qt) as bcc01custo, " +
				"   bcc01.bcc01data, cast(abm0101json ->> 'precolivre' as numeric(18,6)) as bcc01pmu, bcc01.bcc01qt, bcc01.bcc01qtPS, bcc01.bcc01mov," +
				...
				"   ent.abe01codigo as codEnt, ent.abe01na as naEnt, abb01pedido.abb01num as numPedido,bcc01.bcc01id "+
				"  from bcc01 bcc01" +
				...
				"  left join eaa01 as eaa01nota on eaa01nota.eaa01central = doc.abb01id " +
				"  left join eaa0103 as eaa0103nota on eaa0103nota.eaa0103doc = eaa01nota.eaa01id " +
