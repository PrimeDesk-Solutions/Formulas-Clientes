...
public class SPP_FichaEngenhariaProdutos extends RelatorioBase {
	...
	public Map<String, Object> criarValoresIniciais() {
		   Map<String,Object> filtrosDefault = new HashMap()
	        ...
	        filtrosDefault.put("chkPrecoItem","0");
	...
	public DadosParaDownload executar() {
		...
		if(chkPrecoItem){
			switch(precoItem){
				case 0: 
					wherePrecoItem = "cast(confComponente.abm0101json ->> 'custo' as numeric(18,2)) as valorItem ";
					break;
				case 1: 
					wherePrecoItem = "confComponente.abm0101pmu as valorItem ";
					break;
				case 2: 
					wherePrecoItem = "cast(confComponente.abm0101json ->> 'maior_preco_unit' as numeric(18,2)) as valorItem ";
					break;
				case 3: 
					wherePrecoItem = "cast(confComponente.abm0101json ->> 'menor_preco_unit' as numeric(18,2)) as valorItem ";
					break;
				case 4: 
					wherePrecoItem = "cast(confComponente.abm0101json ->> 'ultimo_preco' as numeric(18,2)) as valorItem ";
					break;
			}
		}
	...
	private buscarDadosGerais(List<TableMap> idsItens, String wherePrecoItem, Integer quantidade){
		String whereItens = idsItens != null && idsItens.size() > 0 ? "where abp20item in (:idsItens) " : "";
		Parametro parametroItens = idsItens != null && idsItens.size() > 0 ? Parametro.criar("idsItens",idsItens) : null;
