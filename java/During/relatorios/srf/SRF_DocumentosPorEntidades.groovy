...
public class SRF_DocumentosPorEntidades extends RelatorioBase {
    ...
    public DadosParaDownload executar() {
        ...
        List<TableMap> documentos = buscarDocumentos(numDocIni, numDocFin, idsTipoDoc, idsPcd,resumoOperacao, dtEmissao, dtEntradaSaida, idsEntidades,
                                                        optionResumo,idsItens,idEmpresa);
        def totalGeral1 = 0;
        def totalGeral2 = 0;
        def totalGeral3 = 0;
        ...
        if(impressao == 0) return gerarPDF("SRF_DocumentosPorEntidades",documentos);      
    ...
    private buscarDocumentos(Integer numDocIni, Integer numDocFin,List<Long>idsTipoDoc,List<Long> idsPcd,Integer resumoOperacao, LocalDate[] dtEmissao, 
                                    LocalDate[] dtEntradaSaida,List<Long> idsEntidades,Integer optionResumo,List<Long>idsItens,Long idEmpresa){
        //Data Emissao
        ...
        String sql = "select aag02uf as estado, aag0201nome as municipio, aah20placa as placa,eaa01id,abb01num,abb01data, eaa01esdata, ent.abe01codigo as codEnt, ent.abe01na as naEnt, "+
                "rep.abe01na as naRep,aah01codigo,abe30nome,abe40nome,aaj15codigo,eaa01json, "+
                ...
                "rep.abe01na,aah01codigo,abe30nome,abe40nome,aaj15codigo,eaa01json "
