...
class SRF_ResumoPorCfop extends RelatorioBase {
	@Override
	...
	public DadosParaDownload executar() {
		...
		List<TableMap> dados = buscarDocumentos(numeroInicial,numeroFinal,dataEmissao,dataEntSai,resumoOperacao,cfops,pcd,camposLivre1,camposLivre2,camposLivre3,camposLivre4,camposLivre5,camposLivre6);
...
//			}
		...
		if(imprimir == 1) return gerarXLSX("SRF_ResumoPorCFOP_Excel",dados);
		return gerarPDF("SRF_ResumoPorCFOP",dados)
	}

	private List<TableMap> buscarDocumentos(Integer numeroInicial,Integer numeroFinal,LocalDate[] dataEmissao,LocalDate[] dataEntSai,Integer resumoOperacao,List<Long>cfops,List<Long>pcd,
