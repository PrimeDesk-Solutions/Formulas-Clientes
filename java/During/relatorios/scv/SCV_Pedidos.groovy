...
public class SCV_Pedidos2 extends RelatorioBase {
    ...
    public DadosParaDownload executar() {
        ...
        List<TableMap> dados = buscarDocumentos(tipos, numeroInicial, numeroFinal, entidades, pedEntSai, emissao, entrega, atendimento, numeroCliente);
        ...
        return gerarPDF("SCV_Pedidos", dados)

    }

    private List<TableMap> buscarDocumentos(List<Long> tipos, Integer numeroInicial, Integer numeroFinal, List<Long> entidades, Integer pedEntSai, LocalDate[] emissao, LocalDate[] entrega, List<Integer> atendimento, String numeroCliente) {
        ...
        String sql = "select " + campo1 + campo2 + campo3 + campo4 +
                    " eaa01id, eaa0103nota.eaa0103id, abb01num,abb01serie, abb01data, abe01codigo, abe01na, abm01codigo, abm01na, " +
                    ...
                    whereTipos + whereEntidades + whereCompVenda + whereEmissao + whereNumIni + whereNumFim + whereEntrega + whereAtendimento + whereNumCliente +
                    "order by abb01num ";
        ...
        return getAcessoAoBanco().buscarListaDeTableMap(sql,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10)
    }
