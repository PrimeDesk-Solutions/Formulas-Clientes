...
public class SCV_ImpressaoPedidoDeCompraNacional extends RelatorioBase {
    @Override
    public String getNomeTarefa() {
        return "SCV - Impressão Pedido De Compra Nacional";
    }
    @Override
    ...
    public DadosParaDownload executar() {
        ...
        adicionarParametro("SUBREPORT_DIR1", carregarArquivoRelatorio("IDM_PEDIDO_COMPRA_NACIONAL_s1"))

        return gerarPDF("IDM_PEDIDO_COMPRA_NACIONAL", dsPrincipal)
    }
    ...
    private List<TableMap> buscarDadosRealatorio(Integer numInicial,Integer numFinal, LocalDate[] dtEmissao,List<Long> entidades){
        ...
        String sql = "select distinct eaa01totdoc, abb01id, eaa01id as idDoc,abb01num as numDoc, abe01codigo as codEntidade, abe01nome as nomeEntidade, abe0101ddd1 as ddd, abe0101fone1 as foneEntidade, abe01ni as cnpj,\n" +
    ...
    private List<TableMap> buscarItensDoc(Long idDoc){
        String sql = "SELECT  eaa0103seq, abm01codigo as codItem, abm01livre, abm01na as naItem, cast(eaa0103json ->> 'ft' as text) as numFt, aam06codigo as unidadeMedida, eaa0103qtComl as qtdItem, "+
                ...
                "cast(eaa0103json ->> 'aliq_ipi' as numeric(18,6)) as aliq_ipi, "+
...
//meta-sis-eyJkZXNjciI6IlNDViAtIEltcHJlc3PDo28gUGVkaWRvIERlIENvbXByYSBOYWNpb25hbCIsInRpcG8iOiJyZWxhdG9yaW8ifQ==
//meta-sis-eyJkZXNjciI6IlNDViAtIEltcHJlc3PDo28gUGVkaWRvIERlIENvbXByYSBOYWNpb25hbCIsInRpcG8iOiJyZWxhdG9yaW8ifQ==