/*
    Copia da formula 'SCV_SRF_DocPadrao_Entrada_OutrasIcm_IpiSPED_SPisCofins' para realizar alterações de impostos
    Solicitado pela responsável Daniela - 10/06
*/
...
public class SCV_SRF_DocPadrao_Entrada_OutrasIcm_IpiSPED_SPisCofins_V2 extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(jsonEaa0103.getBigDecimal_Zero("volumes") == 0){
                if(abm13.abm13fcVW == null) throw new ValidacaoException("Necessário informar fator de conversão de volume para cálculo de volumes do item "+ abm01.abm01codigo);
...
//            }
           ...
           calcularIPI();
            ...
            if(jsonEaa0103.getBigDecimal_Zero("icms") == 0){
                jsonEaa0103.put("icms_outras", (eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("ipi")).round(2));
