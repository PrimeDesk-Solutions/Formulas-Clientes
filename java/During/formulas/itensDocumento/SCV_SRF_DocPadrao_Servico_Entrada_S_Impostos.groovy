/*
	Cópia da formula 'SCV_SRF_DocPadrao_Servico_Entrada' para retirar os impostos do documentos, conforme solicitado pela
	colaboradora Daniela - 10/06
*/
...
public class SCV_SRF_DocPadrao_Servico_Entrada extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(jsonEaa0103.getBigDecimal_Zero("volumes") == 0){
                jsonEaa0103.put("volumes", eaa0103.eaa0103qtComl * abm13.abm13fcUV );
            }
            ...
            if(abm01.abm01tipo == 3 ){
                jsonEaa0103.put("servicos_item",round((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit) - jsonEaa0103.getBigDecimal_Zero("desconto"),2));
            ...
            eaa0103.eaa0103totDoc = round(jsonEaa0103.getBigDecimal_Zero("total_servico") - jsonEaa0103.getBigDecimal_Zero("iss"), 2);

            // Total Financeiro
            //if(aam01 == null) throw new ValidacaoException("Não foi informado classe no cadastro do item "+abm01.abm01codigo+" para gerar valor do financeiro")

//            if(aam01.aam01codigo != "01"){ // Itens Não Importados
