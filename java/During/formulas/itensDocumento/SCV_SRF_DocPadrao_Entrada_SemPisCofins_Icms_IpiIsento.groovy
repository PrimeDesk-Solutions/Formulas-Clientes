...
public class SCV_SRF_DocPadrao_Entrada_SemPisCofins_Icms_IpiIsento extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // Outras de ICMS
            jsonEaa0103.put("icms_isento", eaa0103.eaa0103total.round(2));
            jsonEaa0103.put("ipi_isento", eaa0103.eaa0103total.round(2));
