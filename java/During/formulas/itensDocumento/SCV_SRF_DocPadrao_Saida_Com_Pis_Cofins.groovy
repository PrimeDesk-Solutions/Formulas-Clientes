...
public class SCV_SRF_DocPadrao_Saida_Com_Pis_Cofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(abm13.abm13fcUV == null ) throw new ValidacaoException("Necessário informar fator de conversão de uso para venda no item "+ abm01.abm01codigo);

            eaa0103.eaa0103qtUso = round((eaa0103.eaa0103qtComl * abm13.abm13fcUV),2);


            // Converte quantidade comercial para volumes
            ...
            jsonEaa0103.put("qtd_tribut", eaa0103.eaa0103unit);
            ...
            // Total Do Documento sem ST = Total Item + IPI + Frete + Seguro + Outras Despesas - Desconto incond
            ...
            // Zera Base de Calculo ICMS se Aliquota Menor que Zero
            ...
            // Chamada para a funnção de calculo de IPI
            calcularIPI();
            ...
            // Isentas de ICMS
            if(jsonEaa0103.getBigDecimal_Zero("bc_icms") < eaa0103.eaa0103totDoc){
                jsonEaa0103.put("icms_isento", round(eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("bc_icms"),2))
            }

            // Total Do Documentos com ST
            if(jsonEaa0103.getBigDecimal_Zero("icms_st") > 0 ){
                jsonEaa0103.put("total_doc_st", eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("icms_st"));
                jsonEaa0103.put("total_doc_st", round(jsonEaa0103.getBigDecimal_Zero("total_doc_st"),2));
                eaa0103.eaa0103totDoc = round(eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("icms_st"),2);
            }

            // Chamada para calculo de desoneração
            calcularDesoneracao();
            ...
            // Total Liquido
            jsonEaa0103.put("total_liquido", eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms") - jsonEaa0103.getBigDecimal_Zero("pis") - jsonEaa0103.getBigDecimal_Zero("cofins") - jsonEaa0103.getBigDecimal_Zero("iss"));
    ...
    private void calcularIPI(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("_ipi") != -1){
            if (eaa0103.eaa0103cstIpi != null) {
                ...
                jsonEaa0103.put("bc_ipi", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("outras_despesas"));
            ...
            if(jsonAbm0101.getBigDecimal_Zero("_red_bc_ipi") > 0){
                jsonEaa0103.put("ipi",jsonEaa0103.getBigDecimal_Zero("ipi") * (100 - jsonAbm0101.getBigDecimal_Zero("_red_bc_ipi")) / 100);
                jsonEaa0103.put("ipi",round(jsonEaa0103.getBigDecimal_Zero("ipi"),2));
            }
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        jsonEaa0103.put("bc_icms", round((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas")),2) )
        ...
        // Pessoas Fisicas ou não contribuinte - Não tem redução da base de Calculo
        if(abe01.abe01ti == 1 && contribICMS == 0){
            jsonEaa0103.put("_red_bc_icms", -1);
        }

        // Calculo da Redução
        if(jsonEaa0103.getBigDecimal_Zero("_red_bc_icms") > 0 ){
            vlrReducao = round((jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("_red_bc_icms") / 100),2);
            jsonEaa0103.put("vlrntriredbcspd",vlrReducao);
            jsonEaa0103.put("bc_icms", round((jsonEaa0103.getBigDecimal_Zero("bc_icms") - vlrReducao),2));
        }

        // Obtendo a Aliquota de ICMS
        if(aam01 != null && aam01.aam01codigo == "01"){ // Itens com classe não importado
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") < 0){
            ...
            jsonEaa0103.put("icms", round((jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("aliq_icms") / 100),2));
    ...
    // ========================================================================================
		...
		if (abb10.abb10tipoCod == 1) {
			if (abm12.abm12cstA == 3 || abm12.abm12cstA == 5 || abm12.abm12cstA == 8) {
				...
				if (eab0101 == null) {
					interromper("O item " + abm01.abm01codigo + " está sem ficha de FCI")
				} else {
					if (eab0101.eab0101numFCI == null) {
						interromper("O item " + abm01.abm01codigo + " está sem numero de FCI")
					}

					jsonEaa0103.put("nfci", eab0101.eab0101numFCI)
					jsonEaa0103.put("obs_nfci", "Resolução do senado federal 13/12 FCI: " + eab0101.eab0101numFCI + " CI: " + eab0101.eab0101ci)
    ...
    private void calcularICMSST(){
        ...
        //Alíquota do ICMS ST
        jsonEaa0103.put("_icms_st", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fixa_icms_st"));

        if(jsonEaa0103.getBigDecimal_Zero("bc_icms_st") == 0){
            jsonEaa0103.put("bc_icms_st", round((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas")),2) )
        }
        ...
        if(ivaST > 0){
            ...
            jsonEaa0103.put("icms_st", (jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * (ivaST / 100)) - jsonEaa0103.getBigDecimal_Zero("icms"))
            jsonEaa0103.put("icms_st", round(jsonEaa0103.getBigDecimal_Zero("icms_st"),2));
        }else{
    ...
    private void calcularPIS(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_pis") < 0){
            ...
            jsonEaa0103.put("pis",round(jsonEaa0103.getBigDecimal_Zero("pis"),2));
        }
    }
    private void calcularCOFINS(){
        ...
        jsonEaa0103.put("bc_cofins", eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms_st") - jsonEaa0103.getBigDecimal_Zero("icms"));
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_cofins") < 0){
            ...
            jsonEaa0103.put("cofins",round(jsonEaa0103.getBigDecimal_Zero("cofins"),2));
        }
    }

    private void calcularDesoneracao(){
        // Receita Bruta
        jsonEaa0103.put("receita_bruta", round(eaa0103.eaa0103totDoc,2));

        // Receita por Atividade
        jsonEaa0103.put("qt_custo_adicional", round(eaa0103.eaa0103totDoc,2))

        // Exclusões
        jsonEaa0103.put("exc_rec_bruta", round(jsonEaa0103.getBigDecimal_Zero("ipi"),2));
    }
    ...
    private void preencherSPEDS(){
        ...
        jsonEaa0103.put("_pis_sped", jsonEaa0103.getBigDecimal_Zero("_pis"));
