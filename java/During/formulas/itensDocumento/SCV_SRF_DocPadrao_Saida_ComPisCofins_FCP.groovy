...
public class SCV_SRF_DocPadrao_Saida_ComPisCofins_FCP extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(abm13.abm13fcVU == null ) throw new ValidacaoException("Necessário informar fator de conversão de venda para uso no item "+ abm01.abm01codigo);

            eaa0103.eaa0103qtUso = (eaa0103.eaa0103qtComl * abm13.abm13fcVU).round(2);
            ...
            if(jsonEaa0103.getBigDecimal_Zero("icms_st") > 0 ){
                ...
                jsonEaa0103.put("total_doc_st", jsonEaa0103.getBigDecimal_Zero("total_doc_st").round(2));
                eaa0103.eaa0103totDoc = jsonEaa0103.getBigDecimal_Zero("total_doc_st").round(2)
            }
            ...
            if (jsonEaa0103.getBigDecimal_Zero("ipi") == 0) {
                jsonEaa0103.put("ipi_outras", eaa0103.eaa0103totDoc.round(2));
            }else{
            ...
            if(jsonEaa0103.getBigDecimal_Zero("bc_icms") < eaa0103.eaa0103totDoc){
                jsonEaa0103.put("icms_isento", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("bc_icms")).round(2))
            }

            // Receita por Atividade
            jsonEaa0103.put("qt_custo_adicional", eaa0103.eaa0103totDoc);
    ...
    private void calcularICMSST(){
        ...
        if(ivaST != 0){
            ...
            ivaST = jsonEaa0103.getBigDecimal_Zero("aliq_icms_st");
        }
    ...
    private void calcularPIS(){
        ...
        jsonEaa0103.put("bc_pis", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms")).round(2));
    ...
    private void calcularCOFINS(){
        ...
        jsonEaa0103.put("bc_cofins", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms")).round(2));
    ...
    private void calcularFCP(){
        // Base Calculo FCP
        jsonEaa0103.put("bc_fcp", jsonEaa0103.getBigDecimal_Zero("icms"));

        // Aliquota FCP
        if(jsonAbm1001_UF_Item != null){
            if(jsonAbm1001_UF_Item.getBigDecimal_Zero("fcp") > 0){
                jsonEaa0103.put("fcp", jsonAbm1001_UF_Item.getBigDecimal_Zero("fcp") )
            }
        }

        // Calculo FCP
        jsonEaa0103.put("vlr_fcp", (jsonEaa0103.getBigDecimal_Zero("icms") * jsonEaa0103.getBigDecimal_Zero("fcp") / 100).round(2))
    }
