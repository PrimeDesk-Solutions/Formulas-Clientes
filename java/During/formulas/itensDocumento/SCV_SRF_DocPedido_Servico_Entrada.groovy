...
public class SCV_SRF_DocPedido_Servico_Entrada extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(jsonEaa0103.getBigDecimal_Zero("volumes") == 0){
                jsonEaa0103.put("volumes", round((eaa0103.eaa0103qtComl * abm13.abm13fcVW),2));
            }
            ...
            eaa0103.eaa0103total = round(jsonEaa0103.getBigDecimal_Zero("servicos_item"),2);
            ...
            // Total Documento
            eaa0103.eaa0103totDoc = round((jsonEaa0103.getBigDecimal_Zero("total_servico") + jsonEaa0103.getBigDecimal_Zero("ir")),2)
