...
public class SCV_SRF_DocSaida_Subst_Item extends FormulaBase {
    ...
    private void calcularICMSST(){
        ...
        jsonEaa0103.put("bc_icms_st", eaa0103.eaa0103total + (eaa0103.eaa0103total * jsonAbm1001_UF_Item.getBigDecimal_Zero("substituicao") / 100));

        jsonEaa0103.put("icms_st", ((jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fixa_icms") / 100) - jsonEaa0103.getBigDecimal_Zero("icms")).round(2));
