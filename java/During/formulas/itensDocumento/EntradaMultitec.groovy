		...
		if (eaa0103.eaa0103qtComl > 0 && eaa0103.eaa0103unit > 0) {
			...
			if (eaa0103.eaa0103cstIpi != null) {
				...
				if ((abm12.abm12tipo == 0 || abm12.abm12tipo == 7) || (aac13 != null && aac13.aac13classTrib != null && aac13.aac13classTrib.aaj01codigo == "2")) { //00 - Revenda, 07-Uso e Consumo e 2-Simples Nacional, excesso rec bruta
					...
					if (jsonEaa0103.getBigDecimal_Zero("aliq_ipi") > 0) {
						...
						if(abe01.abe01regTrib != 0) { //Só gera a obs IPI se fornecedor não é simples nacional
							...
							jsonEaa0103.put("ipi_obs", ((jsonEaa0103.getBigDecimal_Zero("bc_ipi") * jsonEaa0103.getBigDecimal_Zero("aliq_ipi")) / 100).round(2));
						}
					}
				}
				...
				if (aaj11_cstIpi.aaj11codigo == "00") {
					if (jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != 0) throw new ValidacaoException("CST indica entrada com recuperação de crédito, porém não foi informada a alíquota de IPI.");
				...
				if (aaj11_cstIpi.aaj11codigo == "02" || aaj11_cstIpi.aaj11codigo == "04" || aaj11_cstIpi.aaj11codigo == "05") {
					cstValido = true;
					jsonEaa0103.put("ipi_isento", jsonEaa0103.getBigDecimal_Zero("bc_ipi"));
					jsonEaa0103.put("bc_ipi", 0.00);
					jsonEaa0103.put("aliq_ipi", 0.00);
					jsonEaa0103.put("ipi_outras", 0.00);
					jsonEaa0103.put("ipi", 0.00);
				}
			...
			if (eaa0103.eaa0103cstIcms != null) {
				...
				if (abe01.abe01regTrib != 0) {
					...
					if (jsonAag02Ent.getBigDecimal("aliq_icmsaida") != null) {
						jsonEaa0103.put("aliq_icms", jsonAag02Ent.getBigDecimal_Zero("aliq_icmsaida"));
					...
					if (jsonAbm1003_Ent_Item.getBigDecimal_Zero("aliq_icms") > 0) {
						jsonEaa0103.put("aliq_icms", jsonAbm1003_Ent_Item.getBigDecimal_Zero("aliq_icms"));
						
					}else if (jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fixa_icms") > 0) {
				...
				if (abe01.abe01regTrib == 0) {
					...
					if (abm12.abm12tipo == 0 || abm12.abm12tipo == 1 || abm12.abm12tipo == 2 || abm12.abm12tipo == 4) {
						...
						if (jsonAbe01.getBigDecimal_Zero("simpnacional_aliq") > 0) {
							jsonEaa0103.put("aliq_icms", jsonAbe01.getBigDecimal_Zero("simpnacional_aliq"));
				...
				if (cstParteB == "00") {
					if (jsonEaa0103.getBigDecimal_Zero("aliq_icms") != 0) throw new ValidacaoException("CST indica entrada tributada, porém não foi informada alíquota de ICMS.");

					cstValido = true;

					jsonEaa0103.put("icms", ((jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("aliq_icms")) / 100).round(2));
					jsonEaa0103.put("icms_outras", 0.00);
					jsonEaa0103.put("icms_isento", 0.00);
				}

				if (jsonEaa0103.getBigDecimal_Zero("aliq_icms") == 0) {
					jsonEaa0103.put("icms_outras", jsonEaa0103.getBigDecimal_Zero("bc_icms"));
					jsonEaa0103.put("bc_icms", 0.00);
				...
				if (cstParteB == "10" ) {
					...
					jsonEaa0103.put("bc_icms_st", (((jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * jsonEaa0103.getBigDecimal_Zero("tx_iva_st")) / 100) + 1).round(2));

					//Calcula redução da BC ICMS ST
					if (jsonAbm1001_UF_Item.getBigDecimal_Zero("icm_reducst_bc") > 0) {
						jsonEaa0103.put("bc_icms_st", (jsonEaa0103.getBigDecimal_Zero("bc_icms_st") - ((jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * jsonAbm1001_UF_Item.getBigDecimal_Zero("icm_reducst_bc")) / 100)).round(2));
					...
					jsonEaa0103.put("aliq_icms_st", jsonAag02Ent.getBigDecimal_Zero("aliq_icmsint"));
					
					//ICMS ST = Base * Alíquota Interna Estado Destino - Vlr ICMS Normal
					if (jsonEaa0103.getBigDecimal_Zero("aliq_icms_st") > 0) {
						jsonEaa0103.put("icms_st", (((jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * jsonEaa0103.getBigDecimal_Zero("aliq_icms_st")) / 100) - jsonEaa0103.getBigDecimal_Zero("icms")).round(2));
					}
				}
				...
				if (cstParteB == "20") {
					...
					cstValido = true;
					def vlrReducao = ((jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("icm_reduc_bc")) / 100).round(2);
				...
				if (cstParteB == "30" || cstParteB == "40") {
					...
					jsonEaa0103.put("icms_isento", jsonEaa0103.getBigDecimal_Zero("bc_icms"));
					jsonEaa0103.put("bc_icms", 0.00);
					jsonEaa0103.put("aliq_icms", 0.00);
					jsonEaa0103.put("icms", 0.00);
					jsonEaa0103.put("icms_outras", 0.00);
				}
				...
				if (cstParteB == "60" ) {
					...
					jsonEaa0103.put("aliq_icms_st", 0.00);
				...
				if (cstParteB == "70" ) {
					...
					jsonEaa0103.put("bc_icms", jsonEaa0103.getBigDecimal_Zero("bc_icms") - vlrReducao);
					jsonEaa0103.put("icms", ((jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("aliq_icms")) / 100).round(2));
					jsonEaa0103.put("icms_outras", vlrReducao);
					jsonEaa0103.put("icms_isento", 0.00);
					jsonEaa0103.put("st_bc", jsonEaa0103.getBigDecimal_Zero("bc_icms"));
					...
					//ICMS ST = Base * Alíquota Interna Estado Destino - Vlr ICMS Normal
					if (jsonEaa0103.getBigDecimal_Zero("aliq_icms_st") > 0) {
						jsonEaa0103.put("st_icm", (((jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * jsonEaa0103.getBigDecimal_Zero("aliq_icms_st")) / 100) - jsonEaa0103.getBigDecimal_Zero("icms")).round(2));
					}
				}
			...
			if (eaa0103.eaa0103cstPis != null) {
				...
				if (aaj12_cstPis.aaj12codigo == "70" || aaj12_cstPis.aaj12codigo == "71" || aaj12_cstPis.aaj12codigo == "72" || aaj12_cstPis.aaj12codigo == "73" || 
					...
					cstValido = true;
					jsonEaa0103.put("bc_pis", 0.00);
					jsonEaa0103.put("aliq_pis", 0.00);
					jsonEaa0103.put("pis", 0.00);
				}
			...
			if (eaa0103.eaa0103cstCofins != null) {
				...
				if (aaj13_cstCof.aaj13codigo == "70" || aaj13_cstCof.aaj13codigo == "71" || aaj13_cstCof.aaj13codigo == "72" || 
					...
					cstValido = true;
					jsonEaa0103.put("bc_cofins", 0.00);
					jsonEaa0103.put("aliq_cofins", 0.00);
					jsonEaa0103.put("cofins", 0.00);
				}
			...
			//Define o Campo de Unitário para Estoque
				jsonEaa0103.put("unitario_estoque", (eaa0103.eaa0103unit + jsonEaa0103.getBigDecimal_Zero("frete_dest") +
																 jsonEaa0103.getBigDecimal_Zero("seguro") +
																 jsonEaa0103.getBigDecimal_Zero("outras_despesas") -
																 jsonEaa0103.getBigDecimal_Zero("desconto") -
																 jsonEaa0103.getBigDecimal_Zero("icms") -
			...
			jsonEaa0103.put("custo_aquisicao", (custoAquisicao + jsonEaa0103.getBigDecimal_Zero("frete_dest") +
																 jsonEaa0103.getBigDecimal_Zero("seguro") +
																 jsonEaa0103.getBigDecimal_Zero("outras_despesas") -
																 jsonEaa0103.getBigDecimal_Zero("desconto") -
																 jsonEaa0103.getBigDecimal_Zero("icms") -
