...
public class SCV_SRF_DocPadrao_Servico_Saida extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            jsonEaa0103.put("servicos_item",round((eaa0103.eaa0103qtComl * jsonEaa0103.getBigDecimal_Zero("unit_s_imp")) ,2));
            jsonEaa0103.put("total_servico", round(jsonEaa0103.getBigDecimal_Zero("servicos_item"),2));

            // Chamada da Função para calulo de impostos de serviços
            calcularImpostosServicos()

            // Total Item
            eaa0103.eaa0103total = round((jsonEaa0103.getBigDecimal_Zero("servicos_item") +  jsonEaa0103.getBigDecimal_Zero("iss") + jsonEaa0103.getBigDecimal_Zero("csll") + jsonEaa0103.getBigDecimal_Zero("inss") + jsonEaa0103.getBigDecimal_Zero("ir")),2)

            // Valor Unitário
            eaa0103.eaa0103unit = round(eaa0103.eaa0103total,2);

            // Total do Item sem imposto
            jsonEaa0103.put("tot_item_s_imp", round((eaa0103.eaa0103qtComl * jsonEaa0103.getBigDecimal_Zero("unit_s_imp")),2));

            // Total do Items com Imposto
            jsonEaa0103.put("tot_item_c_imp", eaa0103.eaa0103total);

            // Total Do Documento
            eaa0103.eaa0103totDoc = round(jsonEaa0103.getBigDecimal_Zero("total_servico"), 2);
            ...
            // Chamada para calculo de carga tributária
            calculaCargaTributaria()

            // Total Financeiro
            if(jsonEaa0103.getBigDecimal_Zero("total_servico") > 0){
                eaa0103.eaa0103totFinanc = round(jsonEaa0103.getBigDecimal_Zero("total_servico"),2);
            }else{
                eaa0103.eaa0103totFinanc = round(eaa0103.eaa0103totDoc,2);
            }

            // Total Liquido
            jsonEaa0103.put("total_liquido", round(eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms") - jsonEaa0103.getBigDecimal_Zero("pis") - jsonEaa0103.getBigDecimal_Zero("cofins") - jsonEaa0103.getBigDecimal_Zero("iss"),2))
    ...
    private void calcularImpostosServicos(){
        // BC ISS
        jsonEaa0103.put("bc_iss", jsonEaa0103.getBigDecimal_Zero("total_servico") + jsonEaa0103.getBigDecimal_Zero("pis") + jsonEaa0103.getBigDecimal_Zero("cofins"));
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_iss") == -1){
            ...
            jsonEaa0103.put("iss", round((jsonEaa0103.getBigDecimal_Zero("bc_iss") * jsonEaa0103.getBigDecimal_Zero("aliq_iss") / 100),2) );
        }

        // BC CSLL
        jsonEaa0103.put("bc_csll", jsonEaa0103.getBigDecimal_Zero("total_servico") + jsonEaa0103.getBigDecimal_Zero("pis") + jsonEaa0103.getBigDecimal_Zero("cofins"));
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_csll") == 0){
            ...
            jsonEaa0103.put("csll", round((jsonEaa0103.getBigDecimal_Zero("bc_csll") * jsonEaa0103.getBigDecimal_Zero("aliq_csll") / 100),2) );
        }

        // BC IR
        jsonEaa0103.put("bc_ir", jsonEaa0103.getBigDecimal_Zero("total_servico") + jsonEaa0103.getBigDecimal_Zero("pis") + jsonEaa0103.getBigDecimal_Zero("cofins"));
    ...
    private void calculaCargaTributaria(){
        ...
        if(abm0101.abm0101ncm != null){
            ...
            // BC Carga Tributária
            jsonEaa0103.put("bc_carga_trib_", eaa0103.eaa0103totDoc.round(2));
