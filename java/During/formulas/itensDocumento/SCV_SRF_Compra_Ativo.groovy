...
public class SCV_SRF_Compra_Ativo extends FormulaBase {
    ...
    private void calcularIPI(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("_ipi") != -1){
            if (eaa0103.eaa0103cstIpi != null) {
                ...
                jsonEaa0103.put("bc_ipi", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("seguro")  + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto"));
        ...
        // IPI outras e OBS
        if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") <= 0){
            jsonEaa0103.put("ipi_observacoes", jsonEaa0103.getBigDecimal_Zero("ipi"));
            jsonEaa0103.put("bc_ipi", BigDecimal.ZERO);
            jsonEaa0103.put("ipi", BigDecimal.ZERO);
            jsonEaa0103.put("ipi_outras", round((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("seguro")  + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto")),2));
        }
    }
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("_red_bc_icms") > 0 ){
            ...
            jsonEaa0103.put("bc_icms", round((vlrReducao + jsonEaa0103.getBigDecimal_Zero("ipi")),2));
        }
