...
public class SCV_SRF_Remessa_Com_Pis_Cofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
		  ...
		  // Chamada para calculo do PIS
            calcularPIS();

		  // Chamada para calculo do COFINS	
            calcularCOFINS();

            // ICMS Outras
            jsonEaa0103.put("icms_outras", round(eaa0103.eaa0103totDoc,2));

            // IPI Outras
            jsonEaa0103.put("ipi_outras", round(eaa0103.eaa0103totDoc,2));

            // Total Financeiro
            if(aaj15_cfop.aaj15codigo.substring(1) == '901' || aaj15_cfop.aaj15codigo.substring(1) == '902' || aaj15_cfop.aaj15codigo.substring(1) == '1903'){
    ...
    private void calcularPIS(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_pis") == BigDecimal.ZERO){
    ...
    private void calcularCOFINS(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_cofins") == BigDecimal.ZERO){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_cofins") < BigDecimal.ZERO){
            ...
            jsonEaa0103.put("cofins", round(((eaa0103.eaa0103totDoc * jsonEaa0103.getBigDecimal_Zero("aliq_cofins")) / 100),2) )
        }
    ...
    //private void calcularDesoneracao(){
       ...
       // jsonEaa0103.put("receita_bruta", round(eaa0103.eaa0103totDoc,2));
        ...
        //if(aaj15_cfop.aaj15codigo == '7101'){
           // jsonEaa0103.put("exc_rec_bruta",round(((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit) + jsonEaa0103.getBigDecimal_Zero("frete_dest")),2));
        //}
