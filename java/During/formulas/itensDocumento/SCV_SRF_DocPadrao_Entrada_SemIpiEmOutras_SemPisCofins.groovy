...
public class SCV_SRF_DocPadrao_Entrada_SemIpiEmOutras_SemPisCofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // IPI Outras
            jsonEaa0103.put("ipi_outras",(eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("ipi")).round(2));
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        jsonEaa0103.put("bc_icms", (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto")).round(2))
    ...
    private void calcularPIS(){
        ...
        jsonEaa0103.put("bc_pis", (eaa0103.eaa0103totDoc).round(2));
    ...
    private void calcularCOFINS(){
        ...
        jsonEaa0103.put("bc_cofins", (eaa0103.eaa0103totDoc).round(2));
