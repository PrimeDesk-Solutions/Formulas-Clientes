...
public class SCV_SRF_Compra_Insumo_ComPisCofins_ICMS_Outras extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(abm1301 == null ) throw new ValidacaoException("Necessário informar fator de conversão de uso no item "+ abm01.abm01codigo);

            eaa0103.eaa0103qtUso = (eaa0103.eaa0103qtComl * abm1301.abm1301fcCU).round(2);
            ...
            if(jsonEaa0103.getBigDecimal_Zero("icms") == 0){
                jsonEaa0103.put("icms_outras", eaa0103.eaa0103total.round(2));
            ...
            // ICMS Isento Não tributável
            if(jsonEaa0103.getBigDecimal_Zero("_red_bc_icms") > 0){
                jsonEaa0103.put("icms_isento", (jsonEaa0103.getBigDecimal_Zero("bc_ipi") - jsonEaa0103.getBigDecimal_Zero("bc_icms")).round(2));
                jsonEaa0103.put("VlrNTriRedBCSPD", jsonEaa0103.getBigDecimal_Zero("icms_isento"))
            }
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        jsonEaa0103.put("bc_icms", (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto") + jsonEaa0103.getBigDecimal_Zero("ipi")  ).round(2))
