...
public class SCV_SRF_Complemento_Importacao_Estoque extends FormulaBase {
    ...
    private void calcularItem() {
	    ...
	    eaa0103.eaa0103total = round(eaa0103.eaa0103qtComl * eaa0103.eaa0103unit,9);
...
//		
//            // % Complemento
//            //def complement =  (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("vlr_complemento")) / eaa0103.eaa0103total;
//
//           // jsonEaa0103.put("_complemento",((complement - 1) * 100).round(2));
//
//        }
    }
