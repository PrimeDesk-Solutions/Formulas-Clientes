...
public class SCV_SRF_DocPadrao_Saida_ComPisCofins_Com_Tributos_FCP extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(abm13.abm13fcUV == null) throw new ValidacaoException("Não foi informado fator de conversão de uso para venda no cadastro do item " + abm01.abm01codigo);

            eaa0103.eaa0103qtUso = (eaa0103.eaa0103qtComl * abm13.abm13fcUV).round(2);
            ...
            // Chamada para calculo de ICMS
            calcularICMS();

            // Chamada para calculo de ICMS ST
            calcularICMSST();
            ...
            // Chamada para calculo FCP
            calcularFCP();

            // Chamada para calculo da Carga Tributária
...
// ========================================================================================
    ...
    private void calcularPIS(){
        ...
        jsonEaa0103.put("bc_pis", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms_st")).round(2));
    ...
    private void calcularCOFINS(){
        ...
        jsonEaa0103.put("bc_cofins", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms_st")).round(2));
