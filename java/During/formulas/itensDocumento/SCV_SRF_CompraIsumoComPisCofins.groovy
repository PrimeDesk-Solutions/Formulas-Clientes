...
public class SCV_CompraIsumoComPisCofins extends FormulaBase {
		...
		private void calcularItem() {
			...
			if(eaa0103.eaa0103qtComl > 0){
				...
				if(abm1301 == null) throw new ValidacaoException("O item " + abm01.abm01codigo + " encontra-se sem fator de conversão de compra no cadastro.")
...
//				}
				...
				if(jsonEaa0103.getBigDecimal_Zero("icms") == 0){
					jsonEaa0103.put("icms_outras", round((eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("desconto")),2)); 
				...
				// Total Documento sem IPI
				jsonEaa0103.put("total_doc_s_ipi", round((eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi")),2)); 
...
//				}else{
//					if(jsonEaa0103.getBigDecimal_Zero("icms_st") > 0){
//						eaa0103.eaa0103totFinanc = jsonEaa0103.getBigDecimal_Zero("total_doc_st");
//					}else{
...
//				}
		...
		private void calcularICMS(Integer contribICMS){
			...
			// *************************************** ICMS *********************************************
			// ==========================================================================================
			if(jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fixa_icms") == 0) throw new ValidacaoException("Aliquota de ICMS não encontrada.")
			...
			if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") > -1){
				...
				jsonEaa0103.put("bc_icms", round((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto")),2) )
		...
		private void calcularICMSST(){
			...
			if(ivaST > 0){
				...
				jsonEaa0103.put("bc_icms_st", jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * ((ivaST / 100) + 1));
				jsonEaa0103.put("bc_icms_st", round(jsonEaa0103.getBigDecimal_Zero("bc_icms_st"),2));
