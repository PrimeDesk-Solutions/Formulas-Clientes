...
public class SCV_SRF_DocPadrao_Saida_ComPisCofins_ComTributos extends FormulaBase {
    ...
    public void executar() {
        ...
        if(municipioEnt == null) throw new ValidacaoException("Não foi possível localizar a UF do endereço principal da entidade " + abe01.abe01codigo)
    ...
    private void calcularItem() {
        ...
        // Unitário = Unitário Sem Imposto
        eaa0103.eaa0103unit = jsonEaa0103.getBigDecimal_Zero("unit_s_imp");
        ...
        jsonEaa0103.put("qtd_tribut", round(eaa0103.eaa0103qtComl,2));

        // Unitário Tributável
        jsonEaa0103.put("unit_tribut", round(eaa0103.eaa0103unit,2));

        // Total Item
        eaa0103.eaa0103total = round(((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit) - jsonEaa0103.getBigDecimal_Zero("desconto")),2);
        ...
        //interromper(eaa0103.eaa0103totDoc.toString());

        // Total Financeiro
        eaa0103.eaa0103totFinanc = eaa0103.eaa0103totDoc;


//interromper(jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_icms").toString())
        //Total Item com Impostos
        // jsonEaa0103.put("tot_item_c_imp", ((jsonEaa0103.getBigDecimal_Zero("unit_s_imp") / piscofIcms) / icmstot) * (1+jsonEaa0103.getBigDecimal_Zero("aliq_ipi")/100) * eaa0103.eaa0103qtComl);
        //  jsonEaa0103.getBigDecimal_Zero("ipi") +
        //  jsonEaa0103.getBigDecimal_Zero("frete_dest") +
        //  jsonEaa0103.getBigDecimal_Zero("seguro") +
        //  jsonEaa0103.getBigDecimal_Zero("outras_despesas") +
        ...
        //  jsonEaa0103.getBigDecimal_Zero("pis") +
        //  jsonEaa0103.getBigDecimal_Zero("cofins"));
//ea011.ea011vlr100 = ((ea011.ea011vlr50 / piscof) / icmstot) * (1+ea011.ea011vlr17/100)
//ea011.ea011vlr100 = ea011.ea011vlr100.round(2)
//ea011.ea011vlr100 = ea011.ea011vlr1 * ea011.ea011vlr100
//ea011.ea011vlr100 = ea011.ea011vlr100.round(2)
        ...
        jsonEaa0103.put("total_liquido", round(jsonEaa0103.getBigDecimal_Zero("total_liquido"),2));
        ...
        if(jsonEaa0103.getBigDecimal_Zero("cif") > 0){
            eaa0103.eaa0103unit = round((eaa0103.eaa0103unit + jsonEaa0103.getBigDecimal_Zero("cif")),2)
        }
    ...
    private void calcularIPI(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != -1){
            if (eaa0103.eaa0103cstIpi != null) {
                ...
                jsonEaa0103.put("bc_ipi", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto"));
    ...
    private void calcularPIS(){
        ...
        //jsonEaa0103.put("bc_pis", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") -  jsonEaa0103.getBigDecimal_Zero("icms_st") - jsonEaa0103.getBigDecimal_Zero("icms")).round(2));
        jsonEaa0103.put("bc_pis", jsonEaa0103.getBigDecimal_Zero("unit_s_imp") / piscof * eaa0103.eaa0103qtComl.round(2));
    ...
    private void calcularICMS(){
        ...
        def piscofIcms = ((100-(jsonEaa0103.getBigDecimal_Zero("aliq_pis") + jsonEaa0103.getBigDecimal_Zero("aliq_cofins")))/100);
        def icmstot = 1-(jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fixa_icms") / 100);

        jsonEaa0103.put("bc_icms", ((eaa0103.eaa0103total / piscofIcms) / icmstot).round(2))
        //jsonEaa0103.put("bc_icms", (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi")).round(2))
    ...
    private void calcularICMSST(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") == jsonEaa0103.getBigDecimal_Zero("aliq_icms_st") ){
            ...
            jsonEaa0103.put("bc_icms_st", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi") )
            ...
            if(ivaST > 0){
                ...
                jsonEaa0103.put("icms_st", (jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * aliqIcmsST / 100).round(2));
    ...
    private void calculaCargaTributaria(){
        ...
        jsonEaa0103.put("vlrcargatrib", round(jsonEaa0103.getBigDecimal_Zero("vlrcargatrib"),2));
    ...
    private void preencherSPEDS(){
        ...
        jsonEaa0103.put("_icms_st_sped", jsonEaa0103.getBigDecimal_Zero("aliq_icms_st"));
