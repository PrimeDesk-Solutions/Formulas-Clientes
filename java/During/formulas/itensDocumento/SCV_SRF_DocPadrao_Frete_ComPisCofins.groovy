...
public class SCV_SRF_DocPadrao_Frete_ComPisCofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            eaa0103.eaa0103totDoc = eaa0103.eaa0103total 
            					...
            					/*
            					 * Erro ao digitar conhecimento de transporte
            					 * retirado a soma dos impostos do total do documentos, pois segundo a Daniela não calcula impostos nesse PCD. 14/06
            ...
            //interromper(eaa0103.eaa0103totFinanc.toString())
...
//meta-sis-eyJ0aXBvIjoiZm9ybXVsYSIsImZvcm11bGF0aXBvIjoiNjIif
//meta-sis-eyJ0aXBvIjoiZm9ybXVsYSIsImZvcm11bGF0aXBvIjoiNjIifQ==