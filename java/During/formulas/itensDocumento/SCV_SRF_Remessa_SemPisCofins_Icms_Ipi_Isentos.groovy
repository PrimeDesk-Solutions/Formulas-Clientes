...
public class SCV_SRF_Remessa_SemPisCofins_Icms_Ipi_Isentos extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            jsonEaa0103.put("qt_custo_adicional", (eaa0103.eaa0103qtComl * eaa0103.eaa0103unit).round(2));

            // Exportação
            if(aaj15_cfop.aaj15codigo == "7101"){
                jsonEaa0103.put("tot_conv", ((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit) + jsonEaa0103.getBigDecimal_Zero("frete_dest")).round(2))
            }

            // Total Financeiro
            eaa0103.eaa0103totFinanc = eaa0103.eaa0103totDoc.round(2);

            // Chamada da Função para calculo dos SPED's
            preencherSPEDS();
        }
