...
public class SCV_SRF_DocPadrao_Saida_Proposta_Venda_Exportacao extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // Unitário Item
            eaa0103.eaa0103unit = round(jsonEaa0103.getBigDecimal_Zero("unit_s_imp"),2);

            // Total Item
            eaa0103.eaa0103total = round((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit),2);

            // Total Documento
            eaa0103.eaa0103totDoc = round((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("embalagem")),2);
            ...
            // Chamada da função para calculo da desoneração
            calcularDesoneracao(aaj15_cfop);

            // Total Item com Imposto
            jsonEaa0103.put("tot_item_c_imp", round((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit),2));

            // Total Item sem Imposto
    ...
    private void calculaCargaTributaria(){
        ...
        // % Tributária
        jsonEaa0103.put("carga_trib_", new BigDecimal(0))

        // BC Carga Tributária
        jsonEaa0103.put("bc_carga_trib_", new BigDecimal(0));

        // Carga Tributária
        jsonEaa0103.put("vlrcargatrib",new BigDecimal(0));
    ...
    private void calcularImpostosservicos(){
        ...
        // Aliquota ISS
        jsonEaa0103.put("_iss", new BigDecimal(0));
        ...
        // Aliquota CSLL
        jsonEaa0103.put("_csll", new BigDecimal(0));
        ...
        // Aliquota IR
        jsonEaa0103.put("_ir", new BigDecimal(0));
    ...
    private calcularDesoneracao(Aaj15 aaj15_cfop){
        ...
        // Exclusões
        jsonEaa0103.put("exc_rec_bruta", jsonEaa0103.getBigDecimal_Zero("ipi"));
