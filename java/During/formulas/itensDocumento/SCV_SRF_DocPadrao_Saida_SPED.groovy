...
public class SCV_SRF_DocPadrao_Saida_SPED extends FormulaBase {
    ...
    private void calcularICMSST(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") == jsonEaa0103.getBigDecimal_Zero("aliq_icms_st")){
            ...
            jsonEaa0103.put("icms_st",(eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi")).round(2));
