...
public class SCV_SRF_DocPadrao_Saida_SemIpiBcIcms_SemPisCofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // Zera Base de Calculo ICMS caso Aliquota de ICMS menor que Zero
            ...
            // IPI Isento
            jsonEaa0103.put("ipi_isento", eaa0103.eaa0103totDoc.round(2));
    ...
    private void calcularICMS(){
        ...
        jsonEaa0103.put("bc_icms", (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas")).round(2) )
...
// ========================================================================================
    ...
    private void calcularICMSST(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") == jsonEaa0103.getBigDecimal_Zero("aliq_icms_st")){
            ...
            // Verifica se a entidade é varejista ou atacadista
