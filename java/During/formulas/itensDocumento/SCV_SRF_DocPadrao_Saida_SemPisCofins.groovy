...
public class SCV_SRF_DocPadrao_Saida_SemPisCofins extends FormulaBase {
    ...
    private void calcularIPI(){
        ...
        // IPI Isento
        jsonEaa0103.put("ipi_isento", round(eaa0103.eaa0103totDoc,2));
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        jsonEaa0103.put("bc_icms", round((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi")),2) )
        ...
        // Isentas de ICMS
        jsonEaa0103.put("icms_isento", round(eaa0103.eaa0103totDoc,2));
    ...
    private void calcularICMSST(){
        ...
        if(ivaST != 0){
            jsonEaa0103.put("_icms_st", ivaST);
        }else{
            ivaST = jsonEaa0103.getBigDecimal_Zero("_icms_st");
        }

        if(ivaST > 0){
            // Adicionar IVA ST á Base

            jsonEaa0103.put("icms_st", (jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * (jsonEaa0103.getBigDecimal_Zero("_icms_st") / 100)) - jsonEaa0103.getBigDecimal_Zero("icms"))
    ...
    private void calcularPIS(){
        ...
        jsonEaa0103.put("bc_pis", round((eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("icms")),2));
    ...
    private void calcularCOFINS(){
        ...
        jsonEaa0103.put("bc_cofins", round((eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("icms")),2));
