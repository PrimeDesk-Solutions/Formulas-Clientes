...
public class SCV_SRF_Compra_Insumo_com_IPI_Frete extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(jsonEaa0103.getBigDecimal_Zero("icms") == 0){
                jsonEaa0103.put("icms_outras", round(eaa0103.eaa0103total ,2));
    ...
    private void calcularPIS(){
        ...
        jsonEaa0103.put("bc_pis", round((eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi")),2));
    ...
    private void calcularCOFINS(){
        ...
        jsonEaa0103.put("bc_cofins", round((eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi")),2));
