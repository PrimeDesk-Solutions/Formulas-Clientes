...
public class SCV_SRF_DocPadrao_Servico_Saida_SemPisCofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // Total Liquido
            jsonEaa0103.put("total_liquido", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi") - jsonEaa0103.getBigDecimal_Zero("icms") - jsonEaa0103.getBigDecimal_Zero("pis") - jsonEaa0103.getBigDecimal_Zero("cofins") - jsonEaa0103.getBigDecimal_Zero("iss")).round(2))


            // Total Financeiro
            if(jsonEaa0103.getBigDecimal_Zero("total_servico") > 0){
                eaa0103.eaa0103totFinanc = jsonEaa0103.getBigDecimal_Zero("total_servico").round(2);
            }else{
    ...
    private void calcularPIS(){
        ...
        jsonEaa0103.put("bc_pis", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi")).round(2));
    ...
    private void calcularCOFINS(){
        ...
        jsonEaa0103.put("bc_cofins", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi")).round(2));
