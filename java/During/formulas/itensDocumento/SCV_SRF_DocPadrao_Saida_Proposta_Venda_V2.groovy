...
public class SCV_SRF_DocPadrao_Saida_Proposta_Venda extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // Total Do Documento = Total Item C/ Impostp + Frete
            //eaa0103.eaa0103totDoc = jsonEaa0103.getBigDecimal_Zero("tot_item_c_imp")  + jsonEaa0103.getBigDecimal_Zero("ipi"); + jsonEaa0103.getBigDecimal_Zero("frete_dest")
		   eaa0103.eaa0103totDoc = 	(jsonEaa0103.getBigDecimal("tot_item_c_imp") + jsonEaa0103.getBigDecimal_Zero("frete_dest") +
            ...
            // Ajusta a base de calculo de ICMS 
            jsonEaa0103.put("bc_icms", eaa0103.eaa0103totDoc)
            ...
            // Zera total serviço
            jsonEaa0103.put("total_servico", new BigDecimal(0));
            ...
            if(abm01.abm01tipo == 3){
                jsonEaa0103.put("servicos_itens", (eaa0103.eaa0103qtComl * eaa0103.eaa0103unit).round(2));
                jsonEaa0103.put("total_servico", (eaa0103.eaa0103qtComl * eaa0103.eaa0103unit).round(2));
            }
    ...
    private void calcularICMS(BigDecimal pisCof, BigDecimal icmsTot){
        ...
        if(abm01.abm01tipo != 3){
            jsonEaa0103.put("bc_icms", ((jsonEaa0103.getBigDecimal_Zero("unit_s_imp") / pisCof) / icmsTot).round(2))
        }
