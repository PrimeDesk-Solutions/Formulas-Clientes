...
public class SCV_SRF_Exportacao_60012 extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(jsonAbm0101.getBigDecimal_Zero("qtd_tribut") > 0){
                jsonEaa0103.put("qtd_tribut", (eaa0103.eaa0103qtComl * jsonAbm0101.getBigDecimal_Zero("qtd_tribut")).round(2) )
            }else{
                jsonEaa0103.put("qtd_tribut", eaa0103.eaa0103qtComl);
            }

            // Unitário Tributável
            if(jsonAbm0101.getBigDecimal_Zero("unit_tribut") > 0){
                jsonEaa0103.put("unit_tribut", (eaa0103.eaa0103unit / jsonAbm0101.getBigDecimal_Zero("unit_tribut")).round(2) )
            }else{
            ...
            // Jogar o frete no valor de frete
		 jsonEaa0103.put("vlr_frete", jsonEaa0103.getBigDecimal_Zero("frete_dest"));
            ...
            // ICMS Isento
            jsonEaa0103.put("icms_isento", eaa0103.eaa0103totDoc.round(2))
    ...
    private void calcularICMSST(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("bc_icms_st") == 0){
            jsonEaa0103.put("bc_icms_st", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi"));
