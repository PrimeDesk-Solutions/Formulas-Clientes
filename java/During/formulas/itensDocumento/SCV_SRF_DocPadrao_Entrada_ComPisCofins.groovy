...
public class SCV_SRF_DocPadrao_Entrada_ComPisCofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            if(jsonEaa0103.getBigDecimal_Zero("icms") == 0){
                jsonEaa0103.put("icms_outras", (eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("desconto")).round(2));
    ...
    private void calcularIPI(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("_ipi") != -1){
            ...
            if (eaa0103.eaa0103cstIpi != null) {
                ...
                jsonEaa0103.put("bc_ipi", (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("outras_despesas")).round(2));
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        if(aam01 != null && aam01.aam01codigo == "01"){ // Itens com classe importado
