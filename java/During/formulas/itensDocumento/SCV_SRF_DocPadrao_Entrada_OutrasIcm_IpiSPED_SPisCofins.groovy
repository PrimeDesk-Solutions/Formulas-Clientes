...
public class SCV_SRF_DocPadrao_Entrada_OutrasIcm_IpiSPED_SPisCofins extends FormulaBase {
...
//            }
    ...
    private void calcularIPI(){
        ...
        // IPI Outras
        jsonEaa0103.put("ipi_outras", (eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("ipi")).round(2));
