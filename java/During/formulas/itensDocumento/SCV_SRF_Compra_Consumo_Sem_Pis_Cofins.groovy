...
public class SCV_SRF_Compra_Consumo_Sem_Pis_Cofins extends FormulaBase {
    ...
    private void calcularIPI(){
        ...
        if(abd01.abd01es == 0 && abd01.abd01aplic == 0) {
            jsonEaa0103.put("bc_ipi", eaa0103.eaa0103total.round(2));
    ...
    private void calcularICMS(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("ipi_observacoes") == BigDecimal.ZERO){
            jsonEaa0103.put("bc_icms", (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("ipi") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("frete_dest")).round(2))
        }else{
            jsonEaa0103.put("bc_icms", eaa0103.eaa0103total.round(2));
        }
        ...
        if(jsonEaa0103.getBigDecimal_Zero("icms") == 0 ){
            jsonEaa0103.put("icms_outras", (eaa0103.eaa0103total  + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("frete_dest")).round(2))
            jsonEaa0103.put("bc_icms", BigDecimal.ZERO);
            jsonEaa0103.put("icms", BigDecimal.ZERO);
            jsonEaa0103.put("icms_isento", BigDecimal.ZERO);
        }else{
