// Ultima atualização Kelly 14.08.2024
...
public class SCV_SRF_Compra_Consumo extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        // ============================================================================================
        // ****************** IPI/ICMS/PIS/COFINS NÃO CALCULA *****************************************
        //RETIRADO DA FÓRMULA O CÁLCULO ATÉ AJUSTARMOS OS CAMPOS DOS ITENS*****************************
        // ============================================================================================

		//Define valores dos impostos
		...
		//Define CST ICMS (Atribui CST 90)
		def codigoCst;
		...
		//Se CFOP = "556"
			if (aaj15_cfop.aaj15codigo.substring(1) == "556"){
				codigoCst = "90";
		}
		...
		//Define CST IPI/PIS/COFINS (Por enquanto Atribui Do item - até trocarmos os campos e fórmulas)
