...
public class SCV_SRF_Exportacao_60011 extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // Total Do Documento
            eaa0103.eaa0103totDoc = ((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest")).round(2));
            ...
            jsonEaa0103.put("qt_custo_adicional", eaa0103.eaa0103totDoc.round(2));

            // Exportação
            if(aaj15_cfop.aaj15codigo == "7101"){
                jsonEaa0103.put("total_conv", ((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit) + jsonEaa0103.getBigDecimal_Zero("frete_dest")).round(2));
            }
