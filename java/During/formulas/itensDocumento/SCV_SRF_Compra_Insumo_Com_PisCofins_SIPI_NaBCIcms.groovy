...
public class SCV_SRF_Compra_Insumo_Com_PisCofins_SIPI_NaBCIcms extends FormulaBase {
    ...
    private void calcularICMS(Integer contribICMS){
	   ...
	   if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") != -1){
	        ...
	        jsonEaa0103.put("bc_icms", (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi")  - jsonEaa0103.getBigDecimal_Zero("desconto")).round(2))
