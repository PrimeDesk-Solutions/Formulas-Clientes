...
public class SCV_SRF_Compra_Consumo_Ipi_Icms_Outras extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if(eaa0103.eaa0103qtComl > 0){
            ...
            jsonEaa0103.put("_red_bc_icms", BigDecimal.ZERO);
            ...
            if (abg01 != null && abg01.abg01txIpi_Zero > 0) {
                jsonEaa0103.put("ipi_observacoes", (eaa0103.eaa0103totDoc * abg01.abg01txIpi).round(2));
            }

            // Total Financeiro
            eaa0103.eaa0103totFinanc = eaa0103.eaa0103totDoc.round(2);

            // Chamada para calculo dos SPED's
            preencherSPEDS()
