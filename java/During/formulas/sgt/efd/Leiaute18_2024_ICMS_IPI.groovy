package during.formulas.sgt.efd
...
import br.com.multitec.utils.*
import br.com.multitec.utils.collections.TableMap
import sam.dicdados.FormulaTipo
import sam.model.entities.aa.*
import sam.model.entities.ab.*
import sam.model.entities.bc.Bcb10
import sam.model.entities.bc.Bcb11
import sam.model.entities.bc.Bcc01
import sam.model.entities.ea.*
import sam.model.entities.ec.*
import sam.model.entities.ed.*
...
public class Leiaute18_2024_ICMS_IPI extends FormulaBase {
    ...
    private static final Integer versaoLeiaute = 18;
    ...
    public void executar() {
        ...
        if(aac10.aac10municipio == null) throw new ValidacaoException("Necess rio informar o munic pio no cadastro da empresa.");
        if(aac10.aac10endereco == null) throw new ValidacaoException("Necess rio informar o endere o no cadastro da empresa.");

        aac13 = aac10.aac13fiscal;
        if(aac13 == null) throw new ValidacaoException("Necess rio informar as informa  es fiscais no cadastro da empresa.");
        if(aac13.aac13tipoAtiv == null) throw new ValidacaoException("Necess rio informar o tipo de atividade nas informa  es fiscais do cadastro da empresa.");

        perfil = aac13.aac13perfil;
        if(perfil == null) throw new ValidacaoException("Necess rio informar o perfil nas informa  es fiscais do cadastro da empresa.");
    ...
    def gerarAberturaBloco0() {
         ...
         * REGISTRO 0205: Altera  o do Item -> N o geramos este arquivo
         ...
         * REGISTRO 0221: CORRELA  O ENTRE C DIGOS DE ITENS COMERCIALIZADOS
         */
         ...
         * REGISTRO 0305: Utiliza  o do Bem
         */
        ...
        //Guarda o id dos documentos que ser o utilizados no C170 e das NFe Pr pria para serem utilizadas no registro E510
     ...
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * *  BLOCO B: ESCRITURA  O E APURA  O DO ISS  * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     */
    def gerarBlocoB() {
        ...
        if(eaa01s != null && eaa01s.size() > 0) {
            ...
            while(eaa01s.size() > 0) {
                ...
                for(Eaa01 eaa01 : eaa01s) {
                    ...
                    String UF = buscarUfEnderecoPrincipal(eaa01.eaa01id);

                    Abb01 abb01 = getSession().get(Abb01.class, eaa01.eaa01central.abb01id);

                    if(UF == null) throw new ValidacaoException("Não foi encontrado a UF do endereço principal no documento " + abb01.abb01num.toString())
			      ...
			      UF = UF.toUpperCase()
                    ...
                    //Se a situa  o for 02, 03, 04, 05, 06 ou 07 os registros filhos n o precisam ser gerados
                    ...
                    if(geraFilhos) {
                        /**
                         * REGISTRO C101: Informa  o Complementar dos Documentos Fiscais quando das Opera  es Interestaduais destinadas a consumidor final
                         * n o contribuinte EC 87/15
                         */
                         ...
                         */
                        if(gerarRegByPerfil(perfil, "C120", eaa01.eaa01esMov) && eaa01.eaa01esMov == 0 && (modelo.equals("01") || modelo.equals("55")) && eaa01034s != null && eaa01034s.size() > 0) {
                        ...
                        /**
                         * REGISTRO C160: Volumes Transportados (C digo 01 e 04) - Exceto Comb stiveis
                         */
                        ...
                        if(!isSit06ou07 && gerarRegByPerfil(perfil, "C170", eaa01.eaa01esMov) && !isNFePropria && eaa0103s != null && eaa0103s.size() > 0) {
                            for(Eaa0103 eaa0103 : eaa0103s) {
                                ...
                                if(eaa0103.eaa0103umComl != null) {
                                    ...
                                    Aam06 aam06Aux = abm0101.abm0101uma != null ? getSession().get(Aam06.class, abm0101.abm0101uma.aam06id) : null;

                                 txt2.print(aam06Aux != null && aam06.aam06id != aam06Aux.aam06id ? aam06Aux.aam06codigo : aam06.aam06codigo);
                                 set0190.add(eaa0103.eaa0103umComl.aam06id);
                                 comporRegistro0220(abm01, aam06Aux, eaa01.eaa01esMov == 1);
                                }else {
                                    txt2.print(null);
                                }
                                ...
                                txt2.print(formatarValor(jsonEaa0103.getBigDecimal_Zero(aaj10 != null && aaj10.aaj10codigo == "061" ? null : getCampo(alinEFD, "C170", "VL_BC_ICMS")), 2));
                                txt2.print(jsonEaa0103.getBigDecimal_Zero(aaj10 != null && aaj10.aaj10codigo == "061" ? null : getCampo(alinEFD, "C170", "ALIQ_ICMS")) == -1 ? formatarValor(0,2) : formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_ICMS")), 2));
                                ...
                                txt2.print(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_ST")) == -1 ? formatarValor(0,2) : formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_ST")), 2));
                                ...
                                txt2.print(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_IPI")) == -1 ? formatarValor(0,2) : formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_IPI")), 2));
                                ...
                                txt2.print(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_PIS_P")) == -1 ? formatarValor(0,2) : formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_PIS_P")), 2));
                                txt2.print(formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "QUANT_BC_PIS")), 3));
                                txt2.print(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_PIS_R")) == -1 ? formatarValor(0,2) : formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_PIS_R")), 4));
                                ...
                                txt2.print(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_COFINS_P")) == -1 ? formatarValor(0,2) : formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_COFINS_P")), 2));
                                txt2.print(formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "QUANT_BC_COFINS")), 3));
                                txt2.print(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_COFINS_R")) == -1 ? formatarValor(0,2) : formatarValor(jsonEaa0103.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_COFINS_R")), 4));
                                ...
                                /**
                                 * RegistroC179: Informa  es complementares ST (C digo 01)
                                 */
                        ...
                        if(gerarRegByPerfil(perfil, "C190", eaa01.eaa01esMov)) {
                            ...
                            if(listEaa0103 != null && listEaa0103.size() > 0) {
                                for(TableMap tm : listEaa0103) {
                                    ...
                                    String aaj10codigo = tm.getString("aaj10codigo");

                                    txt2.print("C190");
                                    txt2.print(tm.getString("aaj10codigo"));
                                    txt2.print(tm.getString("aaj15codigo"));
                                    txt2.print(formatarValor(tm.getBigDecimal_Zero(aaj10codigo == "061" ? null : getCampo(alinEFD, "C190", "ALIQ_ICMS")) == -1 ? 0 : tm.getBigDecimal_Zero(getCampo(alinEFD, "C170", "ALIQ_ICMS")), 2));
                                    txt2.print(formatarValor(tm.getBigDecimal_Zero("eaa0103totDoc"), 2));
                                    txt2.print(formatarValor(tm.getBigDecimal_Zero(aaj10codigo == "061" ? null : getCampo(alinEFD, "C190", "VL_BC_ICMS")), 2));
                        ...
                        /**
                         * REGISTRO C195: Observa  es do Lan amento Fiscal (C digo 01, 1B e 55)
                         */
    ...
    def gerarC500() {
        /**
         * REGISTRO C500: NF de Energia El trica (C digo 06), NF de Energia El trica Eletronica - NF3e (Cod 66)
         * NF de Fornecimento de  gua canalizada (29) e NF G s (28)
         */
        def pagina = 0;
        ...
        while(eaa01s.size() > 0) {
            for(Eaa01 eaa01 : eaa01s) {
                ...
                if(eaa01.eaa01sitDoc == null) throw new ValidacaoException("A situa  o do documento n o foi informada. Documento de entrada: " + abb01.abb01num);
    ...
    def gerarC800() {
        /**
         * REGISTRO C800: Cupom Fiscal Eletr nico - SAT (C digo 59)
         */
        if(gerarRegByPerfil(perfil, "C800", 1)) {
            ...
            while(eaa01s.size() > 0) {
                for(Eaa01 eaa01 : eaa01s) {
                    ...
                    /**
                     * REGISTRO C850 - Registro Anal tico do CF-e SAT
                     */
        ...
        if(gerarRegByPerfil(perfil, "C860", 1)) {
            ...
            for(String key : setSAT) {
                ...
                /**
                 * REGISTRO C890: Resumo Di rio do CF-e SAT
                 */
            ...
            for(Eaa01 eaa01 : eaa01s) {
                ...
                if(eaa01.eaa01sitDoc == null) {
                    if(eaa01.eaa01esMov == 0) {
                        throw new ValidacaoException("A situa  o do documento n o foi informada. Documento de entrada: " + abb01.abb01num);
                    }else {
                        throw new ValidacaoException("A situa  o do documento n o foi informada. Documento de sa da: " + abb01.abb01num);
                    }
                }
                ...
                if("02".equals(aaj03.aaj03efd) || "03".equals(aaj03.aaj03efd)) {
                    ...
                    txt2.print(eaa0102.eaa0102frete == null ? 1 : eaa0102.eaa0102frete);
                    txt2.print(formatarValor(eaa01.eaa01totItens, 2));
                ...
                /**
                 * REGISTRO D101: Informa  o Complementar dos Documentos Fiscais quando das Opera  es Interestaduais destinadas a consumidor final n o contribuinte EC 87/15
                 */
                ...
                /**
                 * REGISTRO D190 - Registro Anal tico do Documento (C digo 07, 08, 8B, 09, 10, 11, 26, 27, 57 e 67)
                 */
    ...
    def gerarBlocoE() {
         ...
         */
        Edb01 edb01 = buscarApuracoes(ano, mes, "001");
        if(edb01 == null)throw new ValidacaoException("Necess rio fazer a apura  o do ICMS para gera  o da EFD. Processo cancelado.");
        ...
        txt2.print(formatarValor(jsonEdb01.getBigDecimal_Zero(getCampo(alinApurIcms, "0", "CredorAnt")), 2));
        ...
        for(Edb01 edb01st : edb01s) {
            ...
            /**
             * REGISTRO E220 - Ajuste/Benef cio/Incentivo da Apura  o do ICMS Subtitui  o Tribut ria
             */
        ...
        /**
         * REGISTRO E300 - Per odo de Apura  o do ICMS Diferencial de Al quota - UF Origem/DestinoEC 87/15
         */
        ...
        for(Edb01 edb01dif : edb01s) {
            ...
            /**
             * REGISTRO E311 - Ajuste/Benef cio/Incentivo da Apura  o do ICMS Diferencial Al quota
             */
            ...
            for(Edb0101 edb0101 : edb0101s) {
                ...
                /**
                 * REGISTRO E312 - Informa  es Adicionais dos Ajustes
                 */
                def edb01011s = buscarInformacoesAdicionais(edb0101.edb0101id);
                for(Edb01011 edb01011 : edb01011s) {
                    verificarProcessoCancelado();
            ...
            /**
             * REGISTRO E316 - Obriga  es do ICMS Recolhido ou a Recolher
             */
        ...
        if(aac13.aac13tipoAtiv.equals(0)) {
            ...
            if(edb01s == null || edb01s.size() == 0) throw new ValidacaoException("Necess rio fazer a apura  o do IPI para gera  o da EFD. Processo cancelado.");
            ...
            for(Edb01 edb01ipi : edb01s) {
               ...
               /**
                ...
                /**
                 * REGISTRO E530 - Ajuste da Apura  o do IPI
                 */
    ...
    def gerarBlocoG() {
        ...
        if(ecc01s != null && ecc01s.size() > 0) {
            ...
            def fator = BigDecimal.ZERO;


            def ecc0101Valores = buscarValoresDoFatorVariavelCIAP(mes, ano);
            if(ecc0101Valores != null) {
                totalSaidas = ecc0101Valores.ecc0101json.getBigDecimal_Zero("vlr_contabil");
                ...
                if(ecc01.MODELO_MODELO_D_48) {
                    ...
                    def icms = ecc0101Valores.ecc0101json.getBigDecimal_Zero("icm_icm");
                    def outras = ecc0101Valores.ecc0101json.getBigDecimal_Zero("icm_outras");
                    totalTribExp = icms.add(outras).add(isentas).add(ipi);
                }
            }
            ...
            for(Ecc01 ecc01 : ecc01s) {
                ...
                tm.put("icmsPropria", ecc01.ecc01icms_Zero);
                tm.put("icmsST", BigDecimal.ZERO);
                tm.put("icmsFrete", BigDecimal.ZERO);
                tm.put("icmsAliq", BigDecimal.ZERO);
                tm.put("parcela", ecc0101 == null ? 0 : ecc0101.ecc0101parcela);
                tm.put("icms", ecc0101 == null ? 0 : ecc0101.ecc0101icms);
                tm.put("abb20", abb20);

                if(tm.getString("tipoMov").equals("SI")) sdoInicial = sdoInicial.add(ecc0101.ecc0101icms);

                if(ecc0101 != null) {
                    totalIcmsAprop = totalIcmsAprop.add(jsonEcc0101.getBigDecimal("icm_variavel") != null ? jsonEcc0101.getBigDecimal("icm_variavel") : totalIcmsAprop);
                    fator = ecc0101.ecc0101fator_Zero;
                }

                totalIcmsCiap = totalIcmsCiap.add(ecc01.ecc01icms_Zero);
            ...
            txt2.print(dtInicial.format(ddMMyyyy));
            txt2.print(dtFinal.format(ddMMyyyy));
            txt2.print(formatarValor(totalIcmsCiap, 2));
            ...
            for(int i = 0; i < mapG125.size(); i++) {
                ...
                txt2.print(formatarValor(mapG125.get(i).getBigDecimal_Zero("uforig_icms"), 2));
                txt2.print(mapG125.get(i).getInteger("parcela"));
                txt2.print(formatarValor(mapG125.get(i).getBigDecimal_Zero("icms"), 2));
                txt2.newLine();
                qtLinG125++;
                qtLinBlocoG++;
            ...
            if(bcb11s != null && bcb11s.size() > 0) {
                ...
                for(Bcb11 bcb11 : bcb11s) {
                    ...
                    if(abm01 != null) {
                        ...
                        Aam06 aam06uma = abm0101.abm0101uma != null ? getSession().get(Aam06.class, abm0101.abm0101uma.aam06id) : null;
        ...
        if(gerarBlocoH) {
            ...
            if(mapH010.size() > 0) {
                for(int i = 0; i < mapH010.size(); i++) {
                    ...
                    def codigo = mapH010.get(i).getString("cod_item");
     ...
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * * * * * * * BLOCO K: CONTROLE DA PRODU  O E ESTOQUE * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     */
    def gerarBlocoK() {
        ...
        if(comMovimentoBlocoK){
            ...
            /**
             * REGISTRO K100 - Per odo de Apura  o
             */
            verificarProcessoCancelado();
        ...
        /**
         * REGISTRO K270 - Corre  o de Apontamento
         */
        ...
        /**
         * REGISTRO K280 - Corre  o de Apontamento
         */
        ...
        /**
         * REGISTRO K290 - Produ  o Conjunta e K291 - Produ  o Conjunta - Itens Produzidos
         */
        ...
        /**
         * REGISTRO K300 - Produ  o Conjunta por Terceiros e K301 - Produ  o Conjunta por Terceiros - Itens Produzidos
         */
    ...
    def gerarBloco1() {
        ...
        /**
         * REGISTRO 1601 - OPERA  ES COM INSTRUMENTOS DE PAGAMENTOS ELETR NICOS
         */
    ...
    private String definirTipoMov(Ecc01 ecc01, Ecc0101 ecc0101){
        ...
        if(ecc0101 == null && abb20.abb20baixa != null) { 															//Significa que o bem n o tem mais ciap, foi baixado
            if(abb20.abb20clasBx == 0){																				//AT   Aliena  o ou Transfer ncia: quando o bem estiver baixado e a data da baixa estiver contida no per odo informado na tela e a classifica  o da baixa for igual a 0
                tipo = "AT";
            }else if(abb20.abb20clasBx == 1){																		//PE   Perecimento, Extravio ou Deteriora  o: quando o bem estiver baixado e a data da baixa estiver contida no per odo informado na tela e a classifica  o da baixa for igual a 1
                tipo = "PE";
            }else {
                tipo = "OT";																						//OT   Outras Sa das do Imobilizado: quando o bem estiver baixado e a data da baixa estiver contida no per odo informado na tela e a classifica  o da baixa for igual a 2
            }
            ...
            if(ecc0101.ecc0101parcela > 1) { 																		//SI   Saldo Inicial: quando a parcela for maior que 1
                ...
                tipo = "IM";	 																					//IM   Imobiliza  o: quando a parcela for igual a 1
                if(abb20.abb20construcao == 1 && !abb20.abb20codigo.substring(7).equals("000")) tipo = "IA";		//IA   Imobiliza  o em Andamento: quando a parcela for igual a 1 e for bem em constru  o
                if(ecb01 != null && ecb01.ecb01ativoCirc == 1) tipo = "MC";											//MC   Imobiliza  o de Ativo Circulante: quando a parcela for igual a 1 e a origem do bem for do ativo circulante

            }else if(ecc0101.ecc0101parcela == ecc0101s.size()) {													//BA   Baixa (fim da apropria  o): quando for a  ltima parcela
                tipo = "BA";

            }
        }

        //CI   Conclus o de Imobiliza  o em Andamento: n o implementado no SAM. No processo de agrupamento as fichas CIAP continuam vinculadas aos componentes que deram origem ao bem constru do.
    ...
    //Havendo uma entidade com mais de uma IE ser  gerado o c digo + IE pois a entidade deve se repetir no registro 0150
    ...
    private void validacoes(List<Eaa01> eaa01s) {
        for(Eaa01 eaa01 : eaa01s) {
            Eaa0102 eaa0102 = getSession().get(Eaa0102.class, Criterions.eq("eaa0102doc", eaa01.eaa01id));
            Abb01 abb01 = getSession().get(Abb01.class, eaa01.eaa01central.abb01id);
            if(abb01.abb01ent == null) throw new ValidacaoException("A entidade do documento n o foi informada. Documento de " + (eaa01.eaa01esMov == 0 ? "entrada" : "sa da") + ": " + abb01.abb01num);

            if(eaa01.eaa01sitDoc == null) throw new ValidacaoException("A situa  o do documento n o foi informada. Documento de " + (eaa01.eaa01esMov == 0 ? "entrada" : "sa da") + ": " + abb01.abb01num);
            ...
            if(abe0101 == null) throw new ValidacaoException("O documento de " + (eaa01.eaa01esMov == 0 ? "entrada" : "sa da") + " de n mero " + abb01.abb01num + " n o cont m o endere o da entidade.");
        }
    }
    ...
    List<TableMap> comporRegistrosC110eFilhos(Boolean isNFePropria, Eaa01 eaa01, Eaa0102 eaa0102, Aac10 aac10, TableMap map0450, String perfil) {
        /**
         * Registro C110: Informa  o complementar
         */
        ...
        if(gerarRegByPerfil(perfil, "C112", eaa01.eaa01esMov)) {
            ...
            if(eaa0105s != null && eaa0105s.size() > 0) {
                ...
                if(eaa01.eaa01obsFisco == null) comporRegistroC110(mapRegistroC110, "Documento com arrecada  o referenciado", map0450);
                def tm = new TableMap();
         ...
         * Documentos de Sa da com modelo 01, 1B e 04 e
         * endere o de entrega seja diferente do endere o do destinat rio ou endere o de saida seja diferente do endere o do emitente
         */
    ...
    def comporRegistro0200(Abm01 abm01) {
        ...
        if(abm0101.abm0101uma != null) set0190.add(abm0101.abm0101uma.aam06id); //adiciona a unidade de medida auxiliar pois usa no registro 0200
    ...
    def comporRegistro0220(Abm01 abm01, Aam06 aam06, boolean isSaida) {
        ...
        if(abm0101.abm0101umt != null && abm0101.abm0101umt.aam06id != abm0101.abm0101uma.aam06id){
            if(abm13 != null) {
                if (isSaida) {
                    if (abm13 != null) {
                    ...
                    mapUnid.put(abm0101.abm0101umt.aam06id, abm0101.abm0101fcUA);
                }
            }
