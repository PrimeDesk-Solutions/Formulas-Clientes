package During.formulas.srf.nfe
...
//		}
		...
		for(Eaa0104 eaa0104 : eaa0104s) {
			...
			Aag02 aag02 = getSession().get(Aag02.class, "aag02id, aag02uf", eaa0104.eaa0104embUF.aag02id)
			
			if(eaa0104.eaa0104embLocal != null) {
				ElementXml exporta = infNfe.addNode("exporta");
				exporta.addNode("UFSaidaPais", eaa0104.eaa0104embUF == null ? null : aag02.aag02uf, true);
...
//		put("tagsAssinar", "infNFe"); //Descomentar essa linha quando a nota precisar ser assinada pelo SAM
	...
	private void item() {
		...
		for(Eaa0103 eaa0103 : eaa0103sOrdem) {
			...
			prod.addNode("qTrib", eaa0103.eaa0103qtComl == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("113-I14","qTrib")), 4, true), false);
			...
			/** Grupo Diversos (I07) */
			prod.addNode("nFCI", jsonEaa0103.getString("nfci") != null ? jsonEaa0103.getString("nfci") : null, false);
				...
				if(cstIpi != null) {
					...
					if(cstIpi.equals("00") || cstIpi.equals("49") || cstIpi.equals("50") || cstIpi.equals("99")) {
						...
						if(getCampo("257-O13","pIPI") != null && jsonEaa0103.getBigDecimal_Zero(getCampo("257-O13","pIPI")).compareTo(new BigDecimal(0)) != 0) {
							...
							IPITrib.addNode("pIPI", getCampo("257-O13","pIPI") == null || jsonEaa0103.getBigDecimal(getCampo("257-O13","pIPI")) == -1 ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("257-O13","pIPI")), 2, false), true);
						}else {
