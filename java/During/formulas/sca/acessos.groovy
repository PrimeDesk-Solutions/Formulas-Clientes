...
public class acessos extends FormulaBase {
	...
	public void executar() {
		...
		//Considerar até 05 minutos de falta como atraso
		if(fca10.fca10horFalt <= 5) {
		    fca10.fca10folha00 = fca10.fca10horFalt;
		if(fca10.fca10horFalt != 0) fca10.fca10eve00 = buscarEventoPorCodigo("1304");
		}
		
		//Considerar acima de 05 minutos de falta como falta infustificada
		if(fca10.fca10horFalt > 5) {
			fca10.fca10folha00 = fca10.fca10horFalt;
			fca10.fca10eve00 = buscarEventoPorCodigo("2004");
		}
	}
