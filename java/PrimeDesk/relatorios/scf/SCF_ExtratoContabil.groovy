...
class SCF_ExtratoContabil extends RelatorioBase {
    ...
    private List<TableMap> buscarDados(List<Long> empresa, Integer classe, Integer ordem, Integer tipo, Integer numeroInicial, Integer numeroFinal,
        ...
        String sql ="SELECT \n" +
                ...
                "\n" +
                "CASE WHEN (daa01json ->>'jurosq') NOTNULL \n" +
                "THEN (daa01json ->>'jurosq')::numeric ELSE 0.00 END as jurosq, \n" +
                "\n" +
                "CASE WHEN (daa01json ->>'multaq') NOTNULL \n" +
                "THEN (daa01json ->>'multaq')::numeric ELSE 0.00 END as multaq, \n" +
                "\n" +
                "CASE WHEN (daa01json ->>'encargosq') NOTNULL \n" +
                "THEN (daa01json ->>'encargosq')::numeric ELSE 0.00 END as encargosq, \n" +
                "\n" +
                "CASE WHEN (daa01json ->>'descontoq') NOTNULL \n" +
                "THEN (daa01json ->>'descontoq')::numeric ELSE 0.00 END as descontoq, \n" +
                " \n" +
                "daa01valor as vlr\n" +
                "\n" +
                "FROM Daa01\n" +
