...
public class Doc_Padrao_SaidaForaEstado extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Total do Documento
            eaa0103.eaa0103totDoc = (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("acrescimo_inc_") + jsonEaa0103.getBigDecimal_Zero("icms_st") - jsonEaa0103.getBigDecimal_Zero("desconto")).round(2);
    ...
    private void definirCFOP(Boolean dentroEstado) {
        ...
        if(eaa0103.eaa0103cstIcms != null){
            if(!dentroEstado){
                ...
                primeiroDigito = cfop.substring(0,1);
                cfop = cfop.substring(1);
    ...
    private void calcularICMSST() {
        ...
        if (jsonEaa0103.getBigDecimal_Zero("aliq_icms_st") != -1) {
            ...
            //VALOR PARA O ESTADO DE SP
            BigDecimal sp = jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * 0.18;

            BigDecimal difST = sp - jsonEaa0103.getBigDecimal_Zero("icms");

            // VALOR ICMS ST
            jsonEaa0103.put("icms_st", (difST + jsonEaa0103.getBigDecimal_Zero("vlr_fcp")).round(2));
    ...
    private calcularFCP(){
        if(jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fcp") > 0 ){
            ...
            jsonEaa0103.put("vlr_fcp", (jsonEaa0103.getBigDecimal_Zero("bc_fcp") * jsonEaa0103.getBigDecimal_Zero("aliq_fcp") / 100).round(2));
        }
    }
    ...
    private void calculaPIS() {
        if (jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_pis") > 0 && eaa0103.eaa0103cstPis != null) {
    ...
    private calculaCOFINS() {
        if (jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_cofins") > 0 && eaa0103.eaa0103cstCofins != null) {
    ...
    private void preencherSPEDS() {
        ...
        jsonEaa0103.put("red_bc_icms_sped", jsonEaa0103.getBigDecimal_Zero("aliq_red_bc_icms"));
