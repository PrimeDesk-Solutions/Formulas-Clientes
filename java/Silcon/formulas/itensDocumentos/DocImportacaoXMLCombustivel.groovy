...
public class DocImportacaoXMLCombustivel extends FormulaBase {
    ...
    public void executar() {
        ...
        if (aaj10_cstIcms == null) throw new ValidacaoException("Não foi preenchido CST ICMS no parametro FISCAL do item " + abm01.abm01codigo + "-" + abm01.abm01na);
    ...
    private void calcularItem() {
        ...
        jsonEaa0103.put("volumes", (eaa0103.eaa0103qtComl * abm13.abm13fcVW).round(3));
    ...
    private void definirCFOP (Boolean dentroEstado) {
        ...
        if (eaa0103.eaa0103cstIcms.aaj10codigo == '060' || eaa0103.eaa0103cstIcms.aaj10codigo == '061' || eaa0103.eaa0103cstIcms.aaj10codigo == '160' || eaa0103.eaa0103cstIcms.aaj10codigo == '260'){
            cfop = "1653";
        }
        ...
        if (!dentroEstado) {
            ...
            if (aaj15_cfop == null) throw new ValidacaoException("CFOP " + cfop + " não localizado no sistema.");
        }
