...
public class Doc_Padrao_EntradaCTe extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if (jsonEaa0103.getBigDecimal_Zero("icms_st") != 0) {
                ...
                jsonEaa0103.put("total_doc_c__st", (eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("icms_st")).round(2));
    ...
    private void calcularIPI() {
        ...
        if (jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != -1) {
            ...
            if (jsonEaa0103.getBigDecimal_Zero("aliq_ipi") == -1) {
                ...
                jsonEaa0103.put("ipi_outras", new BigDecimal(-1));
                jsonEaa0103.put("ipi", new BigDecimal(-1));
                jsonEaa0103.put("aliq_ipi", new BigDecimal(-1));
                jsonEaa0103.put("bc_ipi", new BigDecimal(-1));
            }
    ...
    private void calcularIcmsST() {
        ...
        if (abm10.abm1001s != null) { //Cálculo do ICMS ST considera os percentuais por estado (item - Estado)

            // Alíquota ICMS_ST = Aliquota para operações internas do cadastro de Estados da entidade destino
            jsonEaa0103.put("aliq_icms_st", jsonAag02.getBigDecimal_Zero("aliq_icms_interna"));
