...
public class DevolucaoNfe_Desconto_Proporcional extends FormulaBase {
...
//                if (jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_icms_st") != -1)
                if (jsonAbm1001_UF_Item != null) {
                    jsonEaa0103.put("icms_ret", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_icms_ret"));
                ...
                if (ivaST > 0) {
                    ...
                    jsonEaa0103.put("icms_ret", new BigDecimal(0));
    ...
    private void calcularICMS (Integer contribICMS) {
        ...
        if (eaa0103.eaa0103cstIcms != null) {
            cstIcms = eaa0103.eaa0103cstIcms.aaj10codigo;
        }

        // Alíquota Icms
        if (cstIcms == "000" || cstIcms == "200") {
            jsonEaa0103.put("aliq_icms", jsonAbm0101.getBigDecimal_Zero("aliq_icms"));
        }
    ...
    private void calcularIcmsSTRegime() {
        // ********  ICMS ST Retido - Regime "Substituto Tributário" ********
            ...
            if (jsonEaa0103.getBigDecimal_Zero("vlr_icms_ret") == 0) {
                ...
                if (jsonAbm1001_UF_Item != null){
                    jsonEaa0103.put("icms_ret", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fixa_icms"));
