...
public class SRF_Importa_XML_Transferencia extends FormulaBase {
    ...
    private void definirCFOP(Boolean dentroEstado) {
        ...
        if(eaa0103.eaa0103cstIcms == null) throw new ValidacaoException("Não foi informado CST de ICMS no item " + eaa0103.eaa0103seq + " do documento.")

        String cst = eaa0103.eaa0103cstIcms.aaj10codigo;
        String cfop = "1152";
