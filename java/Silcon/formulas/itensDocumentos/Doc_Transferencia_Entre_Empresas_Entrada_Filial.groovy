...
public class Doc_Transferencia_Entre_Empresas_Entrada_Filial extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // ICMS Isento
            if (eaa0103.eaa0103cstIcms.aaj10codigo == '060' || eaa0103.eaa0103cstIcms.aaj10codigo == '040' || eaa0103.eaa0103cstIcms.aaj10codigo == '240' ||
