...
public class DocSaidaConsumidorFinalPcd60012 extends FormulaBase {
    ...
    private void calculoFCP() {

        //%FCP
        if (jsonAbm1001_UF_Item != null) {
            if (jsonAbm1001_UF_Item.getBigDecimal_Zero("fcp") != 0) {
                jsonEaa0103.put("fundopobreza", jsonAbm1001_UF_Item.getBigDecimal_Zero("fcp"));
            }

            //Calculo (FCP)
            if (jsonEaa0103.getBigDecimal_Zero("fundopobreza") > 0) {
                jsonEaa0103.put("fundopobreza", (jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("vlrfundpobreza")) / 100)
                jsonEaa0103.put("fundopobreza", jsonEaa0103.getBigDecimal_Zero("fundopobreza").round(3));
            }
        }
    }
    ...
    private void calcularFCP() {
        if (jsonAbm1001_UF_Item.getBigDecimal_Zero("fcp") > 0) {
            ...
            jsonEaa0103.put("vlr_fcp", (jsonEaa0103.getBigDecimal_Zero("bc_icms_st") * jsonEaa0103.getBigDecimal_Zero("aliq_fcp")) / 100);
            jsonEaa0103.put("vlr_fcp",  jsonEaa0103.getBigDecimal_Zero("vlr_fcp").round(3));
        }
    }
