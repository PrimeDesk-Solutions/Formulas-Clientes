...
class NFCe extends FormulaBase {
    ...
    public void executar() {
        ...
        ICMSTot.addNode("qBCMonoRet", getCampo("331.04a-W06d.1", "qBCMonoRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa01.getBigDecimal(getCampo("331.04a-W06d.1", "qBCMonoRet")), 2, false), true);
        ICMSTot.addNode("vICMSMonoRet", getCampo("331.05-W06e", "vICMSMonoRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa01.getBigDecimal(getCampo("331.05-W06e", "vICMSMonoRet")), 2, false), true);
        ...
        ICMSTot.addNode("vTotTrib", getCampo("341a-W16a", "vTotTrib") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa01.getBigDecimal(getCampo("341a-W16a", "vTotTrib")), 2, false), true);
...
//		put("tagsAssinar", "infNFe"); //Descomentar essa linha quando a nota precisar ser assinada pelo SAM
    ...
    private void item() {
        ...
        for(Eaa0103 eaa0103 : eaa0103sOrdem) {
            ...
            det.setAttribute("nItem", eaa0103.eaa0103seq.toString());
...
//            }
            ...
            for(Eaa01034 eaa01034 : eaa0103.eaa01034s) {
                ...
                DI.addNode("dDI", eaa01034.eaa01034dtReg == null ? null : NFeUtils.formatarData(eaa01034.eaa01034dtReg) , true);
                ...
                DI.addNode("dDesemb", eaa01034.eaa01034dtDesemb == null ? null : NFeUtils.formatarData(eaa01034.eaa01034dtDesemb), true);
            ...
            if(configItem != null && configItem.abm0101fiscal != null && configItem.abm0101fiscal.abm12codANP != null) {
                ...
                /** origComb  - Grupo indicador da origem do combustível  (LA18) */
                if (!"65".equals(modelo)) {
                    origComb = comb.addNode("origComb");
                    origComb.addNode("indImport", getCampo("162r-LA19", "indImport") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("162r-LA19", "indImport ")), 4, false), true);
                    origComb.addNode("cUFOrig", getCampo("162s-LA20", "cUFOrig") == null ? 0 : jsonEaa0103.getBigDecimal(getCampo("162s-LA20", "cUFOrig")).intValue(), true);
                    origComb.addNode("pOrig", getCampo("162t-LA21", "pOrig") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("162t-LA21", "pOrig")), 2, false), true);
                }
            }
                ...
                if(empresa.aac13fiscal.aac13classTrib.aaj01nfe.equals("1")) { //Simples nacional
                    ...
                    if(csosn != null) {
                        ...
                        if(cso.equals("101")) {
                            ...
                            Abd01 abd01 = getSession().get(Abd01.class, eaa01.eaa01pcd.abd01id);
                            if (abd01.abd01codigo == "60402"){
                    ...
                    if(cstIcms != null) {
                        ...
                        if((cst.equals("41")) && getCampo("245.20-N26","vBCSTRet") != null && !jsonEaa0103.getBigDecimal(getCampo("245.20-N26","vBCSTRet")).equals(0)) {
                            ...
                            if(getCampo("245.21b-N27a","vBCFCPSTRet") != null && !jsonEaa0103.getBigDecimal(getCampo("245.21b-N27a","vBCFCPSTRet")).equals(0) ||
                                ...
                                ICMSST.addNode("pFCPSTRet", getCampo("245.21c-N27b","pFCPSTRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.21c-N27b","pFCPSTRet")), 2, false), true);
                            ...
                            if(getCampo("245.23c-N35","vBCEfet") != null && !jsonEaa0103.getBigDecimal(getCampo("245.23c-N35","vBCEfet")).equals(0) ||
                                ...
                                ICMSST.addNode("pRedBCEfet", getCampo("245.23b-N34","pRedBCEfet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.23b-N34","pRedBCEfet")), 4, false), true);
                                ...
                                ICMSST.addNode("pICMSEfet", getCampo("245.23d-N36","pICMSEfet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.23d-N36","pICMSEfet")), 4, false), true);
                            ...
                            if(eaa0103.eaa0103motDesIcms > 0){
                                ICMS41.addNode("qBCMonoRet", getCampo("245.75-N43a","qBCMonoRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.75-N43a","qBCMonoRet")), 2, false), true);
...
//                                ICMS60.addNode("pST", getCampo("216.1-N26a","pST") == null ? "0.00" : jsonEaa0103.getBigDecimal(getCampo("216.1-N26a","pST")).equals(0) ? "0.00" : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("216.1-N26a","pST")), 4, false), true);
                        ...
                        }else if(cst.equals("61")) {
                            /** ICMS00 - CST = 61 - Tributação Monofásica Combustíveis (N08a) */
                            ICMS61 = ICMS.addNode("ICMS61");
                            ICMS61.addNode("orig", orig, true);
                            ICMS61.addNode("CST", cst, true);
                            ICMS61.addNode("qBCMonoRet", getCampo("245.75-N43a","qBCMonoRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.75-N43a","qBCMonoRet")), 2, false), true);
                            ICMS61.addNode("adRemICMSRet", getCampo("245.76-N44","adRemICMSRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.76-N44","adRemICMSRet")), 4, false), true);
                            ICMS61.addNode("vICMSMonoRet", getCampo("245.77-N45","vICMSMonoRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.77-N45","vICMSMonoRet")), 2, false), true);
                            ...
                            ICMS90.addNode("modBC", configItem.abm0101fiscal.abm12modBcIcms, true);
            ...
            //if (!"65".equals(modelo)) {
                ...
                if (cstPis != null) {
                    ...
                    if (getCampo("324s-UA04", "vIPIDevolv") != null && !jsonEaa0103.getBigDecimal(getCampo("324s-UA04", "vIPIDevolv")).equals(0)) {
                        ...
                        if (itemVda != null) {
                            ...
                            impostoDevol.addNode("pDevol", NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal("p_ipi_dev"), 2, false), true);

                            IPI = impostoDevol.addNode("IPI");
                            IPI.addNode("vIPIDevolv", NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("324s-UA04", "vIPIDevolv")), 2, true), true);
                        }
                    } else {
                        ...
                        if(!temISS){
                            ...
                            if(eaa0103.eaa0103cstIcms == null) {
                                ...
                                if(!cstIcms.equals("00") && !cstIcms.equals("10") && !cstIcms.equals("20") && !cstIcms.equals("30") &&
                                        ...
                                        !cstIcms.equals("60") && !cstIcms.equals("61") && !cstIcms.equals("70") && !cstIcms.equals("90")) {
    ...
    private List<Eaa0113> buscarFinanceiroPorDocumento(Long eaa01id) {
        return getAcessoAoBanco().buscarListaDeRegistros(
                "SELECT * FROM Eaa0113 WHERE eaa0113doc = :eaa01id AND eaa0113clasParc = 0",
                Parametro.criar("eaa01id", eaa01id)
        );
    }
