package Silcon.formulas.srf.nfe
...
class NFCe_Reforma extends FormulaBase {
    ...
    private String xmlInfNFeSupl = null;
    private boolean algumItemComIS = false;
    private boolean algumItemComCbsIbs = false;
    private boolean gerouEstornoCred = false;
    ...
    public void executar() {
        ...
        if(getAlinhamento().size() == 0 ) throw new ValidacaoException("O alinhamento 0001 para NFCe não foi encontrado.");
        ...
        /** nfeProc - Nota Fiscal Eletrônica */
        nfeProc = NFeUtils.criarElementXmlNFe("http://www.portalfiscal.inf.br/nfe");
        nfeProc.setAttribute("versao", versaoXMLLayoutNFe);

        /** NFe - Nota Fiscal Eletrônica */
        nfe = nfeProc.addNode("nfe");
        ...
        ide.addNode("tpNFDebito", eaa01.eaa01sitDoc == null ? null : eaa01.eaa01sitDoc.aaj03tipoNfDeb, false);
        ide.addNode("tpNFCredito", eaa01.eaa01sitDoc == null ? null : eaa01.eaa01sitDoc.aaj03tipoNfCred, false);
        ...
        if(eaa0102.eaa0102govTipo != null && eaa0102.eaa0102govTipo != 0){
            ...
            gCompraGov.addNode("tpEnteGov", eaa0102.eaa0102govTipo, true);
            gCompraGov.addNode("pRedutor", NFeUtils.formatarDecimal(eaa0102.eaa0102govRed, 4, false), true);
            gCompraGov.addNode("tpEnteGov", eaa0102.eaa0102govOper, true);
        }

        List<Long> docsRefAntecipacao = buscarDocumentosReferenciados(eaa01.eaa01id, 1);
        if(docsRefAntecipacao != null && docsRefAntecipacao.size() > 0) {
            ElementXml gPagAntecipado = ide.addNode("gPagAntecipado");
            for(Long eaa01Ref : docsRefAntecipacao) {
                String chaveNotaRef = getAcessoAoBanco().obterString("SELECT eaa01nfeChave FROM Eaa01 WHERE eaa01id = " + eaa01Ref);
                gPagAntecipado.addNode("refNFe", chaveNotaRef)
            }
        }
        ...
        ICMSTot.addNode("vProd", NFeUtils.formatarDecimal(eaa01.eaa01totItens, 2, false), true);
        ...
        ICMSTot.addNode("vTotTrib", getCampo("341a-W16a","vTotTrib") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa01.getBigDecimal(getCampo("341a-W16a","vTotTrib")), 2, true), false);

        if(algumItemComIS) {
            def ISTot = total.addNode("ISTot");
            ISTot.addNode("vIS", getDecimalReq(jsonEaa01, "355-W33", "ISTot"))
        }

        if(algumItemComCbsIbs) {
            def IBSCBSTot = total.addNode("IBSCBSTot");
            IBSCBSTot.addNode("vBCIBSCBS", getDecimalReq(jsonEaa01, "355-W35", "vBCIBSCBS"))
            def gIBS = IBSCBSTot.addNode("gIBS");

            def gIBSUF = gIBS.addNode("gIBSUF");
            gIBSUF.addNode("vDif", getDecimalReq(jsonEaa01, "355.8-W38", "vDif"))
            gIBSUF.addNode("vDevTrib", getDecimalReq(jsonEaa01, "355.9-W39", "vDevTrib"))
            gIBSUF.addNode("vIBSUF", getDecimalReq(jsonEaa01, "355-W41", "vIBSUF"))

            def gIBSMun = gIBS.addNode("gIBSMun");
            gIBSMun.addNode("vDif", getDecimalReq(jsonEaa01, "355.13-W43", "vDif"))
            gIBSMun.addNode("vDevTrib", getDecimalReq(jsonEaa01, "355.14-W44", "vDevTrib"))
            gIBSMun.addNode("vIBSMun", getDecimalReq(jsonEaa01, "355-W46", "vIBSMun"))

            gIBS.addNode("vIBS", getDecimalReq(jsonEaa01, "355-W47", "vIBS"))
            gIBS.addNode("vCredPres", getDecimalReq(jsonEaa01, "355.18-W48", "vCredPres"))
            gIBS.addNode("vCredPresCondSus", getDecimalReq(jsonEaa01, "355.19-W49", "vCredPresCondSus"))

            def gCBS = IBSCBSTot.addNode("gCBS");
            gCBS.addNode("vDif", getDecimalReq(jsonEaa01, "355.23-W53", "vDif"))
            gCBS.addNode("vDevTrib", getDecimalReq(jsonEaa01, "355.24-W54", "vDevTrib"))
            gCBS.addNode("vCBS", getDecimalReq(jsonEaa01, "355-W56", "vCBS"))
            gCBS.addNode("vCredPres", getDecimalReq(jsonEaa01, "355.26a-W56a", "vCredPres"))
            gCBS.addNode("vCredPresCondSus", getDecimalReq(jsonEaa01, "355.26b-W56b", "vCredPresCondSus"))

            if(gerouEstornoCred) {
                def gEstornoCred = IBSCBSTot.addNode("gEstornoCred");
                gEstornoCred.addNode("vIBSEstCred", getDecimalReq(jsonEaa01, "355.29f-W59f", "vIBSEstCred"))
        ...
        TreeSet<Eaa0113> eaa0113sOrdem = new TreeSet<Eaa0113>(new Comparator<Eaa0113>() {
            public int compare(Eaa0113 o1, Eaa0113 o2) {
        ...
        if (!"65".equals(modelo)) {
            if (eaa0113s != null && eaa0113s.size() > 0) {
                ...
                fat.addNode("vOrig", eaa01.eaa01totDoc == null ? 0 : NFeUtils.formatarDecimal(eaa01.eaa01totDoc, 2, false), true);
                ...
                fat.addNode("vLiq", eaa01.eaa01totDoc == null ? 0 : NFeUtils.formatarDecimal(eaa01.eaa01totDoc, 2, false), true);
        ...
        if (modelo.equals("65")) {
            ...
            if (tpAmb == "1") {
                ...
                urlqrCode = "https://www.nfce.fazenda.sp.gov.br/NFCeConsultaPublica/Paginas/ConsultaQRCode.aspx";
            } else {
                urlConsulta = "https://www.homologacao.nfce.fazenda.sp.gov.br/consulta"
                urlqrCode = "https://www.homologacao.nfce.fazenda.sp.gov.br/NFCeConsultaPublica/Paginas/ConsultaQRCode.aspx"
            }
            String chave = chaveNfe;
            String idCSC = "1";
            String cscToken;
            ...
            if (tpAmb == "1") {
                ...
                cscToken = jsonAac10.getString("csctoken_homol")
            }

            // Geração do hashSHA1(chave + CSC)
            String dadosn = chave + "|2|" + tpAmb + "|" + idCSC + cscToken;
            String hash = gerarHashSHA1(dadosn).toUpperCase()
        ...
        if (modelo.equals("65")) {
            dados = dados.replace("</NFe>", xmlInfNFeSupl + "</NFe>")
        }
...
//		put("tagsAssinar", "infNFe"); //Descomentar essa linha quando a nota precisar ser assinada pelo SAM
    ...
    private String gerarHashSHA1(String texto) {
        ...
        def hashBytes = md.digest(texto.getBytes("UTF-8"))
        ...
        for(Eaa0103 eaa0103 : eaa0103sOrdem) {
            ...
            if (isProducao) {
                if (jsonEaa0103.getString('cod_cliente') == null) {
                    ...
                    prod.addNode("xProd", eaa0103.eaa0103descr + " -Cód.Item Cliente: " + jsonEaa0103.getString('cod_cliente'), true, 120);
                }
            } else {
                prod.addNode("xProd", "NOTA FISCAL EMITIDA EM AMBIENTE DE HOMOLOGACAO - SEM VALOR FISCAL", true, 120);
            }
            ...
            prod.addNode("uCom", aam06.aam06codigo, true, 6);

            prod.addNode("qCom", eaa0103.eaa0103qtComl == null ? 0 : NFeUtils.formatarDecimal(eaa0103.eaa0103qtComl, 4, false), true);
            prod.addNode("vUnCom", eaa0103.eaa0103unit == null ? 0 : NFeUtils.formatarDecimal(eaa0103.eaa0103unit, 6, false), true);
            prod.addNode("vProd", eaa0103.eaa0103total == null ? 0 : NFeUtils.formatarDecimal(eaa0103.eaa0103total, 2, false), true);
            ...
            prod.addNode("uTrib", aam06UMT == null ? null : aam06UMT.aam06codigo, true, 6);

            prod.addNode("qTrib", eaa0103.eaa0103qtComl == null ? 0 : NFeUtils.formatarDecimal(eaa0103.eaa0103qtComl, 4, false), true);
            prod.addNode("vUnTrib", eaa0103.eaa0103unit == null ? 0 : NFeUtils.formatarDecimal(eaa0103.eaa0103unit, 6, false), true);
            ...
            } else if(eaa01.eaa01sitDoc.aaj03nfe != Aaj03.NFE_NOTA_DE_CREDITO && eaa01.eaa01sitDoc.aaj03nfe != Aaj03.NFE_NOTA_DE_DEBITO) {
                ...
                if(empresa.aac13fiscal.aac13classTrib.aaj01nfe.equals("1")) { //Simples nacional
                    ...
                    if(csosn != null) {
                        ...
                        if(cso.equals("101")) {
                            ...
                            ICMSSN201.addNode("pMVAST", getCampo("245.31-N19","pMVAST") == null ? null : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.31-N19","pMVAST")), 2, true), false);
                            ...
                            ICMSSN202.addNode("pMVAST", getCampo("245.42-N19","pMVAST") == null ? null : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.42-N19","pMVAST")), 2, true), false);
...
//							}
                            ...
                            if(getCampo("245.63-N21","vBCST") != null && !jsonEaa0103.getBigDecimal(getCampo("245.63-N21","vBCST")).equals(0)){
                                ...
                                ICMSSN900.addNode("pMVAST", getCampo("245.61-N19","pMVAST") == null ? null : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.61-N19","pMVAST")), 2, true), false);
                        ...
                        Aaj10 aaj10 = getAcessoAoBanco().buscarRegistroUnicoById("Aaj10", eaa0103.eaa0103cstIcms.aaj10id);
                        String cstIcms = aaj10.aaj10codigo;
                        String orig = cstIcms.substring(0, 1);
                        String cst = cstIcms.substring(1);
                        if(cst.equals("61"))
                        /** ICMS00 - CST = 61 - Tributação Monofásica Combustíveis (N08a) */
                            ICMS00 = ICMS.addNode("ICMS61");
                        ICMS00.addNode("orig", orig, true);
                        ICMS00.addNode("CST", cst, true);
                        ICMS00.addNode("qBCMonoRet", getCampo("245.75-N43a", "qBCMonoRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.75-N43a", "qBCMonoRet")), 2, false), true);
                        ICMS00.addNode("adRemICMSRet", getCampo("245.76-N44", "adRemICMSRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.76-N44", "adRemICMSRet")), 4, false), true);
                        ICMS00.addNode("vICMSMonoRet", getCampo("245.77-N45", "vICMSMonoRet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245.77-N45", "vICMSMonoRet")), 2, false), true);
                    }
                    ...
                    if(cstIcms != null) {
                        String orig = cstIcms.substring(0, 1);
                        String cst = cstIcms.substring(1);
                        //(cst.equals("41") || cst.equals("60")) && getCampo("245.20-N26","vBCSTRet") != null && !jsonEaa0103.getBigDecimal(getCampo("245.20-N26","vBCSTRet")).equals(0)
...
//                                ICMS60.addNode("pST", getCampo("216.1-N26a","pST") == null ? "0.00" : jsonEaa0103.getBigDecimal(getCampo("216.1-N26a","pST")).equals(0) ? "0.00" : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("216.1-N26a","pST")), 4, false), true);
            ...
            if(cstPis != null) {
                ...
                if((getCampo("245a.03-NA03","vBCUFDest") != null && !jsonEaa0103.getBigDecimal(getCampo("245a.03-NA03","vBCUFDest")).equals(0)) ||
                    ...
                    if(idDest == 2 && eaa0102.eaa0102consFinal == 1 && indIEDest == 9 && !temISS){
                        ...
                        ICMSUFDest.addNode("vICMSUFRemet", getCampo("245a.17-NA17","vICMSUFRemet") == null ? 0 : NFeUtils.formatarDecimal(jsonEaa0103.getBigDecimal(getCampo("245a.17-NA17","vICMSUFRemet")), 2, false), true);
                    }
                }
                ...
                if(getCampo("324s-UA04","vIPIDevol") != null && !jsonEaa0103.getBigDecimal(getCampo("324s-UA04","vIPIDevol")).equals(0)) {
                    ...
                    getCampo("324s-UA04", "vIPIDevolv") == 0.00
                    getCampo("337.01-W12a", "vIPIDevol") == 0.00
                }
            ...
            Aaj06 aaj06 = eaa0103.eaa0103clasTribIS
            if(aaj06 != null){
                algumItemComIS = true;
                def IS = imposto.addNode("IS");
                IS.addNode("CST", aaj06.aaj06codigo.substring(0, 3) , true);
                IS.addNode("cClassTrib", aaj06.aaj06codigo, true);
                IS.addNode("vBCIS", getDecimalReq(jsonEaa0103, "324-UB05", "vBCIS"));
                IS.addNode("pIS", getDecimalReq4Dig(jsonEaa0103, "324-UB06", "pIS"));
                IS.addNode("pISEspec", getDecimal(jsonEaa0103, "324.07-UB07", "pISEspec"));
            ...
            if(aaj07 != null && aaj07.getAaj07json() != null) {
                ...
                if(doacao) {
                    IBSCBS.addNode("indDoacao", 1, false);
                }
                ...
                if(aaj07json.getInteger("exige_tributacao") == 1){
                    if(aaj07json.getBoolean("transf_cred")){
                        ...
                        gTransfCred.addNode("vCBS", getDecimalReq(jsonEaa0103, "324.108-UB108", "vCBS"));

                    }else if(aaj07json.getBoolean("ajuste_comp")){
                        def gAjusteCompet = IBSCBS.addNode("gAjusteCompet");
                        def competApur = jsonEaa0103.getDate(getCampo("324.113-UB113", "competApur"))
                        if(competApur != null) gAjusteCompet.addNode("competApur", NFeUtils.formatarData(competApur, "yyyy-MM"), true);
                        gAjusteCompet.addNode("vIBS", getDecimalReq(jsonEaa0103, "324.114-UB114", "vIBS"));
                        gAjusteCompet.addNode("vCBS", getDecimalReq(jsonEaa0103, "324.115-UB115", "vCBS"));

                    }else{
                        def gIBSCBS = IBSCBS.addNode("gIBSCBS");
                        gIBSCBS.addNode("vBC", getDecimalReq(jsonEaa0103, "324-UB16", "vBC"));
                        gerarIBSUF(gIBSCBS, jsonEaa0103, aaj07json)
                        gerarIBSMun(gIBSCBS, jsonEaa0103, aaj07json)
                        gIBSCBS.addNode("vIBS", getDecimalReq(jsonEaa0103, "324-UB54a", "vIBS"));
                        gerarCBS(gIBSCBS, jsonEaa0103, aaj07json)

                        Aaj07 aaj07Regular = eaa0103.eaa0103clasTribCbsIbsReg
                        if(aaj07json.getBoolean("tributacao") && aaj07Regular != null){

                            def gTribRegular = gIBSCBS.addNode("gTribRegular");
                            gTribRegular.addNode("CSTReg", aaj07Regular.aaj07codigo.substring(0, 3));
                            gTribRegular.addNode("cClassTribReg", aaj07Regular.aaj07codigo);
                            gTribRegular.addNode("pAliqEfetRegIBSUF", getDecimalReq4Dig(jsonEaa0103, "324.71-UB71", "pAliqEfetRegIBSUF"));
                            gTribRegular.addNode("vTribRegIBSUF", getDecimalReq(jsonEaa0103, "324.72-UB72", "vTribRegIBSUF"));
                            gTribRegular.addNode("pAliqEfetRegIBSMun", getDecimalReq4Dig(jsonEaa0103, "324.72a-UB72a", "pAliqEfetRegIBSMun"));
                            gTribRegular.addNode("vTribRegIBSMun", getDecimalReq(jsonEaa0103, "324.72b-UB72b", "vTribRegIBSMun"));
                            gTribRegular.addNode("pAliqEfetRegCBS", getDecimalReq4Dig(jsonEaa0103, "324.72c-UB72c", "pAliqEfetRegCBS"));
                        ...
                        if(getDecimal(aaj07json, "324-UB82b", "pAliqIBSUF") != null && !getDecimal(aaj07json, "324-UB82b", "pAliqIBSUF") == 0) {
                            ...
                            gTribCompraGov.addNode("pAliqIBSMun", getDecimalReq4Dig(jsonEaa0103, "324-UB82d", "pAliqIBSMun"));
                            gTribCompraGov.addNode("vTribIBSMun", getDecimalReq(jsonEaa0103, "324-UB82e", "vTribIBSMun"));
                            gTribCompraGov.addNode("pAliqCBS", getDecimalReq4Dig(jsonEaa0103, "324-UB82f", "pAliqCBS"));
                ...
                if(aaj07json.getBoolean("estorno_cred")) {
                    ...
                    gEstornoCred.addNode("vIBSEstCred", getDecimalReq(jsonEaa0103, "324.117-UB117", "vIBSEstCred"));
                    gEstornoCred.addNode("vCBSEstCred", getDecimalReq(jsonEaa0103, "324.118-UB118", "vCBSEstCred"));
                }

                if(aaj07json.getBoolean("cred_pres_ibs_zfm")) {
                    def gCredPresIBSZFM = IBSCBS.addNode("gCredPresIBSZFM");
                    def competApur = jsonEaa0103.getDate(getCampo("324.132-UB132", "competApur"));
                    if(competApur != null) gCredPresIBSZFM.addNode("competApur", NFeUtils.formatarData(competApur, "yyyy-MM"), true);
                    gCredPresIBSZFM.addNode("tpCredPresIBSZFM", eaa0103.eaa0103credPresIbsZFM, true);
                    gCredPresIBSZFM.addNode("vCredPresIBSZFM", getDecimalReq(jsonEaa0103, "324.134-UB134", "vCredPresIBSZFM"));

                }else if(aaj07json.getBoolean("cred_presumido")) {
                    Aaj25 aaj25 = eaa0103.eaa0103credPresCbsIbs
                    if(aaj25 != null) {
                        def gCredPresumido = IBSCBS.addNode("gCredPresumido");
                        gCredPresumido.addNode("vBCCredPres", getDecimalReq(jsonEaa0103, "324.121-UB121", "vBCCredPres"));
                        gCredPresumido.addNode("cCredPres", aaj25.aaj25codigo);

                        TableMap aaj25json = aaj25.aaj25json;
                        if (aaj25json != null){
                            if (aaj25json.getBoolean("cred_presumido_ibs")) {
                                def gIBSCredPres = gCredPresumido.addNode("gIBSCredPres");

                                gIBSCredPres.addNode("pCredPres", getDecimalReq4Dig(jsonEaa0103, "324.124-UB124", "pCredPres"));
                                gIBSCredPres.addNode("vCredPres", getDecimalReq(jsonEaa0103, "324.125-UB125", "vCredPres"));
                                gIBSCredPres.addNode("vCredPresCondSus", getDecimalReq(jsonEaa0103, "324.126-UB126", "vCredPresCondSus"));
                            }
                            if (aaj25json.getBoolean("cred_presumido_cbs")) {
                                def gCBSCredPres = gCredPresumido.addNode("gCBSCredPres");

                                gCBSCredPres.addNode("pCredPres", getDecimalReq4Dig(jsonEaa0103, "324.128-UB128", "pCredPres"));
                                gCBSCredPres.addNode("vCredPres", getDecimalReq(jsonEaa0103, "324.129-UB129", "vCredPres"));
                                gCBSCredPres.addNode("vCredPresCondSus", getDecimalReq(jsonEaa0103, "324.130-UB130", "vCredPresCondSus"));
                            }
                        }
                    }
                }
    ...
    private void gerarIBSUF(ElementXml gIBSCBS, TableMap jsonEaa0103, TableMap aaj07json) {
        def gIBSUF = gIBSCBS.addNode("gIBSUF");
        gIBSUF.addNode("pIBSUF", getDecimalReq(jsonEaa0103, "324-UB18", "pIBSUF"));

        if (aaj07json.getBoolean("dif_cbsibs")) {
            def gDif = gIBSUF.addNode("gDif");
        ...
        if (aaj07json.getBoolean("red_bc")) {
            ...
            gRed.addNode("pAliqEfet", getDecimalReq4Dig(jsonEaa0103, "324.28-UB28", "pAliqEfet"));
        }
        gIBSUF.addNode("vIBSUF", getDecimalReq(jsonEaa0103, "324-UB35", "vIBSUF"));
    }

    private void gerarIBSMun(ElementXml gIBSCBS, TableMap jsonEaa0103, TableMap aaj07json) {
        def gIBSMun = gIBSCBS.addNode("gIBSMun");
        gIBSMun.addNode("pIBSMun", getDecimalReq(jsonEaa0103, "324-UB37", "pIBSMun"));

        if (aaj07json.getBoolean("dif_cbsibs")) {
            def gDif = gIBSMun.addNode("gDif");
            gDif.addNode("pDif", getDecimalReq(jsonEaa0103, "324.41-UB41", "pDif"));
        ...
        gIBSMun.addNode("vIBSMun", getDecimalReq(jsonEaa0103, "324-UB54", "vIBSMun"));
    }

    private void gerarCBS(ElementXml IBSCBS, TableMap jsonEaa0103, TableMap aaj07json) {
        def gCBS = IBSCBS.addNode("gCBS");
        gCBS.addNode("pCBS", getDecimalReq(jsonEaa0103, "324-UB56", "pCBS"));

        if (aaj07json.getBoolean("dif_cbsibs")) {
            def gDif = gCBS.addNode("gDif");
        ...
        if (aaj07json.getBoolean("red_bc")) {
            ...
            gRed.addNode("pAliqEfet", getDecimalReq4Dig(jsonEaa0103, "324.66-UB66", "pAliqEfet"));
        }
        gCBS.addNode("vCBS", getDecimalReq(jsonEaa0103, "324-UB67", "vCBS"));
    }
    ...
    private List<Long> buscarDocumentosReferenciados(Long eaa01id, int eaa01033clasRef) {
        return getSession().createQuery("SELECT DISTINCT eaa01id" +
                ...
                " WHERE eaa0103item.eaa0103doc = :eaa01id AND eaa01033clasRef = :eaa01033clasRef")
    ...
    private String getDecimal(TableMap json, String registro, String campo) {
        return NFeUtils.formatarDecimal(json.getBigDecimal(getCampo(registro,campo)), 2, false);
    }
    private String getDecimalReq(TableMap json, String registro, String campo) {
        BigDecimal valor = json.getBigDecimal(getCampo(registro,campo));
        if(valor == null || valor.compareTo(BigDecimal.ZERO) == 0) {
            return "0.00"
        }
        return NFeUtils.formatarDecimal(valor, 2, true);
    }
    private String getDecimalReq4Dig(TableMap json, String registro, String campo) {
        BigDecimal valor = json.getBigDecimal(getCampo(registro,campo));
        if(valor == null || valor.compareTo(BigDecimal.ZERO) == 0) {
            return "0.0000"
        }
...
//meta-sis-eyJ0aXBvIjoiZm9ybXVsYSIsImZvcm11bGF0aXBvIjoiNjgifQ==package Silcon.formulas.srf.nfe
//
//import br.com.multiorm.ColumnType
//import br.com.multiorm.criteria.criterion.Criterions
//import br.com.multiorm.criteria.join.Joins
