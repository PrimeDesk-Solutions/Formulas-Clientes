...
class SGT_Apuracao_EFD_ICMS extends FormulaBase {
    ...
    public void executar() {
         ...
         */
        def saldoCredorAnt = buscarSaldoCredorAnterior(getCampo("0", "saldocredor"), edb01.edb01ano, edb01.edb01mes, edb01.edb01tipo.aaj28id);
