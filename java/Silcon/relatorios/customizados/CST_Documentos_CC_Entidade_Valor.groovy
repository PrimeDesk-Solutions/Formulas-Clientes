...
public class CST_Documentos_CC_Entidade_Valor extends RelatorioBase {
    @Override
    public String getNomeTarefa() {
        return "CST - Documentos por C.C Entidades e Valor";
    }
...
//meta-sis-eyJkZXNjciI6IkNTVCAtIERvY3VtZW50b3MgcG9yIEMuQyBFbnRpZGFkZXMgZSBWYWxvciIsInRpcG8iOiJyZWxhdG9yaW8ifQ==