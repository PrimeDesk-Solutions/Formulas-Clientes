...
public class CST_Documentos_Por_Centro_Custos extends RelatorioBase {
    @Override
    public String getNomeTarefa() {
        return "CST - Documentos Por Centro de Custos";
    }
    ...
    public DadosParaDownload executar() {
        ...
        if ( exportar == 0) {
            params.put("TITULO_RELATORIO", "CST - Documentos Por Centro de Custos");
            return gerarPDF("CST_Documentos_Por_Centro_Custos_PDF", dados);
        }


        return gerarXLSX("CST_Documentos_Por_Centro_Custos_Excel", dados);
    }
    ...
    private obterDadosRelatorio(List<Long> Emprs, Integer classe, Integer tp, List<Long> tipoDoc, Integer numeroInicial, Integer numeroFinal, List<Long> entidade, List<Long> departamento, List<Long> naturezas, LocalDate[] dataVenc, Integer opcVcto, LocalDate[] dataEmissao, Integer tipoData, LocalDate[] dtPgtoBaixa, List<Long> port, List<Long> oper, Integer ordem) {
        ...
        String orderBy = "ORDER BY abb11codigo, " + campoData + "daa01valor, abb01num, abb01parcela, abb01serie, abb01quita"
        ...
        String sql = " SELECT DISTINCT daa01id, abe01codigo, abe01na, abb01num,abb01parcela, abb01data, abb01serie, abb01quita,  " +
                "aah01codigo, aah01nome, abe01ni AS cnpj, abb11codigo, abb11nome, abb01serie,  " +
...
//meta-sis-eyJkZXNjciI6IkNTVCAtIERvY3VtZW50b3MgUG9yIENlbnRybyBkZSBDdXN0b3MiLCJ0aXBvIjoicmVsYXRvcmlvIn0=