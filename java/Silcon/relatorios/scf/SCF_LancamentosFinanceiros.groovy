...
public class SCF_LancamentosFinanceiros extends RelatorioBase {
    ...
    public DadosParaDownload executar() {
        ...
        if(impressao == 1 ) return gerarXLSX("SCF_Lancamentos_Financeiros_Excel", dados)
        return gerarPDF("SCF_Lancamentos_Financeiros_PDF", dados, "codigoConta", isSaltarPagina)
    }
