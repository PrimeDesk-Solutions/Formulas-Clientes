...
public class SPV_Vale extends RelatorioBase {
    ...
    public DadosParaDownload executar() {
        ...
        params.put("EMPRESA_RS", obterEmpresaAtiva().getAac10rs());
        params.put("EMPRESA_DDD", obterEmpresaAtiva().getAac10dddFone());
        params.put("EMPRESA_FONE", obterEmpresaAtiva().getAac10fone());
