...
public class SRF_Relatorio_Participacao_Vendas extends RelatorioBase {
    @Override
    ...
    public DadosParaDownload executar() {
        ...
        List<Long> repositorio = getListLong("repositorio");
        ...
        params.put("title", "SRF - Relatório Participação de Vendas");
        ...
        List<TableMap> dados = buscarDocumentos(numDocIni, numDocFin, idsTipoDoc, idsPcd, resumoOperacao, dtEmissao, dtEntradaSaida, idsEntidades, idEmpresa, repositorio);
        ...
        if (impressao == 0) return gerarPDF("SRF_Relatorio_Participacao_Vendas_PDF", dadosRelatorio);

        return gerarXLSX("SRF_Relatorio_Participacao_Vendas_Excel", dadosRelatorio);
    }

    private buscarDocumentos(Integer numDocIni, Integer numDocFin, List<Long> idsTipoDoc, List<Long> idsPcd, Integer resumoOperacao, LocalDate[] dtEmissao, LocalDate[] dtEntradaSaida, List<Long> idsEntidades, Long idEmpresa, List<Long> repositorio) {
        // Data Emissao
        ...
        String whereRepositorio = " AND aba20id IN (:repositorio) ";
        ...
        String sql = "SELECT ent.abe01id AS abe01id, abb01num,abb01data, eaa01esdata, eaa0103id, eaa01id, aba20codigo, aba20descr, " +
                ...
                " INNER JOIN aba2001 ON aba2001ent = abe01id "+
        ...
        return getAcessoAoBanco().buscarListaDeTableMap(sql, parametroEmpresa, parametroNumIni, parametroNumFin, parametroTipoDoc, parametroPcd, parametroDtEmissaoIni, parametroDtEmissaoFin, parametroDtEntradaSaidaIni, parametroDtEntradaSaidaFin, parametroEntidade, parametroRepositorio);
