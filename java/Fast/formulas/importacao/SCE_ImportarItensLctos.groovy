package Fast.formulas.importacao;
...
public class SCE_ImportarItensLctos extends FormulaBase {
    ...
    public void executar() {
        ...
        while(txt.nextLine()) {
            ...
            Long idStatus = Long.parseLong(txt.getCampo(6));
            Long idLocal = Long.parseLong(txt.getCampo(7));
     ...
     *
        ...
        |abm01tipo|abm01codigo|quantidade|valor|lote|serie|validade|fabricacao|Status|Local

        |0|0101001|5.000000|2.50|LRX|1|2023-07-01|2023-05-04|123|1010
        |0|0101001|4.000000|2.45|LRX|2|2023-07-01|2023-05-04|123|1010
        |0|0101001|3.000000|2.30|LRX|3|2023-07-01|2023-05-04|123|1010
        |0|0101002|6.000000|3.75|MTD||2023-08-01|2023-05-05|123|1010
        |0|0101003|7.00|4.10|||||123|1010
