...
public class CompraConsumo_semIpinaBcIcms extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
		  ...
		  jsonEaa0103.put("total_item_estoque", eaa0103.eaa0103total);
            ...
            // IPI Outras
            if(jsonEaa0103.getBigDecimal_Zero("ipi") == 0) jsonEaa0103.put("ipi_outras", eaa0103.eaa0103totDoc);


            if(aaj15_cfop.aaj15codigo == "5902" || aaj15_cfop.aaj15codigo == "1902" ){
