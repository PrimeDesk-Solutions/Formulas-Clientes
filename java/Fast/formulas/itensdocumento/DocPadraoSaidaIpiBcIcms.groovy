...
public class DocPadraoSaidaIpiBcIcms extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            eaa0103.eaa0103qtUso = ((eaa0103.eaa0103qtComl * abm13.abm13fcUV) * abm13.abm13fcVU).round(3);
            ...
            // Peso Líquido
            if (jsonEaa0103.getBigDecimal_Zero("peso-liquido") == 0){
                jsonEaa0103.put("peso_liquido", (eaa0103.eaa0103qtUso * abm01.abm01pesoLiq).round(3));
            }


            // =============================================================================
            // ******************* Quantidade e Unitario Tributavel ************************
            // =============================================================================
            ...
            //Unitario Tributavel
            if(jsonAbm1001_UF_Item.getBigDecimal_Zero("medida_tribut") > 0){
                jsonEaa0103.put("unit_tribut", eaa0103.eaa0103unit / jsonAbm1001_UF_Item.getBigDecimal_Zero("medita_tribut"));
            }else{
		  ...
		  jsonEaa0103.put("total_item_estoque", eaa0103.eaa0103total);
            ...
            //calcularCalcularCargaTributaria
            calcularCargaTributaria();

            // Total do Documento = Total do item + IPI + FreteDest + Seguro + Outras
            ...
            //Calculo FCI Saida
            jsonEaa0103.put("fci_saida", new BigDecimal(0));
    ...
    private void calcularIPI(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != -1){
            ...
            if(abg01 != null && abg01.abg01txIpi_Zero > 0){
                jsonEaa0103.put("aliq_ipi", abg01.abg01txIpi_Zero);
            }

            // Aplica alíquota para calcular IPI
            if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") > -1){
                jsonEaa0103.put("ipi", (jsonEaa0103.getBigDecimal_Zero("bc_ipi") *
                        jsonEaa0103.getBigDecimal_Zero("aliq_ipi") / 100).round(3));
            }else {
    ...
    private void preencherSPEDS(){
        ...
        jsonEaa0103.put("aliq_icms_st_sped", jsonEaa0103.getBigDecimal_Zero("_icms_st"));
