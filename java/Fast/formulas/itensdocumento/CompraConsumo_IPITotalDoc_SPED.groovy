...
public class compraConsumo_IPITotalDoc_SPED extends FormulaBase {
	...
	private void calcularItem() {
		...
		if (eaa0103.eaa0103qtComl > 0) {
			...
			//QtdeSCE = QuantidadeCompra * FatorConvVdaUso
			eaa0103.eaa0103qtUso = ((eaa0103.eaa0103qtComl * abm13.abm13fcUV).round(3));


			//TotalItem = QuantidadeCompra * PreçoUnit
			...
			//TotalDocumento = TotalItem + FreteDest + Seguro + Outras + IPI- Desconto
			...
			//Icms Outras
			if(jsonEaa0103.getBigDecimal_Zero("aliq_icms")){
				jsonEaa0103.put("bc_icms", new BigDecimal(0));
				jsonEaa0103.put("aliq_icms", new BigDecimal(0));
				jsonEaa0103.put("icms", new BigDecimal(0));
				jsonEaa0103.put("icms_outras", eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("seguro"));
			...
			//Somar IPI no total do item
			eaa0103.eaa0103total = (eaa0103.eaa0103qtComl * eaa0103.eaa0103unit) + jsonEaa0103.getBigDecimal_Zero("ipi");
			...
			eaa0103.eaa0103soma = new BigDecimal(1);
			...
			//IcmsAproveitar
			jsonEaa0103.put("icms_aproveitar", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_icms_aproveitar"));
	...
	private void calcularICMS(){
		...
		if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") != -1){
			// BC ICMS
			jsonEaa0103.put("bc_icms", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi"));
