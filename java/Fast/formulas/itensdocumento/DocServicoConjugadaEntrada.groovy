...
public class DocServicoConjugadaEntrada extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
		  ...
		  jsonEaa0103.put("total_item_estoque", eaa0103.eaa0103total);
            ...
            // Outras de ICMS - Campo 28 // Verifica Parâmetros Fiscais
    ...
    private void calcularServicosItem(){
        jsonEaa0103.put("servicos__item_", eaa0103.eaa0103qtComl * eaa0103.eaa0103unit);
        jsonEaa0103.put("total_servico", jsonEaa0103.getBigDecimal_Zero("servicos__item_"));
        ...
        // BC ISS
        jsonEaa0103.put("bc_iss", jsonEaa0103.getBigDecimal_Zero("pis_cofins_csll"));
        ...
        // BC CSLL
        jsonEaa0103.put("bc_csll", jsonEaa0103.getBigDecimal_Zero("pis_cofins_csll"));

        // Aliquota CSLL
        jsonEaa0103.put("aliq_csll", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_csll"));

        // CSLL
        jsonEaa0103.put("iss", (jsonEaa0103.getBigDecimal_Zero("bc_csll") * jsonEaa0103.getBigDecimal_Zero("aliq_csll") / 100).round(2) );



        // BC INSS
        jsonEaa0103.put("bc_inss", jsonEaa0103.getBigDecimal_Zero("pis_cofins_inss"));

        // Aliquota inss
        jsonEaa0103.put("aliq_inss", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_inss"));

        // inss
        jsonEaa0103.put("iss", (jsonEaa0103.getBigDecimal_Zero("bc_inss") * jsonEaa0103.getBigDecimal_Zero("aliq_inss") / 100).round(2) );


        // BC IR
        jsonEaa0103.put("bc_ir", jsonEaa0103.getBigDecimal_Zero("pis_cofins_ir"));

        // Aliquota IR
        jsonEaa0103.put("aliq_ir", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_ir"));

        // IR
        jsonEaa0103.put("iss", (jsonEaa0103.getBigDecimal_Zero("bc_ir") * jsonEaa0103.getBigDecimal_Zero("aliq_ir") / 100).round(2) );
