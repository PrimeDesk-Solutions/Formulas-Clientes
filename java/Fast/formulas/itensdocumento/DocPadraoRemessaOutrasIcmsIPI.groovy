...
public class DocPadraoRemessaOutrasIcmsIPI extends FormulaBase {
    ...
    private void calcularIPI(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != -1){
           ...
           jsonEaa0103.put("ipi", (jsonEaa0103.getBigDecimal_Zero("bc_ipi") * jsonEaa0103.getBigDecimal_Zero("aliq_ipi") / 100).round(3));
