...
public class doc_padrao_saida extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Quantidade SCE
            if(abm13.abm13fcVU_Zero == 0) throw new ValidacaoException("Fator de conversão de Volumes para uso no cadastro do item " + abm01.abm01codigo + " não é válido.")
            eaa0103.eaa0103qtUso = eaa0103.eaa0103qtComl * abm13.abm13fcVU_Zero;
		  ...
		  jsonEaa0103.put("total_item_estoque", eaa0103.eaa0103total);
            ...
            // Calculo FCI Entrada
            jsonEaa0103.put("fci_entrada", eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("icms"));

            eaa0103.eaa0103unit = round(4);
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") != -1){
            ...
            if(contribICMS == 0 ) jsonEaa0103.put("bc_icms", jsonEaa0103.getBigDecimal_Zero("bc_icms") + jsonEaa0103.getBigDecimal_Zero("ipi"))
