...
public class DocPadraoIndustrializacaoComMaoObra extends FormulaBase {
    ...
    public void executar() {
	   ...
	   if(aaj10_cstIcms == null) throw new ValidacaoException("Não foi informado CST de ICMS no cadastro do item " + abm01.abm01codigo + " - " + abm01.abm01na)
        ...
        if (eaa0103.eaa0103qtComl > 0) {
		  ...
		  jsonEaa0103.put("total_item_estoque", eaa0103.eaa0103total);
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_reduc_bc_icms") > 0){
                ...
                jsonEaa0103.put("icms_isentas", new BigDecimal(0))
            }
            ...
            // Total Financeiro
            if(aaj15_cfop.aaj15codigo == "5124"){
