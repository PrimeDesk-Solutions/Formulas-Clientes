...
public class SceCompraConsumo extends FormulaBase{
    ...
    public void executar(){
        ...
        //Custo Total
        bcc01.bcc01custo = (jsonBcc01.getBigDecimal_Zero("total_item_estoque") + jsonBcc01.getBigDecimal_Zero("frete_dest") +
                            jsonBcc01.getBigDecimal_Zero("seguro") + jsonBcc01.getBigDecimal_Zero("outras_despesas") -
                            jsonBcc01.getBigDecimal_Zero("desconto") + jsonBcc01.getBigDecimal_Zero("ipi")).round(2);
