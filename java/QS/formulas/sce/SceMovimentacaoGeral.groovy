...
public class SceMovimentacaoGeral extends FormulaBase{
    ...
    public void executar() {
        ...
        //Menor Preço
        if(jsonAbm0101.getBigDecimal_Zero("unitario_estoque") == 0 || jsonBcc01.getBigDecimal_Zero("unitario_estoque") < jsonAbm0101.getBigDecimal_Zero("preco_diverso_menor") ){
