...
public class DocPadraoRemessa_sempisecofins extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
		  ...
		  // Define CSOSN dos itens
    		  definirCSOSN();

    		  // Define ICMS Aproveitar dos itens
    ...
    private void calcularICMSAproveitar(){
		...
		// ICMS Aproveitar
		if(eaa0103.eaa0103csosn.aaj14codigo != "0102"){
