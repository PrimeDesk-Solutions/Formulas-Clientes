...
public class DocPadraoSaidaSemIpi extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Isentas ICMS
            if(jsonEaa0103.getBigDecimal_Zero("_reduc_bc_icms") > 0) jsonEaa0103.put("icms_isento", eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("bc_icms"));

            // ICMS Outras
            if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") <= 0) jsonEaa0103.put("icms_outras", eaa0103.eaa0103totDoc);

            // IPI Outras
            if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") <= 0) jsonEaa0103.put("ipi_outras", eaa0103.eaa0103totDoc);
            ...
            calculoFundoCombatePobreza();

            // Calculo FCI
            jsonEaa0103.put("fci_saida", eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("icms"));

            preencherInformacoesFornecedor();
    ...
    private void calcularIPI(){
        if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") == new BigDecimal(0)) jsonEaa0103.put("aliq_ipi", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_ipi"));

        if(jsonEaa0103.getBigDecimal_Zero("aliq_ipi") > 0 && jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != -1 ){
            // BC IPI
    ...
    private void calcularICMS(){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") != -1){
            ...
            jsonEaa0103.put("icms_outras", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") + jsonEaa0103.getBigDecimal_Zero("ipi"));
        }
    ...
    private void calcularCargaTributaria(){
        ...
        TableMap camposCustomAbg01 = getAcessoAoBanco().buscarUnicoTableMap(sql, Parametro.criar("abm01id",abm01.abm01id), Parametro.criar("aac10id",aac10.aac10id)).getTableMap("abg01camposcustom");

        if(camposCustomAbg01 == null || camposCustomAbg01.getBigDecimal_Zero("aliq_carga_trib") == 0 ){
            throw new ValidacaoException("Aliquota da carga tributária informada no NCM " + abg01.abg01codigo + " é inválida.");
        }else{
            jsonEaa0103.put("_carga_trib", camposCustomAbg01.getBigDecimal_Zero("aliq_carga_trib"));
        }

        // Carga Tributária
        jsonEaa0103.put("carga_trib", jsonEaa0103.getBigDecimal_Zero("bc_carga_trib") * jsonEaa0103.getBigDecimal_Zero("_carga_trib") / 100 );
        jsonEaa0103.put("carga_trib", jsonEaa0103.getBigDecimal_Zero("carga_trib").round(2));

    }


    private void calculoFundoCombatePobreza(){
        // Aliquota FCP
        jsonEaa0103.put("aliq_fcp", jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_fcp"));

        // Base calculo FCP
        jsonEaa0103.put("bc_fcp", jsonEaa0103.getBigDecimal_Zero("bc_icms"));

        // FCP
        jsonEaa0103.put("vlr_fcp", jsonEaa0103.getBigDecimal_Zero("bc_fcp") * jsonEaa0103.getBigDecimal_Zero("aliq_fcp") / 100 );
        jsonEaa0103.put("vlr_fcp", jsonEaa0103.getBigDecimal_Zero("vlr_fcp").round(2));

    }

    private preencherInformacoesFornecedor(){
        // Número Pedido no fornecedor
        if(abm01.abm01livre != null){
            eaa0103.eaa0103pcNum = abm01.abm01livre;
        }

        // Sequencia do Item no Pedido Fornecedor
        if(jsonAbm0101.getString("seq_item_pedido") != null){
            eaa0103.eaa0103pcSeq = jsonAbm0101.getString("seq_item_pedido").toInteger()
        }
