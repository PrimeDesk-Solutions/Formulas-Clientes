...
public class DocPadraoSaidaIPIeICMSIsento extends FormulaBase {
    ...
    private definirCSOSN(){
        ...
        // Verifica se o item é retorno ou não para definir o CST de ICMS
        //if(jsonAbm0101.getInteger("grupo_mao_obra") == 1 || eaa0103.eaa0103retInd == 1 ){
        	//csosn = "0400"
        //}else{
        	//csosn = "0101"
        //}
