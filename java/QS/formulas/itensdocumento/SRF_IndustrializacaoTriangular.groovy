 ...
 */
package MM.formulas.itensDocumento
...
public class docpadraoindustrializacaoTriangular extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Define CSON dos itens
            definirCSOSN();

            // Calcula ICMS Aproveitar
            calcularICMSAproveitar();
    ...
    private trocaCFOPDentroOuForaEstado(Boolean dentroEstado) {
        if (eaa0103.eaa0103cfop != null) {
            ...
            //Se item não retorno
            if (eaa0103.eaa0103retInd == 0) cfop = "5125";
    ...
    private definirCSTICMS() {
        ...
        if(abm01.abm01na.toUpperCase().contains("MAO DE OBRA")){
            ...
            if(eaa0103.eaa0103retInd == 0){
                if(abd02.abd02cstIcmsB != null){
	               ...
	               cst = aaj10_cstIcms.aaj10codigo;
                	...
                	// Obtem o CST de ICMS no cadastro do item
                	aaj10_cstIcms = getSession().get(Aaj10.class, abm12.abm12cstIcms.aaj10id);
            		cst = aaj10_cstIcms.aaj10codigo;
                }else {
    ...
    private void calcularICMSAproveitar(){
	
		// ICMS Aproveitar
		if(eaa0103.eaa0103csosn.aaj14codigo != "0400"){
			// Aliq ICMS aproveitar
			jsonEaa0103.put("aliq_icms_aproveitar", jsonAac10.getBigDecimal_Zero("aliq_icms_aproveitar"));
			
			// Valor ICMS Aproveitar
			jsonEaa0103.put("icms_aproveitar", ( eaa0103.eaa0103totDoc * jsonEaa0103.getBigDecimal_Zero("aliq_icms_aproveitar") / 100).round(2));
		
		}else{
			// Aliq ICMS aproveitar
			jsonEaa0103.put("aliq_icms_aproveitar", new BigDecimal(0));
			
			// Valor ICMS Aproveitar
			jsonEaa0103.put("icms_aproveitar", new BigDecimal(0));
		}
    }

    private definirCSOSN(){
        // Busca primeiramente o CSOSN no cadastro do PCD, caso não econcontrado, busca no cadastro do item
        String csosn = "";
        if(abm12.abm12csosn != null) {
            aaj14_cstCsosn = getSession().get(Aaj14.class, abm12.abm12csosn.aaj14id);
            csosn = aaj14_cstCsosn.aaj14codigo;
        }else if (abd02.abd02csosnB != null) {
            aaj14_cstCsosn = getSession().get(Aaj14.class, abd02.abd02csosnB.aaj14id);
            csosn = aaj14_cstCsosn.aaj14codigo;
        } else {
            throw new ValidacaoException("Necessário preencher o CSOSN no cadastro do item " + abm01.abm01codigo + " ou no cadastro do PCD " + abd01.abd01codigo);
        }
      
        eaa0103.eaa0103csosn = getSession().get(Aaj14.class, Criterions.eq("aaj14codigo", csosn));
    }
...
//meta-sis-eyJ0aXBvIjoiZm9ybXVsYSIsImZvcm11bGF0aXBvIjoiNjIifQ==
//meta-sis-eyJ0aXBvIjoiZm9ybXVsYSIsImZvcm11bGF0aXBvIjoiNjIifQ==MM.formulas.itensDocumento.DocPadraoIpiIcmsIsentos
//meta-sis-eyJ0aXBvIjoiZm9ybXVsYSIsImZvcm11bGF0aXBvIjoiNjIifQ==