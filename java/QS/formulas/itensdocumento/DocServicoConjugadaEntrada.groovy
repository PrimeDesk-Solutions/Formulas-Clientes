...
public class DocServicoConjugadaEntrada extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Quantidade SCE
            if(abm13.abm13fcVU_Zero == 0) throw new ValidacaoException("Fator de conversão de venda para uso no cadastro do item " + abm01.abm01codigo + " não é válido.")
