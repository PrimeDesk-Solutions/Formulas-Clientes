...
//							}
					...
					if(cstIcms != null) {
						...
						if((cst.equals("41") || cst.equals("60")) && getCampo("245.20-N26","vBCSTRet") != null && !jsonEaa0103.getBigDecimal(getCampo("245.20-N26","vBCSTRet")).equals(0)) {
							...
							ICMS90.addNode("modBC", 0, true); // configItem.abm0101fiscal.abm12modBcIcmsST
							...
							if(getCampo("243-N21","vBCST") != null && !jsonEaa0103.getBigDecimal(getCampo("243-N21","vBCST")).equals(0)) {
								ICMS90.addNode("modBCST", 0, true); // configItem.abm0101fiscal.abm12modBcIcmsST
...
//							}
	...
	private void comporFilhosDocumento() {
		...
		if(eaa01.eaa01sitDoc == null) interromper("Não foi informado a situação do documento no documento " + abb01.abb01num);
