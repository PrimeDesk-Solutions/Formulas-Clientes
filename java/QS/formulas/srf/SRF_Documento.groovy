...
class SRF_Documento  extends FormulaBase {
    ...
    private void comporObservacoesDocumento() {
        ...
        TableMap jsonAac10 = aac10.aac10json != null ? aac10.aac10json : new TableMap();
        ...
        //def aliqIcmsAproveitar = jsonAac10.getBigDecimal("aliq_icms_aproveitar");
        //def icmsAproveitar = eaa01.eaa01json.getBigDecimal_Zero("icms_aproveitar").round(2);


        //obsFisco = "EMPRESA OPTANTE PELO SIMPLES NACIONAL.LEI 9317/96. PERMITE O APROVEITAMENTO DO CREDITO DE ICMS NO VALOR DE R\$ "+ icmsAproveitar.toString() + " CORRESPONDENTE A ALIQUOTA DE "+ aliqIcmsAproveitar.round(2).toString() + " % NOS TERMOS DO ART.23 DA LC 123."


        if(eaa01.eaa01obsUsoInt == null || eaa01.eaa01obsUsoInt.length() == 0) eaa01.eaa01obsUsoInt = obsUsoInt;
        //if(eaa01.eaa01obsFisco == null || eaa01.eaa01obsFisco.length() == 0)
        eaa01.eaa01obsFisco = obsFisco;
