...
public class SRF_Itens_Por_Documentos_Entidades extends RelatorioBase {
    @Override
    ...
    public DadosParaDownload executar() {
        ...
        params.put("title","Itens Por Documentos e Entidades");
        ...
        List<TableMap> dados = buscarItensDoc(numDocIni, numDocFin, idsTipoDoc, idsPcd,resumoOperacao, dtEmissao, dtEntradaSaida, idsEntidades,idsItens,idEmpresa,mps);
...
//		 Agrupa as devoluções
        ...
        if(impressao == 0) return gerarPDF("SRF_Itens_Por_Documentos_Entidades_PDF",dadosRelatorio);

        return gerarXLSX("SRF_Itens_Por_Documentos_Entidades_Excel",dadosRelatorio);

    }

    private List<TableMap> buscarItensDoc(Integer numDocIni, Integer numDocFin, List<Long>idsTipoDoc, List<Long>idsPcd,Integer resumoOperacao, LocalDate[] dtEmissao, LocalDate[] dtEntradaSaida, List<Long>idsEntidades,List<Long>idsItens,Long idEmpresa, List<Integer> mps){
        ...
        String sql = "SELECT ent.abe01id AS idEnt, ent.abe01codigo AS codEnt,ent.abe01na AS naEnt, abm01id, abm01codigo,abm01na,aah01codigo, abb01num as numNota,abb01data as dtNota, "+
                        ...
                        "abb01data, eaa0103qtuso,eaa0103qtcoml,eaa0103unit,eaa0103total,eaa0103totdoc,eaa0103totfinanc, eaa01id, eaa0103id, eaa0103json " +
                        "FROM eaa01 "+
                        ...
                        whereItens+
                        whereMps+
                        "ORDER BY abe01na, abm01codigo, abb01num"
        ...
        return getAcessoAoBanco().buscarListaDeTableMap(sql,parametroEmpresa,parametroNumIni,parametroNumFin,parametroTipoDoc,parametroPcd,parametroDtEmissaoIni,
                parametroDtEmissaoFin,parametroDtEntradaSaidaIni,parametroDtEntradaSaidaFin, parametroEntidade,parametroItens, parametroEmpresa, parametroMps);
    }

    private List<Long> obterIdsItensDoc(Integer numDocIni, Integer numDocFin, List<Long>idsTipoDoc, List<Long>idsPcd,Integer resumoOperacao, LocalDate[] dtEmissao, LocalDate[] dtEntradaSaida, List<Long>idsEntidades,List<Long>idsItens,Long idEmpresa, List<Integer> mps){
        ...
        return getAcessoAoBanco().obterListaDeLong(sql,parametroEmpresa,parametroNumIni,parametroNumFin,parametroTipoDoc,parametroPcd,parametroDtEmissaoIni,
                parametroDtEmissaoFin,parametroDtEntradaSaidaIni,parametroDtEntradaSaidaFin, parametroEntidade,parametroItens, parametroEmpresa, parametroMps);
    }
