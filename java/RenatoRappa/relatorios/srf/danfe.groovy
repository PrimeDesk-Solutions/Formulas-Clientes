package RenatoRappa.relatorios.srf;
...
public class danfe extends RelatorioBase {
	...
	private List<TableMap> buscarItensdaNfe(Long id){
		return getSession().createQuery(" SELECT eaa0103qtComl,eaa0103unit, eaa0103total, eaa0103seq as seq, eaa0103codigo, eaa0103descr, abg01codigo AS eaa0103ncm_codigo, aaj10codigo AS eaa0103cstIcms_codigo, aaj15codigo AS eaa0103cfop_codigo, aam06codigo as eaa0103umComl_codigo,  ",
								  " CAST(eaa0103json ->>'bc_icms' AS numeric(18,6)) AS bc_icms, CAST(eaa0103json ->>'icms' AS numeric(18,6)) AS vlr_icms, CAST(eaa0103json ->>'ipi' AS numeric(18,6)) AS vlr_ipi,CAST(eaa0103json ->>'_icms' AS numeric(18,6)) AS aliq_icms, CAST(eaa0103json ->>'ipi' AS numeric(18,6)) AS vlr_ipi,CAST(eaa0103json ->>'_ipi' AS numeric(18,6)) AS aliq_ipi, cast(eaa0103json ->> 'desconto' as numeric(18,6)) as desconto ",
								  " FROM eaa0103 ",
...
//meta-sis-eyJkZXNjciI6IkRhbmZlIiwidGlwbyI6InJlbGF0b3JpbyJ9
//meta-sis-eyJkZXNjciI6IkRhbmZlIiwidGlwbyI6InJlbGF0b3JpbyJ9
//meta-sis-eyJkZXNjciI6IkRhbmZlIiwidGlwbyI6InJlbGF0b3JpbyJ9
//meta-sis-eyJkZXNjciI6IkRhbmZlIiwidGlwbyI6InJlbGF0b3JpbyJ9