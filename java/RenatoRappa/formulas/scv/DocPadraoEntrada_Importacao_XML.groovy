...
public class DocPadraoEntrada_Importacao_XML extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if (abm1301 != null) {
                eaa0103.eaa0103qtUso = jsonEaa0103.getBigDecimal_Zero() * abm1301.abm1301fcCU;
            } else {
                throw new ValidacaoException("Não foi informado fator de conversão no Cadastro do Item " + abm01.abm01codigo);
            }
            ...
            // Peso Bruto
            jsonEaa0103.put("peso_bruto", (eaa0103.eaa0103qtComl * abm01.abm01pesoBruto_Zero).round(4));

            // Peso Líquido
            jsonEaa0103.put("peso_liquido", (eaa0103.eaa0103qtComl * abm01.abm01pesoLiq_Zero).round(4));
            ...
            eaa0103.eaa0103totDoc = (eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("ipi") +
                    ...
                    jsonEaa0103.getBigDecimal_Zero("_icms_st") -
            ...
            //ICMS Outras
            if (jsonEaa0103.getBigDecimal_Zero("icms_outras_sped") == 0) {
                jsonEaa0103.put("icms_outras", eaa0103.eaa0103totDoc);
            }

            //IPI Outras
            if (jsonEaa0103.getBigDecimal_Zero("ipi_outras_sped") == 0) {
