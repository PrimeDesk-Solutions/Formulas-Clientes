...
public class DocEntradaBcIrVariavelUnimed extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            //Verifica se foi inserido serviço
            if(abm01.abm01tipo != 3){
                throw new ValidacaoException("Item não está caracterizado como serviço")
            }

            // Servico item
            jsonEaa0103.put("servico_item",eaa0103.eaa0103qtComl * eaa0103.eaa0103unit);

            //Gera VAlor desconto incondicional
//            jsonEaa0103.put("desconto",jsonEaa0103.getBigDecimal_Zero("servico_item") * jsoEaa0103.getBigDecimal_Zero("desc_incond") / 100)

            //Subtrai valor do desconto do valor do serviço
            jsonEaa0103.put("servico_item", jsonEaa0103.getBigDecimal_Zero("servico_item") - jsonEaa0103.getBigDecimal_Zero("desconto"));

            //Soma valor das despesas ao valor do serviço 
            jsonEaa0103.put("servico_item", jsonEaa0103.getBigDecimal_Zero("servico_item") + jsonEaa0103.getBigDecimal_Zero("outras_despesas"));
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_ir") == -1){
                ...
                jsonEaa0103.put("bc_ir",jsonEaa0103.getBigDecimal_Zero("servico_item"));
                jsonEaa0103.put("ir",jsonAbm0101.getBigDecimal_Zero("_ir") * jsonEaa0103.getBigDecimal_Zero("_ir") / 100 );
            }
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_inss") == -1){
                ...
                jsonEaa0103.put("bc_inss",jsonEaa0103.getBigDecimal_Zero("servico_item"));
                jsonEaa0103.put("inss",jsonAbm0101.getBigDecimal_Zero("_inss") * jsonEaa0103.getBigDecimal_Zero("_inss") / 100 );
            }
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_iss") == -1){
                ...
                jsonEaa0103.put("bc_iss",jsonEaa0103.getBigDecimal_Zero("servico_item"));
                jsonEaa0103.put("iss",(jsonAbm0101.getBigDecimal_Zero("bc_iss") * jsonEaa0103.getBigDecimal_Zero("_iss") / 100 ).round(2));
//                interromper(jsonAbm0101.getBigDecimal_Zero("iss").toString())
            }

            // Calculo PIS/COFINS/CSLL
            if(jsonEaa0103.getBigDecimal_Zero("_pis_cofins_csll") == -1){
                jsonEaa0103.put("bc_pis_cofins_csll",0)
                jsonEaa0103.put("ir",0)
            }else{
                if(jsonEaa0103.getBigDecimal_Zero("_pis_cofins_csll") == 0){
                    jsonEaa0103.put("_pis_cofins_csll", jsonAbm0101.getBigDecimal_Zero("_pis_cofins_csll"));
                }
                
                jsonEaa0103.put("bc_pis_cofins_csll",jsonEaa0103.getBigDecimal_Zero("servico_item"));
                jsonEaa0103.put("pis_cofins_csll",jsonAbm0101.getBigDecimal_Zero("_pis_cofins_csll") * jsonEaa0103.getBigDecimal_Zero("_pis_cofins_csll") / 100 );
            }

            //Gera o valor total dos serviços
            jsonEaa0103.put("total_servicos", jsonEaa0103.getBigDecimal_Zero("servico_item") - jsonEaa0103.getBigDecimal_Zero("ir") - jsonEaa0103.getBigDecimal_Zero("inss") - jsonEaa0103.getBigDecimal_Zero("iss") - jsonEaa0103.getBigDecimal_Zero("pis_cofins_csll"));

            //Total Itens 
            eaa0103.eaa0103total = jsonEaa0103.getBigDecimal_Zero("servico_item").round(2);

            //Total Documento 
            eaa0103.eaa0103totDoc = jsonEaa0103.getBigDecimal_Zero("servico_item").round(2);
