...
public class Anulacao_de_Frete extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            jsonEaa0103.put("qt_convertida",  eaa0103.eaa0103qtUso * jsonAbm0101.getBigDecimal_Zero("qvenda_qconv"));

            // Converte Qt.Documento para Volume
            jsonEaa0103.put("volumes",  eaa0103.eaa0103qtUso);
            ...
            // Total do item
            eaa0103.eaa0103total = eaa0103.eaa0103qtUso * eaa0103.eaa0103unit;
            ...
            //Calcular Valor ICMS 
            if(jsonEaa0103.getBigDecimal_Zero("_icms") > 0){
                jsonEaa0103.put("icms",jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("_icms") / 100);
            }

            //Total Documento
           eaa0103.eaa0103totDoc =  eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("ipi") +
                                    jsonEaa0103.getBigDecimal_Zero("icms_st") +
                                    jsonEaa0103.getBigDecimal_Zero("mao_de_obra") +
