...
public class DocEntradaBcIrVariavelUnimed extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            eaa0103.eaa0103qtUso = jsonEaa0103.getBigDecimal_Zero("qt_documento") * abm1301.abm1301fcCU;

            // Converte Qt.Venda para Qt.Convertida (Unidade Específica da Empresa)
            jsonEaa0103.put("qt_convertida", jsonEaa0103.getBigDecimal_Zero("qt_documento") * jsonAbm0101.getBigDecimal_Zero("qvenda_qconv"));
            ...
            // Total do item + serviços
            if(abm01.abm01tipo != 3){
                eaa0103.eaa0103total = ((jsonEaa0103.getBigDecimal_Zero("qt_documento") * eaa0103.eaa0103unit) - jsonEaa0103.getBigDecimal_Zero("desconto")).round(2);
            }else{
            	eaa0103.eaa0103total = jsonEaa0103.getBigDecimal_Zero("qt_documento") * eaa0103.eaa0103unit;
               jsonEaa0103.put("total_servico",eaa0103.eaa0103total.round(2));
            }
            ...
            if(abm01.abm01tipo == 3){
                ...
                //Cálculo ISS
                if(jsonEaa0103.getBigDecimal_Zero("_iss") > 0){
                    jsoEaa0103.put("iss",(jsonEaa0103.getBigDecimal_Zero("bc_iss") * jsonEaa0103.getBigDecimal_Zero("_iss") / 100).round(2));
                }else{
                ...
                //Calculo PIS 
                jsonEaa0103.put("pis",(jsonEaa0103.getBigDecimal_Zero("bc_pis") * jsonEaa0103.getBigDecimal_Zero("_pis") / 100).round(2));
                ...
                //Calculo COFINS 
                jsonEaa0103.put("cofins",(jsonEaa0103.getBigDecimal_Zero("bc_cofins") * jsonEaa0103.getBigDecimal_Zero("_cofins") / 100).round(2));

                //BC CSLL
                jsonEaa0103.put("bc_csll", jsonEaa0103.getBigDecimal_Zero("total_servico"));

                //Aliquita de CSLL
                jsonEaa0103.put("_csll",jsonAbm0101.getBigDecimal_Zero("_csll"));

                //Calculo CSLL 
                jsonEaa0103.put("csll",(jsonEaa0103.getBigDecimal_Zero("bc_csll") * jsonEaa0103.getBigDecimal_Zero("_csll") / 100).round(2));

                //BC INSS
                jsonEaa0103.put("bc_inss", (eaa0103.eaa0103total * 30) / 100);
               ...
               if(jsonEaa0103.getBigDecimal_Zero("_inss") > 0){
                ...
                //Aliquota BC PIS/COFINS/CSLL
                if(jsonEaa0103.getBigDecimal_Zero("_pis_cof_csll") > -1){
                    jsonEaa0103.put("_pis_cofins_csll", jsonAbm0101.getBigDecimal_Zero("_pis_cofins_csll"));
                }

                //Calculo PIS/COFINS/CSLL
                if(jsonEaa0103.getBigDecimal_Zero("_pis_cof_csll") > 0){
                    jsonEaa0103.put("pis_cofins_csll", ((jsonEaa0103.getBigDecimal_Zero("bc_pis_cof_csll") * jsonAbm0101.getBigDecimal_Zero("_pis_cofins_csll")) / 100).round(2));
                }else{
            ...
            //Se item estiver isenção de IPI (Aliquota NCM Zerada) move valor da base para isento
            if(jsonEaa0103.getBigDecimal_Zero("_ipi") <= 0 || jsonAbm0101.getBigDecimal_Zero("dif_aliq") == 1){
                jsonEaa0103.put("ipi",0);
                jsonEaa0103.put("ipi_isento",jsonEaa0103.getBigDecimal_Zero("bc_ipi")); //Move IPI para IPI Isento
                jsonEaa0103.put("ipi_isento",0);
                jsonEaa0103.put("_ipi",-1);
            }
            ...
            if (jsonEaa0103.getBigDecimal_Zero("_reduc_bc_icms") == 0) {
                jsonEaa0103.put("_reduc_bc_icms", jsonAbm0101.getBigDecimal_Zero("_reduc_bc_icms")); //Aliquota fixa cadastro itens
            }
            
            // Calculo da Redução 
            if(jsonEaa0103.getBigDecimal_Zero("_reduc_bc_icms") >= 0){
                vlrReducao = (jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonEaa0103.getBigDecimal_Zero("_reduc_bc_icms")) / 100;
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_icms") == 0){
                ...
                if(dentroEstado){
                    if(jsonAbm0101.getBigDecimal_Zero("_fix_icm_de") != 0){
                        jsonEaa0103.put("_icms", jsonAbm0101.getBigDecimal_Zero("_fix_icm_de")); 
                    }
                }
            }
            ...
            // **********  ICMS ST - Regime "Substituto Tributário" **********
            
            //Valor de BC ICMS ST
            jsonEaa0103.put("bc_icms_st", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") +
                                    jsonEaa0103.getBigDecimal_Zero("seguro") +
                                    jsonEaa0103.getBigDecimal_Zero("outras_despesas") +
                                    jsonEaa0103.getBigDecimal_Zero("ipi"));

            //if(abe01camposcustom != null){
                //if(abe01camposcustom.getBigDecimal_Zero("varejista_atac") == 1 || atac == 2);
           
           def ivaST = 0;
           if(jsonAag02Ent.getBigDecimal_Zero("txicminterna") != null){

               //Alíquota do ICMS ST = Alíquota para operações internas do cadastro de Estados da entidade destino
               jsonEaa0103.put("_icms_st", jsonAag02Ent.getBigDecimal_Zero("txicminterna"));
