...
public class Devolucao_De_Compra extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if (aaj10_cstIcms.aaj10codigo == "000") {
                jsonEaa0103.put("insumos", eaa0103.eaa0103total +
                ...
                jsonEaa0103.put("insumos", jsonEaa0103.getBigDecimal_Zero("insumos").round(2));
            } else {
                jsonEaa0103.put("insumos", 0)
            }


            //BC ICMS 
            if (jsonEaa0103.getBigDecimal_Zero("insumos") > 0) {
                jsonEaa0103.put("bc_icms", jsonEaa0103.getBigDecimal_Zero("insumos"))
            } else {
