...
public class DocPadraoEntrada extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Peso Bruto
            if (abm01.abm01pesoLiq_Zero >= 0) jsonEaa0103.put("peso_bruto", (eaa0103.eaa0103qtUso * abm01.abm01pesoBruto_Zero).round(4));

            // Peso Líquido
            if (abm01.abm01pesoBruto_Zero >= 0) jsonEaa0103.put("peso_liquido", (eaa0103.eaa0103qtUso * abm01.abm01pesoLiq_Zero).round(4));
