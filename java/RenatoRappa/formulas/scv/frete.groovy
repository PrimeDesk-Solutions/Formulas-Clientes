...
public class frete extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
           ...
           if(jsonEaa0103.getBigDecimal_Zero("ipi") == 0){
           	jsonEaa0103.put("ipi_isento", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas"));
            ...
            //Pessoas Físicas ou não contribuintes - nôa tem redução de base de cálculo de ICMS
             ...
             if(jsonEaa0103.getBigDecimal_Zero("_icms") == 0){
             	if(dentroEstado){
		  		if(jsonAbm0101.getBigDecimal_Zero("_fix_icm_de") != 0){
		  			...
		  			jsonEaa0103.put("_icms", jsonAbm0101.getBigDecimal_Zero("_fix_icm_fe"));
		  		}
		  	}	 
             }
            ...
            if (eaa0103.eaa0103cstCofins != null) {
                if(jsonAbm0101.getBigDecimal_Zero("_cofins") > 0){
                    //Base de Cálculo de PIS
                    jsonEaa0103.put("bc_cofins", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("cofins") + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro"));
