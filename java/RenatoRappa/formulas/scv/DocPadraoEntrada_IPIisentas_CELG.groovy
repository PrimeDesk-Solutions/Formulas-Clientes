...
public class DocPadraoEntrada_IPIisentas_CELG extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            jsonEaa0103.put("qt_faturamento", eaa0103.eaa0103qtComl * abm13.abm13fcUV)
            ...
            jsonEaa0103.put("qt_convertida", jsonEaa0103.getBigDecimal_Zero("qt_faturamento") * jsonAbm0101.getBigDecimal_Zero("qvenda_qconv"));


            // Converte Qt.Documento para Volume
            jsonEaa0103.put("volumes", jsonEaa0103.getBigDecimal_Zero("qt_faturamento") * abm13.abm13fcVW);
            ...
            if(jsonEaa0103.getBigDecimal_Zero("desc_unit") > 0 && jsonEaa0103.getBigDecimal_Zero("desconto") > 0 ){
                jsonEaa0103.put("desconto", jsonEaa0103.getBigDecimal_Zero("qt_faturamento") * eaa0103.eaa0103unit * jsonEaa0103.getBigDecimal_Zero("desc_unit") / 100);
            }else if(jsonEaa0103.getBigDecimal_Zero("desc_unit") > 0 && jsonEaa0103.getBigDecimal_Zero("desconto") == 0){
                 jsonEaa0103.put("desconto", jsonEaa0103.getBigDecimal_Zero("qt_faturamento") * eaa0103.eaa0103unit * jsonEaa0103.getBigDecimal_Zero("desc_unit") / 100);
            }else if(jsonEaa0103.getBigDecimal_Zero("desc_unit") <= 0 && jsonEaa0103.getBigDecimal_Zero("desconto") > 0){
                jsonEaa0103.put("desc_unit", jsonEaa0103.getBigDecimal_Zero("desconto") /  (jsonEaa0103.getBigDecimal_Zero("qt_faturamento") * eaa0103.eaa0103unit) * 100);
            }else{
                jsonEaa0103.put("desconto",0);
            }

            // Total do item
            eaa0103.eaa0103total = (jsonEaa0103.getBigDecimal_Zero("qt_faturamento") * eaa0103.eaa0103unit) - jsonEaa0103.getBigDecimal_Zero("desconto");
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_ipi") == 0){
                if (abg01 != null && abg01.abg01txIpi_Zero > 0 && jsonEaa0103.getBigDecimal_Zero("_ipi") == 0) {
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_icms") == 0){
                if(jsonAag02Ent.getBigDecimal_Zero("txicmentrada") != 0){ //Taxa ICMS Estados e municípios
                    //Alíquota padrão de ICMS para operações internas (ENTIDADE)
                    jsonEaa0103.put("_icms", jsonAag02Ent.getBigDecimal_Zero("txicmentrada"));
                }else{
           ...
           if(ivaST > 0){
            ...
            if (eaa0103.eaa0103cstPis != null) {
                if(jsonAbm0101.getBigDecimal_Zero("_pis") > 0){
                    ...
                    jsonEaa0103.put("bc_pis", eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("ipi") + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro"));
            ...
            if (eaa0103.eaa0103cstCofins != null) {
                if(jsonAbm0101.getBigDecimal_Zero("_cofins") > 0){
                    //Base de Cálculo de PIS
                    jsonEaa0103.put("bc_cofins", eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("cofins") + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro"));
            ...
            //Total Documento com ST
            if(jsonEaa0103.getBigDecimal_Zero("icms_st") != 0){
            	jsonEaa0103.put("total_doc_st", round(eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("icms_st"),1));	
            }
