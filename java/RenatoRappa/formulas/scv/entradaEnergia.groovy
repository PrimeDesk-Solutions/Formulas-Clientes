...
public class entradaEnergia extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            jsonEaa0103.put("qt_faturamento", (eaa0103.eaa0103qtComl * abm1301.abm1301fcCU).round(3));
            
            // Converte Qt.Documento para Qtde SCE
            eaa0103.eaa0103qtUso = (eaa0103.eaa0103qtComl * abm1301.abm1301fcCU).round(3);
           ...
           //Total Doc sem ST
            ...
            // Obter a Aliquota de ICMS
             if(jsonEaa0103.getBigDecimal_Zero("_icms") != -1){
             	jsonEaa0103.put("icms", ((jsonEaa0103.getBigDecimal_Zero("bc_icms") * jsonAag02Ent.getBigDecimal_Zero("txicmentrada")) / 100).round(2));
             ...
             //Outras ICMS
             jsonEaa0103.put("icms_outras", (eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("bc_icms")).round());
