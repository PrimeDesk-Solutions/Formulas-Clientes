...
public class DocPadraoEntrada extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Total do item
            eaa0103.eaa0103total = ((jsonEaa0103.getBigDecimal_Zero("qt_faturamento") * eaa0103.eaa0103unit) - jsonEaa0103.getBigDecimal_Zero("desconto")).round(2);
            
            // ************* ICMS ******************
            //Outras de ICMS - Verifica Parametros fiscais 
            jsonEaa0103.put("icms_outras", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas"));
            ...
            if(jsonEaa0103.getBigDecimal_Zero("_reduc_bc_icms") > 0){
                jsonEaa0103.getBigDecimal_Zero("icms_isento", eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("bc_icms"))
            }                               
            //Total Documento com ST
            if(jsonEaa0103.getBigDecimal_Zero("icms_st") != 0){
                jsonEaa0103.put("total_doc_st", round(eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("icms_st"),2));
            }
