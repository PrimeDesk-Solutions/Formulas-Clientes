package RenatoRappa.formulas.cgs.condpgto
    ...
    public void executar() {
        ...
        if (abe3001s != null && abe3001s.size() > 0) {
            ...
            for (Abe3001 abe3001 : abe3001s) {
                ...
                jsonEaa0113.put("multa", new BigDecimal(0));
                jsonEaa0113.put("juros", new BigDecimal(0));
                jsonEaa0113.put("encargos", new BigDecimal(0));
                jsonEaa0113.put("desconto", new BigDecimal(0));
                jsonEaa0113.put("dt_limite_desc", null);
