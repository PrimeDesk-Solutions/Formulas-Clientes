...
public class S_2300_xml extends FormulaBase {
	...
	public void executar() {
		...
		ElementXml eSocial = ESocialUtils.criarElementXmlESocial("http://www.esocial.gov.br/schema/evt/evtTSVInicio/v_S_01_01_00");
		...
		brasil.addNode("uf", aag02 != null ? aag02.aag02ibge : null, true);

		ElementXml exterior = endereco.addNode("exterior");
		exterior.addNode("paisResid", abh80.abh80extPais?.aag01eSocial?: null, true);
		...
		if(abh80.abh8002s != null && abh80.abh8002s.size() > 0) {
			for(Abh8002 abh8002 : abh80.abh8002s) {
				...
				dependente.addNode("tpDep", abh8002.abh8002parente?.aap09eSocial?: null, true);
		...
		cargoFuncao.addNode("CBOCargo", abh80.abh80cargo == null ? null : abh80.abh80cargo.abh05cbo == null ? null : abh80.abh80cargo.abh05cbo.aap03codigo, false);
		...
		infoDirigenteSindical.addNode("categOrig", abh80.abh80eoCateg, true);
		infoDirigenteSindical.addNode("tpInsc", "1", true);
		...
		infoDirigenteSindical.addNode("tpRegTrab", abh80.abh80eoRegTrab, true);
		infoDirigenteSindical.addNode("tpRegPrev", abh80.abh80eoRegPrev, true);
		
		ElementXml infoTrabCedido = infoComplementares.addNode("infoTrabCedido");
		infoTrabCedido.addNode("categOrig", abh80.abh80tcCateg, true);
		infoTrabCedido.addNode("cnpjCednt", StringUtils.extractNumbers(abh80.abh80tcCNPJ), true);
		infoTrabCedido.addNode("matricCed", abh80.abh80tcMatric, true);
		infoTrabCedido.addNode("dtAdmCed", abh80.abh80tcAdmis, true);
		infoTrabCedido.addNode("tpRegTrab", abh80.abh80tcRegTrab, true);
		infoTrabCedido.addNode("tpRegPrev", abh80.abh80tcRegPrev, true);
