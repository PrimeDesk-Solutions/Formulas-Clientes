...
public class S_2306_xml extends FormulaBase {
	private Aaa15 aaa15;
	...
	public void executar() {
		...
		ElementXml infoRegimeTrab = altContratual.addNode("infoRegimeTrab");
		...
		ElementXml infoContrato = altContratual.addNode("infoContrato");
		...
		localTrabGeral.addNode("nrInsc", StringUtils.ajustString(aac10.aac10ni, 14, '0', true), true);
		...
		horContratual.addNode("dscTpJorn", abh80.abh80jorDescr, false);
		horContratual.addNode("horNoturno", abh80.abh80jorNot, true);
