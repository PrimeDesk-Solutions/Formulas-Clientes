...
public class Leiaute17_2023_ICMS_IPI extends FormulaBase {
	...
	private static final Integer versaoLeiaute = 17;
	...
	def gerarBlocoG() {
		...
		if(ecc01s != null && ecc01s.size() > 0) {
			...
			if(ecc0101Valores != null && ecc0101Valores.ecc0101json != null) {
	...
	def comporRegistro0220(Abm01 abm01, Aam06 aam06, boolean isSaida) {
		...
		if(map0220.containsKey(abm01.abm01id)) {
			map0220.get(abm01.abm01id).putAll(mapUnid);
			return;
		}
	...
	def comporRegistro0221(Abm01 abm01) {
		...
		def Map<Long, BigDecimal> mapCorrelatos = new HashMap<Long, BigDecimal>();
