...
class R_4080 extends FormulaBase {
	@Override
	...
	public void executar() {
		...
		for(idEmpresa in idsEmpresas){
			...
			ElementXml evtRetRec = reinf.addNode("evtRetRec")
			evtRetRec.setAttribute("id", ReinfUtils.gerarID(aac10.aac10ti, aac10.aac10ni))
			
			String recibo = isRetificacao ? reinfService.buscarAaa17RetRecPeloLayoutPeriodo("R-4080", aac10.aac10id, periodo) : null;
			...
			Aaa17 aaa17 = reinfService.comporAaa17("R-4080", periodo, isRetificacao);
			aaa17.setAaa17xmlEnvio(ReinfUtils.gerarXML(reinf))

			if(reinfService.confirmarGeracaoXML("R-4080", periodo, aaa17.getAaa17xmlEnvio(), "nrInsc")) {
				aaa17s.add(aaa17)
			}
		}
