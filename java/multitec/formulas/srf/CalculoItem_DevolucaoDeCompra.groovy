...
class CalculoItem_DevolucaoDeCompra extends FormulaBase{
	private Aac10 aac10;
	private Aag01 aag01;
	private Aag02 ufEnt;
	...
	private void calcularItem() {
		...
		if (eaa0103.eaa0103cfop != null) {
			...
			//Tem IVA no Item?
			if (jsonAbm1001.getBigDecimal_Zero("iva_compra") > 0) {
		...
		if (eaa0103.eaa0103qtComl > 0 && eaa0103.eaa0103unit > 0) {
			...
			//Unidade SCE para Devolução de Compra
			if (abm1301 != null && abm1301.abm1301fcCU_Zero > 0) {
				eaa0103.eaa0103qtUso = eaa0103.eaa0103qtUso * abm1301.abm1301fcCU;
			}
			...
			if (eaa0103.eaa0103cstIcms != null) {
				...
				if (jsonAbm1001.getBigDecimal_Zero("iva_compra") > 0 && cst != "910" && eaa0102.eaa0102contribIcms != 0) {
				...
				if (jsonAbm1001.getBigDecimal_Zero("icm_reduc_bc") > 0 && jsonAbm1001.getBigDecimal_Zero("iva_compra") > 0 && cst != "910" && eaa0102.eaa0102contribIcms != 0) {
				...
				if (jsonAbm1001.getBigDecimal_Zero("icm_reduc_bc") > 0 && jsonAbm1001.getBigDecimal_Zero("iva_compra") == 0 && cst != "910") {
					if (operacao == 1 || operacao == 2) {
						cst = cstA + "20";
					}
				}
				...
				jsonEaa0103.put("icm_aliq", jsonAag02Ent.getBigDecimal_Zero("aliq_icmsint"));
				...
				//% ICMS venda p/ Consumidor final dentro de SC
				...
				if (aaj10_cstIcms.aaj10codigo.substring(1) == "30" || aaj10_cstIcms.aaj10codigo.substring(1) == "40") {
					cstValido = true;
					jsonEaa0103.put("icm_isento", eaa0103.getBigDecimal_Zero("icm_bc"));
				...
				if (aaj10_cstIcms.aaj10codigo.substring(1) == "41" || aaj10_cstIcms.aaj10codigo.substring(1) == "50" || aaj10_cstIcms.aaj10codigo.substring(1) == "51") {
					cstValido = true;
					jsonEaa0103.put("icm_outras", eaa0103.getBigDecimal_Zero("icm_bc"));
					jsonEaa0103.put("icm_bc",0);
					jsonEaa0103.put("icm_reduc_bc",0);
					jsonEaa0103.put("icm_aliq",0);
					jsonEaa0103.put("icm_icm",0);
