...
class ImportaXmlNFe_Entrada extends FormulaBase {
	...
	public void executar() {
		...
		ElementXml elementide = elementNFe.getChildNode("ide");
		if(elementide == null) return;
		
		String serie = elementide.getChildValue("serie");
		eaa01.eaa01central.abb01serie(serie);
		...
		if(det != null && det.size() > 0) {
			for(ElementXml elementnItem : det) {
				...
				setarValorJson(eaa0103json, getCampo("114-I15","vFrete"), obterValorXml(elementprod, "frete_dest", 2));
				
				setarValorJson(eaa0103json, getCampo("115-I16","vSeg"), obterValorXml(elementprod, "seguro", 2));
				
				setarValorJson(eaa0103json, getCampo("116-I17","vDesc"), obterValorXml(elementprod, "desconto", 2));
				
				setarValorJson(eaa0103json, getCampo("116a-I17a","vOutro"), obterValorXml(elementprod, "outras_despesas", 2));
...
//				setarValorJson(eaa0103json, getCampo("163a-M02","vTotTrib"), obterValorXml(elementimposto, "vTotTrib", 2));
				...
				if(elementICMS10 != null) {
					setarValorJson(eaa0103json, getCampo("176-N15","vBC"), obterValorXml(elementICMS10, "bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("177-N16","pICMS"), obterValorXml(elementICMS10, "_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("178-N17","vICMS"), obterValorXml(elementICMS10, "icms_sped", 2));
...
//					setarValorJson(eaa0103json, getCampo("181-N20","pRedBCST"), obterValorXml(elementICMS10, "pRedBCST", 2));
					setarValorJson(eaa0103json, getCampo("182-N21","vBCST"), obterValorXml(elementICMS10, "bc_icms_st_sped", 2));
					setarValorJson(eaa0103json, getCampo("183-N22","pICMSST"), obterValorXml(elementICMS10, "_icms_st", 2));
					setarValorJson(eaa0103json, getCampo("184-N23","vICMSST"), obterValorXml(elementICMS10, "icms_st_sped", 2));
				}
				
				//Grupo Tributação do ICMS = 20
				ElementXml elementICMS20 = elementICMS.getChildNode("ICMS20");
				if(elementICMS20 != null) {
					setarValorJson(eaa0103json, getCampo("189-N14","pRedBC"), obterValorXml(elementICMS20, "_red_bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("190-N15","vBC"), obterValorXml(elementICMS20, "bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("191-N16","pICMS"), obterValorXml(elementICMS20, "_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("192-N17","vICMS"), obterValorXml(elementICMS20, "icms_sped", 2));
				}
...
//					setarValorJson(eaa0103json, getCampo("198-N20","pRedBCST"), obterValorXml(elementICMS30, "pRedBCST", 2));
					setarValorJson(eaa0103json, getCampo("199-N21","vBCST"), obterValorXml(elementICMS30, "bc_icms_st_sped", 2));
					setarValorJson(eaa0103json, getCampo("200-N22","pICMSST"), obterValorXml(elementICMS30, "_icms_st_sped", 2));
					setarValorJson(eaa0103json, getCampo("201-N23","vICMSST"), obterValorXml(elementICMS30, "icms_st_sped", 2));
				}
...
//				//Grupo Tributação do ICMS = 41
//				ElementXml elementICMS41 = elementICMS.getChildNode("ICMS41");
//				if(elementICMS41 != null) {
//					setarValorJson(eaa0103json, getCampo("204.01-N27a","vICMSDeson"), obterValorXml(elementICMS41, "vICMSDeson", 2));
//					setarValorJson(eaa0103json, getCampo("204.01-N28a","vICMSDeson"), obterValorXml(elementICMS41, "vICMSDeson", 2));
//					setarValorJson(eaa0103json, getCampo("210-N15","vBC"), obterValorXml(elementICMS41, "vBC", 2));
//					setarValorJson(eaa0103json, getCampo("211-N16","pICMS"), obterValorXml(elementICMS41, "pICMS", 2));
//					setarValorJson(eaa0103json, getCampo("212-N17","vICMS"), obterValorXml(elementICMS41, "vICMS", 2));
//				}
				
				//Grupo Tributação do ICMS = 51
				ElementXml elementICMS51 = elementICMS.getChildNode("ICMS51");
				if(elementICMS51 != null) {
					setarValorJson(eaa0103json, getCampo("209-N14","pRedBC"), obterValorXml(elementICMS51, "_red_bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("210-N15","vBC"), obterValorXml(elementICMS51, "bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("211-N16","pICMS"), obterValorXml(elementICMS51, "_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("212-N17","vICMS"), obterValorXml(elementICMS51, "icms_sped", 2));
				}
...
//				}
				...
				if(elementICMS70 != null) {
					setarValorJson(eaa0103json, getCampo("222-N14","pRedBC"), obterValorXml(elementICMS70, "_red_bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("223-N15","vBC"), obterValorXml(elementICMS70, "bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("224-N16","pICMS"), obterValorXml(elementICMS70, "_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("225-N17","vICMS"), obterValorXml(elementICMS70, "icms_sped", 2));
//					setarValorJson(eaa0103json, getCampo("227-N19","pMVAST"), obterValorXml(elementICMS70, "pMVAST", 2));
	//					setarValorJson(eaa0103json, getCampo("228-N20","pRedBCST"), obterValorXml(elementICMS70, "pRedBCST", 2));
					setarValorJson(eaa0103json, getCampo("229-N21","vBCST"), obterValorXml(elementICMS70, "bc_icms_st_sped", 2));
					setarValorJson(eaa0103json, getCampo("230-N22","pICMSST"), obterValorXml(elementICMS70, "_icms_st_sped", 2));
					setarValorJson(eaa0103json, getCampo("231-N23","vICMSST"), obterValorXml(elementICMS70, "icms_st_sped", 2));
				}
				
				//Grupo Tributação do ICMS = 90
				ElementXml elementICMS90 = elementICMS.getChildNode("ICMS90");
				if(elementICMS90 != null) {
					setarValorJson(eaa0103json, getCampo("236-N15","vBC"), obterValorXml(elementICMS90, "bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("237-N14","pRedBC"), obterValorXml(elementICMS90, "_red_bc_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("238-N16","pICMS"), obterValorXml(elementICMS90, "_icms_sped", 2));
					setarValorJson(eaa0103json, getCampo("239-N17","vICMS"), obterValorXml(elementICMS90, "icms_sped", 2));
...
//					setarValorJson(eaa0103json, getCampo("242-N20","pRedBCST"), obterValorXml(elementICMS90, "pRedBCST", 2));
					setarValorJson(eaa0103json, getCampo("243-N21","vBCST"), obterValorXml(elementICMS90, "bc_icms_st_sped", 2));
					setarValorJson(eaa0103json, getCampo("244-N22","pICMSST"), obterValorXml(elementICMS90, "_icms_st_sped", 2));
					setarValorJson(eaa0103json, getCampo("245-N23","vICMSST"), obterValorXml(elementICMS90, "icms_st_sped", 2));
				}
...
//				}
				...
				if(elementIPI != null) {
					...
					if(elementIPITrib != null) {
						setarValorJson(eaa0103json, getCampo("254-O10","vBC"), obterValorXml(elementIPITrib, "bc_ipi_sped", 2));
						setarValorJson(eaa0103json, getCampo("257-O13","pIPI"), obterValorXml(elementIPITrib, "_ipi_sped", 2));
...
//						setarValorJson(eaa0103json, getCampo("256-O12","vUnid"), obterValorXml(elementIPITrib, "vUnid", 4));
						...
						setarValorJson(eaa0103json, getCampo("259-O14","vIPI"), obterValorXml(elementIPITrib, "ipi_sped", 2));
					}
				}
				...
				if(elementII != null) {
					setarValorJson(eaa0103json, getCampo("263-P02","vBC"), obterValorXml(elementII, "bc_imp_import", 2));
					setarValorJson(eaa0103json, getCampo("264-P03","vDespAdu"), obterValorXml(elementII, "outras_despesas", 2));
					setarValorJson(eaa0103json, getCampo("265-P04","vII"), obterValorXml(elementII, "imp_import", 2));
//					setarValorJson(eaa0103json, getCampo("266-P05","vIOF"), obterValorXml(elementII, "vIOF", 2));
				...
				if(elementPIS != null) {
					...
					if(elementPISAliq != null) {
						setarValorJson(eaa0103json, getCampo("270-Q07","vBC"), obterValorXml(elementPISAliq, "bc_pis", 2));
						setarValorJson(eaa0103json, getCampo("271-Q08","pPIS"), obterValorXml(elementPISAliq, "_pis", 2));
						setarValorJson(eaa0103json, getCampo("272-Q09","vPIS"), obterValorXml(elementPISAliq, "pis", 2));
					}
...
//						setarValorJson(eaa0103json, getCampo("275-Q10","qBCProd"), obterValorXml(elementPISQtde, "qBCProd", 4));
						setarValorJson(eaa0103json, getCampo("276-Q11","vAliqProd"), obterValorXml(elementPISQtde, "unitario_pis", 4));
						setarValorJson(eaa0103json, getCampo("277-Q09","vPIS"), obterValorXml(elementPISQtde, "pis", 2));
					}
					
					ElementXml elementPISOutr = elementPIS.getChildNode("PISOutr");
					if(elementPISOutr != null) {
						setarValorJson(eaa0103json, getCampo("282-Q07","vBC"), obterValorXml(elementPISOutr, "bc_pis", 2));
						setarValorJson(eaa0103json, getCampo("283-Q08","pPIS"), obterValorXml(elementPISOutr, "_pis", 2));
//						setarValorJson(eaa0103json, getCampo("284-Q10","qBCProd"), obterValorXml(elementPISOutr, "qBCProd", 4));
						setarValorJson(eaa0103json, getCampo("285-Q11","vAliqProd"), obterValorXml(elementPISOutr, "unitario_pis", 4));
						setarValorJson(eaa0103json, getCampo("286-Q09","vPIS"), obterValorXml(elementPISOutr, "pis", 2));
					}
				}
...
//				}
				...
				if(elementCOFINS != null) {
					...
					if(elementCOFINSAliq != null) {
						setarValorJson(eaa0103json, getCampo("296-S07","vBC"), obterValorXml(elementCOFINSAliq, "bc_cofins", 2));
						setarValorJson(eaa0103json, getCampo("297-S08","pCOFINS"), obterValorXml(elementCOFINSAliq, "_cofins", 4));
						setarValorJson(eaa0103json, getCampo("298-S11","vCOFINS"), obterValorXml(elementCOFINSAliq, "cofins", 2));
					}
					
					ElementXml elementCOFINSQtde = elementCOFINS.getChildNode("COFINSQtde");
					if(elementCOFINSQtde != null) {
						setarValorJson(eaa0103json, getCampo("301-S09","qBCProd"), obterValorXml(elementCOFINSQtde, "qtde_bc_cofins", 4));
						setarValorJson(eaa0103json, getCampo("302-S10","vAliqProd"), obterValorXml(elementCOFINSQtde, "unitario_cofins", 4));
						setarValorJson(eaa0103json, getCampo("303-S11","vCOFINS"), obterValorXml(elementCOFINSQtde, "cofins", 2));
					}
					
					ElementXml elementCOFINSOutr = elementPIS.getChildNode("COFINSOutr");
					if(elementCOFINSOutr != null) {
						setarValorJson(eaa0103json, getCampo("308-S07","vBC"), obterValorXml(elementCOFINSOutr, "bc_cofins", 2));
						setarValorJson(eaa0103json, getCampo("309-S08","pCOFINS"), obterValorXml(elementCOFINSOutr, "_cofins", 2));
						setarValorJson(eaa0103json, getCampo("310-S09","qBCProd"), obterValorXml(elementCOFINSOutr, "qtde_bc_cofins", 4));
						setarValorJson(eaa0103json, getCampo("311-S10","vAliqProd"), obterValorXml(elementCOFINSOutr, "unitario_cofins", 4));
						setarValorJson(eaa0103json, getCampo("312-S11","vCOFINS"), obterValorXml(elementCOFINSOutr, "cofins", 2));
					}
				}
...
//				}
				...
				if(elementISSQN != null) {
					setarValorJson(eaa0103json, getCampo("320-U02","vBC"), obterValorXml(elementISSQN, "bc_iss", 2));
					setarValorJson(eaa0103json, getCampo("321-U03","vAliq"), obterValorXml(elementISSQN, "_iss", 2));
					setarValorJson(eaa0103json, getCampo("322-U04","vISSQN"), obterValorXml(elementISSQN, "iss", 2));
				}
			}
		}
		...
		setarValorJson(eaa01json, getCampo("329.01-W04a","vICMSDeson"), obterValorXml(elementICMSTot, "vICMSDeson", 2));
		setarValorJson(eaa01json, getCampo("329.03-W04c","vFCPUFDest"), obterValorXml(elementICMSTot, "vFCPUFDest", 2));
		setarValorJson(eaa01json, getCampo("329.05-W04e","vICMSUFDest"), obterValorXml(elementICMSTot, "vICMSUFDest", 2));
		setarValorJson(eaa01json, getCampo("329.07-W04g","vICMSUFRemet"), obterValorXml(elementICMSTot, "vICMSUFRemet", 2));
		...
		setarValorJson(eaa01json, getCampo("331.01-W06a","vFCPST"), obterValorXml(elementICMSTot, "vFCPST", 2));
...
//		setarValorJson(eaa01json, getCampo("341a-W16a","vTotTrib"), obterValorXml(elementICMSTot, "vTotTrib", 2));
		...
		if(elementISSQNtot != null) {
			setarValorJson(eaa01json, getCampo("343-W18","vServ"), obterValorXml(elementISSQNtot, "servicos__item_", 2));
			setarValorJson(eaa01json, getCampo("344-W19","vBC"), obterValorXml(elementISSQNtot, "bc_iss", 2));
			setarValorJson(eaa01json, getCampo("345-W20","vISS"), obterValorXml(elementISSQNtot, "iss", 2));
...
//			setarValorJson(eaa01json, getCampo("351-W26","vRetCSLL"), obterValorXml(elementretTrib, "vRetCSLL", 2));
			setarValorJson(eaa01json, getCampo("352-W27","vBCIRRF"), obterValorXml(elementretTrib, "bc_ir", 2));
			setarValorJson(eaa01json, getCampo("353-W28","vIRRF"), obterValorXml(elementretTrib, "ir", 2));
			setarValorJson(eaa01json, getCampo("354-W29","vBCRetPrev"), obterValorXml(elementretTrib, "bc_inss", 2));
			setarValorJson(eaa01json, getCampo("355-W30","vRetPrev"), obterValorXml(elementretTrib, "inss", 2));
		}
		...
		if(vol != null && vol.size() > 0) {
			for(ElementXml elementnvol : vol) {
				setarValorJson(eaa01json, getCampo("382-X27","qVol"), obterValorXml(elementnvol, "volumes", 0));
				setarValorJson(eaa01json, getCampo("386-X31","pesoL"), obterValorXml(elementnvol, "peso_liquido", 3));
				setarValorJson(eaa01json, getCampo("387-X32","pesoB"), obterValorXml(elementnvol, "peso_bruto", 3));
				
				Eaa0103 eaa0103 = obterItemDoDocumentoPelaSeqItemXml(eaa01, 1);
				if(eaa0103 != null) {
					TableMap eaa0103json = eaa0103.getEaa0103json();
					
					setarValorJson(eaa0103json, getCampo("382-X27","qVol"), obterValorXml(elementnvol, "volumes", 2));
					setarValorJson(eaa0103json, getCampo("386-X31","pesoL"), obterValorXml(elementnvol, "peso_liquido", 2));
					setarValorJson(eaa0103json, getCampo("387-X32","pesoB"), obterValorXml(elementnvol, "peso_bruto", 2));
				}
			}
		}
