...
class EventoNFe_112140 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID112140" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		if(eaa0114.eaa01141s != null && eaa0114.eaa01141s.size() > 0) {
			for(Eaa01141 eaa01141 : eaa0114.eaa01141s) {
				ElementXml gItemNaoFornecido = detEvento.addNode("gItemNaoFornecido");
                gItemNaoFornecido.setAttribute("nItem", eaa01141.eaa01141seq_Zero.toString());
                gItemNaoFornecido.addNode("vIBS", eaa01141.eaa01141json.getBigDecimal_Zero("gitemnaofornecido_vibs"));
                gItemNaoFornecido.addNode("vCBS", eaa01141.eaa01141json.getBigDecimal_Zero("gitemnaofornecido_vcbs"));

                ElementXml gControleEstoque = gItemNaoFornecido.addNode("gControleEstoque");
                gControleEstoque.addNode("qNaoFornecida", eaa01141.eaa01141json.getBigDecimal_Zero("gcontroleestoque_qnaofornecida"));
                gControleEstoque.addNode("uNaoFornecida", eaa01141.eaa01141json.getString("gcontroleestoque_unaofornecida"));
			}
		}
