...
class EventoNFe_211150 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID211150" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		if(eaa0114.eaa01141s != null && eaa0114.eaa01141s.size() > 0) {
			for(Eaa01141 eaa01141 : eaa0114.eaa01141s) {
				ElementXml gCredito = detEvento.addNode("gCredito");
                gCredito.setAttribute("nItem", eaa01141.eaa01141seq_Zero.toString());
                gCredito.addNode("vCredIBS", eaa01141.eaa01141json.getBigDecimal_Zero("gcredito_vcredibs"));
                gCredito.addNode("vCredCBS", eaa01141.eaa01141json.getBigDecimal_Zero("gcredito_vcredcbs"));
			}
		}
