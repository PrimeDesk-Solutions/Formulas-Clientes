...
class EventoNFe_211120 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID211120" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		if(eaa0114.eaa01141s != null && eaa0114.eaa01141s.size() > 0) {
			for(Eaa01141 eaa01141 : eaa0114.eaa01141s) {
                ...
                gControleEstoque.addNode("uConsumo", eaa01141.eaa01141json.getString("gconsumo_uconsumo"));

                ElementXml DFeReferenciado = gConsumo.addNode("DFeReferenciado");
                DFeReferenciado.addNode("chaveAcesso", eaa01141.eaa01141json.getBigDecimal_Zero("gconsumo_chaveacesso"));
                DFeReferenciado.addNode("nItem", eaa01141.eaa01141json.getInteger("gconsumo_nitem"));
			}
		}
