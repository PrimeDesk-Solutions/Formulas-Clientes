...
class EventoNFe_112150 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID112150" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
        ...
        detEvento.addNode("dPrevEntrega", DateUtils.formatDate(eaa01.eaa01dtEntregaPrev, "yyyy-MM-dd"), true)
