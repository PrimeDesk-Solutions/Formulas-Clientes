...
class EventoNFe_211130 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID211130" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		if(eaa0114.eaa01141s != null && eaa0114.eaa01141s.size() > 0) {
			for(Eaa01141 eaa01141 : eaa0114.eaa01141s) {
				ElementXml gImobilizacao = detEvento.addNode("gImobilizacao");
                gImobilizacao.setAttribute("nItem", eaa01141.eaa01141seq_Zero.toString());
                gImobilizacao.addNode("vIBS", eaa01141.eaa01141json.getBigDecimal_Zero("gimobilizacao_vibs"));
                gImobilizacao.addNode("vCBS", eaa01141.eaa01141json.getBigDecimal_Zero("gimobilizacao_vcbs"));

                ElementXml gControleEstoque = gImobilizacao.addNode("gControleEstoque");
                gControleEstoque.addNode("qImobilizado", eaa01141.eaa01141json.getBigDecimal_Zero("gcontroleestoque_qimobilizado"));
                gControleEstoque.addNode("uImobilizado", eaa01141.eaa01141json.getString("gcontroleestoque_uimobilizado"));
			}
		}
