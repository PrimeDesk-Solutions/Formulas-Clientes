...
class EventoNFe_211128 extends FormulaBase {
	private Eaa01 eaa01;
	...
	public void executar() {
		...
		if(eaa01.getEaa01nfeStat() != 3) throw new ValidacaoException("A NFe " + central.getAbb01num() + " não foi autorizada, portanto não pode receber eventos.");
		...
		infEvento.setAttribute("Id", "ID211128" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		detEvento.addNode("indAceitacao", 1, true);
