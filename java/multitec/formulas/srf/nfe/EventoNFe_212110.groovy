...
class EventoNFe_212110 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID212110" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		detEvento.addNode("tpAutor", 8, true);
		detEvento.addNode("verAplic", "SAM4_" + Utils.getVersao(), true)
        def indAceitacao = eaa0114.getInteger("indAceitacao")
        detEvento.addNode("indAceitacao", indAceitacao == null ? 0 : indAceitacao, true)
