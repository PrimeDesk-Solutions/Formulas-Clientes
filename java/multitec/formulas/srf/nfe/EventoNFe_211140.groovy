...
class EventoNFe_211140 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID211140" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		if(eaa0114.eaa01141s != null && eaa0114.eaa01141s.size() > 0) {
			for(Eaa01141 eaa01141 : eaa0114.eaa01141s) {
				ElementXml gConsumoComb = detEvento.addNode("gConsumoComb");
                gConsumoComb.setAttribute("nItem", eaa01141.eaa01141seq_Zero.toString());
                gConsumoComb.addNode("vIBS", eaa01141.eaa01141json.getBigDecimal_Zero("gconsumocomb_vibs"));
                gConsumoComb.addNode("vCBS", eaa01141.eaa01141json.getBigDecimal_Zero("gconsumocomb_vcbs"));

                ElementXml gControleEstoque = gConsumoComb.addNode("gControleEstoque");
                gControleEstoque.addNode("qComb", eaa01141.eaa01141json.getBigDecimal_Zero("gcontroleestoque_qcomb"));
                gControleEstoque.addNode("uComb", eaa01141.eaa01141json.getString("gcontroleestoque_ucomb"));
			}
		}
