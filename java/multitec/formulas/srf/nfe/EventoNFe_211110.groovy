...
class EventoNFe_211110 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID211110" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		if(eaa0114.eaa01141s != null && eaa0114.eaa01141s.size() > 0) {
			for(Eaa01141 eaa01141 : eaa0114.eaa01141s) {
				...
				gCredPres.setAttribute("nItem", eaa01141.eaa01141seq_Zero.toString());
