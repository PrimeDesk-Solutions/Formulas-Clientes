...
class EventoNFe_112130 extends FormulaBase {
	...
	public void executar() {
		...
		infEvento.setAttribute("Id", "ID112130" + chaveAcesso + StringUtils.ajustString(eaa0114.getEaa0114seq(), 2));
		...
		if(eaa0114.eaa01141s != null && eaa0114.eaa01141s.size() > 0) {
			for(Eaa01141 eaa01141 : eaa0114.eaa01141s) {
                ...
                gControleEstoque.addNode("uPerecimento", unConsumo);
                gControleEstoque.addNode("vIBS", eaa01141.eaa01141json.getBigDecimal_Zero("gcontroleestoque_vibs"));
                gControleEstoque.addNode("vCBS", eaa01141.eaa01141json.getBigDecimal_Zero("gcontroleestoque_vcbs"));
			}
		}
