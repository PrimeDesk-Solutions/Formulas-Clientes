...
class SFP_LayoutCaixaEconomicaFederal extends FormulaBase {
	...
	public void executar() {
		...
		if(reg == 0 && pi == 33) {
			...
			paramTrasmissao = conteudo;
		}else if(reg == 1 && pi == 10) {
			tipoServico = conteudo;
		}else if(reg == 1 && pi == 12) {
			formaLcto = conteudo;
		}else if(reg == 1 && pi == 39) {
			tipoCompromisso = conteudo;
		}else if(reg == 1 && pi == 41) {
			codCompromisso = conteudo;
		}else if(reg == 3 && pi == 15) {
			tipoMovim = conteudo;
		}else if(reg == 3 && pi == 16) {
		...
		txt.print(codConvBanco, 6, '0', true);																				//033 a 038
		txt.print(paramTrasmissao, 2, '0', true);																			//039 a 040
		txt.print("P");																									//041 a 041
		txt.print(StringUtils.space(1));																					//042 a 042
		txt.print(StringUtils.space(3));																					//043 a 045
		txt.print(0, 4, '0', true);																							//046 a 049
		txt.print(StringUtils.space(3));																					//050 a 052
		...
		txt.print("CAIXA", 30);																								//103 a 132
		txt.print(StringUtils.space(10));																					//133 a 142
		txt.print(1);																									//143 a 143
		txt.print(MDate.dateTime().format(DateTimeFormatter.ofPattern("ddMMyyyy")), 8, '0', true);																//144 a 151
		txt.print(MDate.dateTime().format(DateTimeFormatter.ofPattern("hhmmss")), 6, '0', true);																//152 a 157
		txt.print(numSeqArqCaixa != null ? numSeqArqCaixa.intValue()+1 : 1, 6, '0', true);									//158 a 163
		txt.print("080", 3);																								//164 a 166
		txt.print("01600", 5);																								//167 a 171
		txt.print(StringUtils.space(20));																					//172 a 191
		txt.print(StringUtils.space(20));																					//192 a 211
		txt.print(StringUtils.space(11));																					//212 a 222
		txt.print(StringUtils.space(3));																					//223 a 225
		txt.print(0, 3, '0', true);																							//226 a 228
		txt.print(StringUtils.space(2));																					//229 a 230
		...
		txt.print(tipoServico, 2, '0', true);																				//010 a 011
		txt.print(formaLcto, 2, '0', true);																					//012 a 013
		txt.print("041", 3);																								//014 a 016
		txt.print(StringUtils.space(1));																					//017 a 017
		txt.print(aac10.aac10ti == 0 ? 2 : 1);																		//018 a 018
		txt.print(StringUtils.extractNumbers(aac10.aac10ni), 14, '0', true);												//019 a 032
		txt.print(codConvBanco, 6, '0', true);																				//033 a 038
		txt.print(tipoCompromisso, 2, '0', true);																			//039 a 040
		txt.print(codCompromisso, 4, '0', true);																			//041 a 044
		txt.print(paramTrasmissao, 2);																						//045 a 046
		txt.print(StringUtils.space(6));																					//047 a 052
		txt.print(StringUtils.extractNumbers(abf01.abf01agencia), 5, '0', true);									//053 a 057
		txt.print(abf01.abf01digAgencia, 1);																		//058 a 058
		txt.print(StringUtils.extractNumbers(abf01.abf01conta), 12, '0', true);										//059 a 070
		txt.print(abf01.abf01digConta, 1);																			//071 a 071
		...
		txt.print(cepEmpresaComp, 3);																						//218 a 220
		...
		for(int i = 0; i < abh80s.size(); i++) {
			...
			txt.print(numDocEmp, 6, '0', true);																				//074 a 079
			txt.print(StringUtils.space(13));																				//080 a 092
			txt.print(finalidadeTED, 1);																					//093 a 093
			...
			txt.print(0, 9, '0', true);																						//135 a 143
			txt.print(StringUtils.space(3));																				//144 a 146
			txt.print("01", 2);																								//147 a 148
			txt.print("N");																								//149 a 149
			txt.print(1);																								//150 a 150
			txt.print("05", 2);																								//151 a 152
			txt.print("00", 2);																								//153 a 154
			txt.print(0, 8, '0', true);																						//155 a 162
			txt.print(0, 15, '0', true);																					//163 a 177
			txt.print(StringUtils.space(40));																				//178 a 217
			txt.print(finalidadeDoc, 2, '0', true);																			//218 a 219
			...
			txt.print(0, 15, '0', true);																					//136 a 150
			...
			txt.print(StringUtils.space(15));																				//226 a 240
			txt.newLine();
			sequencial++;
		}
