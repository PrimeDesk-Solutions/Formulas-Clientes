...
/**
 * 2502 - Imposto de Renda - Autônomo e Pro-labore
 **/
public class Eve2502 extends FormulaBase{
	...
	public void executar() {
		...
		if (fba01011.fba01011base != null && fba01011.fba01011base > 0) {
			...
			ir = sfpUtils.aplicarTabelaDeIR("001", sfpUtils.buscarValor("9030"), qtdDepIR);
	
			//Diminui o imposto já recolhido no mês
			def irAnterior = sfpUtils.buscarValorNoUltimoCalculo("*", true, fba0101.getFba0101dtPgto(), true, "2502", [0, 1] as Integer[]);
