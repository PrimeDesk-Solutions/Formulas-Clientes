...
/**
 * 6102 - Maior Remuneração Rescisão - Média de horas extras 50%
 **/
public class Eve6102 extends FormulaBase {
	...
	public void executar() {
		...
		if (fba01011.fba01011base != null && fba01011.fba01011base > 0) {
			...
			if(eveOrigem != null) {
				...
				LocalDate dtRescisao = fbd10.fbd10dtRes;
				dtRescisao = dtRescisao.withDayOfMonth(1);
				dtRescisao = dtRescisao.withMonth(1);
				def dtInicial = dtRescisao;
				def dtAdmissao = abh80.abh80dtAdmis;
								
				if(dtAdmissao > dtInicial) {
					dtInicial = dtAdmissao
				}
				
				def dtFinal = fbd10.fbd10dtRes;  
