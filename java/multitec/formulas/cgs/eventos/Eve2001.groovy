 ...
 * 2001 - INSS
 **/
public class Eve2001 extends FormulaBase {
	...
	public void executar() {
		...
		if (fba01011.fba01011base != null && fba01011.fba01011base > 0) {
			...
			if(abh80.abh80contribInss == 1) { //Contribuinte do INSS
				...
				def scInssFerias = sfpUtils.buscarValorNoCalculo("*", true, fba0101.fba0101dtCalc, true, false, "9021", [3] as Integer[]); 	//SC INSS Empresa Férias
				def inssFerias = sfpUtils.buscarValorNoCalculo("*", true, fba0101.fba0101dtCalc, true, false, "3501", [3] as Integer[]); 	//INSS Sobre Férias
				
				//BC do INSS do mês
				def scInssMes = sfpUtils.buscarValorNoCalculo("*", true, fba0101.fba0101dtCalc, true, false, "9020", [0] as Integer[]);		//SC INSS Empresa
				def inssMes = sfpUtils.buscarValorNoCalculo("*", true, fba0101.fba0101dtCalc, true, false, "2001", [0] as Integer[]);		//INSS
