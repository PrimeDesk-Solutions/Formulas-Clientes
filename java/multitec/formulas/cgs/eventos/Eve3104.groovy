...
/**
 * 3104 - Diferença 1/3 sobre abono
 **/
public class Eve3104 extends FormulaBase {
	...
	public void executar() {
		...
		if (fba01011.fba01011base != null && fba01011.fba01011base > 0) {
			...
			if(salarioAntigo > 0) {
				...
				if(indice > 0) {
					def abono = sfpUtils.buscarValorNoCalculo(null, false, fba0101.fba0101dtCalc, true, false, "3004", [3] as Integer[]);
