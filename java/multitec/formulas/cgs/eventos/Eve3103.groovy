...
/**
 * 3103 - Diferença de 1/3 sobre férias
 **/
public class Eve3103 extends FormulaBase {
	...
	public void executar() {
		...
		if (fba01011.fba01011base != null && fba01011.fba01011base > 0) {
			...
			if(salarioAntigo > 0) {
				...
				if(indice > 0) {
					def ferias = sfpUtils.buscarValorNoCalculo(null, false, fba0101.fba0101dtCalc, true, false, "3003", [3] as Integer[]);
