...
public class SCF_LancamentosFinanceiros extends RelatorioBase {
	...
	public List<TableMap> obterDadosRelatorio (List<Long> idContaCorrente, LocalDate[] dataPeriodo)  {
		...
		String sql = " select Dab01.dab01id, Dab01.dab01codigo, Dab01.dab01nome, Dab10.dab10id, Dab10.dab10data, Dab10.dab10cc, Dab10.dab10mov, Dab10.dab10historico, Dab10.dab10valor" + 
		               " from Dab10 Dab10" + 
