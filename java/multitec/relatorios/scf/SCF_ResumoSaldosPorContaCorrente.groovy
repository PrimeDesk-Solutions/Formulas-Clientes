...
public class SCF_ResumoSaldosPorContaCorrente extends RelatorioBase {

	@Override
	public String getNomeTarefa() {
		return "SCF - Resumo dos Saldos por Conta Corrente";
	}

	@Override
	public Map<String, Object> criarValoresIniciais() {
		Map<String, Object> filtros = new HashMap();
		filtros.put("periodo", DateUtils.getStartAndEndMonth(MDate.date()));
		filtros.put("isContaInativa", true);
	...
	public DadosParaDownload executar() {
		...
		params.put("TITULO_RELATORIO", "Resumo dos Saldos por Conta Corrente");
		...
		return gerarPDF("SCF_ResumoSaldosPorContaCorrente", dados)
	}
...
//meta-sis-eyJkZXNjciI6IlNDRiAtIFJlc3VtbyBkb3MgU2FsZG9zIHBvciBDb250YSBDb3JyZW50ZSIsInRpcG8iOiJyZWxhdG9yaW8ifQ==