...
/**Classe para relatório SFP - Termo De Responsabilidade Salário Família
 * @author Lucas Eliel
 * @since 06/05/2019
 * @version 1.0
 */

public class SFP_TermoDeResponsabilidadeSalarioFamilia extends RelatorioBase {
	...
	public String getNomeTarefa() {
		return "SFP - Termo de Responsabilidade Salário Família";
	}
	...
	public DadosParaDownload executar() {
		...
		params.put("StreamSub1R1", carregarArquivoRelatorio("SFP_TermoDeResponsabilidadeSalarioFamilia_R1_S1"));
		
		List<TableMap> dados = getDadosAbh80sByTermoResponsabilidadeSF(idsTrabalhadores, idsDeptos, idsCargos, idsParentescos, tiposTrab, situacao, true, false);	
		
		List<TableMap> dadosSub = getDadosAbh8002sByTermoResponsabilidadeSF(idsTrabalhadores, idsDeptos, idsCargos, idsParentescos, tiposTrab, situacao, true, false);
		...
		return gerarPDF("SFP_TermoDeResponsabilidadeSalarioFamilia_R1", dsPrincipal);
	}
	...
	/**Método Diverso
	 * @return 	List - TableMap (Query de Trabalhador pelo Termo de Responsabilidade)
	 */
	...
	/**Método Diverso
	 * @return 	List - TableMap (Query de Dependentes pelo Termo de Responsabilidade)
	 */
...
//meta-sis-eyJkZXNjciI6IlNGUCAtIFRlcm1vIGRlIFJlc3BvbnNhYmlsaWRhZGUgU2Fsw6FyaW8gRmFtw61saWEiLCJ0aXBvIjoicmVsYXRvcmlvIn0=