...
public class SCV_DocumentosCancelados extends RelatorioBase {
	@Override
	public String getNomeTarefa() {
		return "SCV - Documentos Cancelados";
	}
...
//meta-sis-eyJkZXNjciI6IlNDViAtIERvY3VtZW50b3MgQ2FuY2VsYWRvcyIsInRpcG8iOiJyZWxhdG9yaW8ifQ==