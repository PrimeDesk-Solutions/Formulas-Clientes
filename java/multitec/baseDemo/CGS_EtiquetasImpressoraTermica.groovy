...
class CGS_EtiquetasImpressoraTermica extends RelatorioBase {
	@Override
	public String getNomeTarefa() {
		return "CGS - Etiquetas para impressoras termicas";
	}
	...
	public DadosParaDownload executar() {
		...
		return converterPDFParaImpressoraTermica(gerarPDF("CGS_EtiquetasImpressoraTermica", dsPrincipal), 203, 48);
	}
...
//meta-sis-eyJkZXNjciI6IkNHUyAtIEV0aXF1ZXRhcyBwYXJhIGltcHJlc3NvcmFzIHRlcm1pY2FzIiwidGlwbyI6InJlbGF0b3JpbyJ9