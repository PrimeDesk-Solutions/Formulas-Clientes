...
public class SCA_Acessos extends FormulaBase {
	@Override
	...
	public void executar() {
		...
		if(tipoDia == "02" || tipoDia == "03" || tipoDia == "07") { 	//Dias normais e sábado
			fca10.fca10eve04 = buscarEventoPorCodigo("1021");
		}else { 														// Domingo e Feriados
			fca10.fca10eve04 = buscarEventoPorCodigo("1024");
		}
		
		//Horas extras noturna
		fca10.fca10folha05 = fca10.getFca10heNot_Zero();
		if(tipoDia == "02" || tipoDia == "03" || tipoDia == "07") { 	//Dias normais e sábado
			fca10.fca10eve05 = buscarEventoPorCodigo("1021");
		}else { 														// Domingo e Feriados
			fca10.fca10eve05 = buscarEventoPorCodigo("1024");
		}
		
		//Considerar até 10 minutos de falta como atraso
		if(fca10.fca10horFalt_Zero <= 10) {
		    fca10.fca10folha06 = fca10.fca10horFalt_Zero;
		    fca10.fca10eve06 = buscarEventoPorCodigo("1301");
		}
		
		//Considerar acima de 10 minutos de falta como atraso
		if(fca10.fca10horFalt_Zero > 10) {
			fca10.fca10folha10 = fca10.fca10horFalt_Zero;
			fca10.fca10eve10 = buscarEventoPorCodigo("2004");
		}
	}
