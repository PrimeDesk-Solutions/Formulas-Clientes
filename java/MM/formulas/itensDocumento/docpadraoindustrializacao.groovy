...
public class docpadraoindustrializacao extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if (jsonEaa0103.getBigDecimal_Zero("peso_bruto") == 0) {
                jsonEaa0103.put("peso_bruto", (eaa0103.eaa0103qtUso * abm01.abm01pesoBruto_Zero).round(2))
            }

            // Peso Liquido
            if (jsonEaa0103.getBigDecimal_Zero("peso_liquido") == 0) {
                jsonEaa0103.put("peso_liquido", (eaa0103.eaa0103qtUso * abm01.abm01pesoLiq_Zero).round(2))
            }
    ...
    private trocaCFOPDentroOuForaEstado(Boolean dentroEstado) {
        if (eaa0103.eaa0103cfop != null) {
            ...
            if (eaa0103.eaa0103retInd == 1) cfop = "5902";
    ...
    private definirCSTICMS() {
        ...
        if(jsonEaa0103.getBigDecimal_Zero("icms") > 0) cst = "000"
