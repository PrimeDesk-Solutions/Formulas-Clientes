...
public class DocPadraoEntradaSomaIPInaBCICMS extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if (abm13.abm13fcUV_Zero == 0 || abm13.abm13fcVU_Zero == 0 ) throw new ValidacaoException("Fator de conversão de Uso para venda ou Fator de Conversão de Venda para uso no cadastro do item " + abm01.abm01codigo + " é inválido.")
            eaa0103.eaa0103qtUso = ((eaa0103.eaa0103qtComl * abm13.abm13fcUV) * abm13.abm13fcVU_Zero).round(3);

            // Converte Qt.Venda para Volume
            ...
            eaa0103.eaa0103total = ((eaa0103.eaa0103qtComl * eaa0103.eaa0103unit) -
                                   jsonEaa0103.getBigDecimal_Zero("desconto")).round(3);
