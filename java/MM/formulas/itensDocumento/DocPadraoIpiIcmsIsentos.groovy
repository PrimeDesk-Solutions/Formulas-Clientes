...
public class DocPadraoIpiIcmsIsentos extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Quantidade SCE
            if(abm13.abm13fcUV_Zero == 0) throw new ValidacaoException("Fator de conversão de uso para venda no cadastro do item " + abm01.abm01codigo + " não é válido.")
...
//meta-sis-eyJ0aXBvIjoiZm9ybXVsYSIsImZvcm11bGF0aXBvIjoiNjIifQ==aliq_fixa_icms
