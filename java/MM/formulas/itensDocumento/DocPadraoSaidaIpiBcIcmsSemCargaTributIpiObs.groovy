...
public class DocPadraoSaidaIpiBcIcmsSemCargaTributIpiObs extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Converte Qt.Documento para Qt.SCE
            eaa0103.eaa0103qtUso = ((eaa0103.eaa0103qtComl * abm13.abm13fcUV) * abm13.abm13fcVU).round(3);

            // Converte Qt.Documento para Qt.Convertida
            jsonEaa0103.put("qt.Convertida", (eaa0103.eaa0103qtComl * abm13.abm13fcVW).round(3));
