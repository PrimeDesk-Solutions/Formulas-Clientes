...
public class SceEntradaProducao extends FormulaBase{
    SCEUtils sceUtils;
    private Bcc01 bcc01;
    ...
    public void executar() {
        ...
        // Custo Total
        bcc01.bcc01custo = (jsonBcc01.getBigDecimal_Zero("qt_sce") * jsonBcc01.getBigDecimal_Zero("unitario_estoque")).round(2);
