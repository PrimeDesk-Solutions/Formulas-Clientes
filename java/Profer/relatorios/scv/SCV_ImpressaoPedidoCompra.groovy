...
public class SCV_ImpressaoPedidoCompra extends RelatorioBase {
    ...
    private List<TableMap> buscarDadosRelatorio(List<Long> tipos, Integer numeroInicial, Integer numeroFinal, List<Long> entidades,LocalDate[] emissao){
        ...
        String sql =    "select distinct abb01num as numDoc, abe01nome as nomeEntidade, abe01ni as CNPJ, abe0101endereco as enderecoEntidade,  " +
                "abe0101numero as numeroEntidade, abe0101bairro as bairroEntidade, eaa0102pcNome as contato, eaa01totItens AS totItem,  " +
                ...
                "eaa01totDoc as totDoc, abe30nome as condPgto, eaa01id, abe01ie AS ieEntidade, abe0101email AS emailEntidade, abe01ni AS cnpj, abe01codigo AS codEntidade " +
                "from eaa01 " +
    ...
    private List<TableMap> buscarDadosItens(Long eaa01id){
        ...
        String sql = "select eaa0103seq, abm01descr as descrItem, eaa0103qtUso as qtd, abm01pesoBruto as pesoBrutoItem,  " +
                "cast(eaa0103json ->> 'peso_bruto' as numeric(18,6)) as pesoBrutoDoc, eaa0103pcNum, aam06codigo as umu, eaa0103unit as unit, eaa0103total as totalItem, " +
                "cast(eaa0103json ->> 'aliq_icms' as numeric(18,6)) as icms, " +
                "cast(eaa0103json ->> 'aliq_ipi' as numeric(18,6)) as ipi, eaa0103item " +
                "from eaa0103 " +
