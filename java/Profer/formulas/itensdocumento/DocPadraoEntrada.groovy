...
public class DocPadraoEntrada extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
		  ...
		  jsonEaa0103.put("unitario_estoque", eaa0103.eaa0103unit);
            ...
            // Quantidade SCE
            if(abm1301.abm1301fcCU == null || abm1301.abm1301fcCU == 0) throw new ValidacaoException("Fator de conversão de compra para venda no cadastro do item " + abm01.abm01codigo + " é inválido.");
	       ...
	       jsonEaa0103.put("total_documento", eaa0103.eaa0103totDoc)
            ...
            if(jsonEaa0103.getBigDecimal_Zero("ipi") == 0){
                jsonEaa0103.put("ipi_outras", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") )
    ...
    private void calcularICMS(Integer contribICMS){
        ...
        if(jsonEaa0103.getBigDecimal_Zero("aliq_icms") != -1 && jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_icms") > 0 ){
            ...
            if(contribICMS) jsonEaa0103.put("bc_icms", (jsonEaa0103.getBigDecimal_Zero("bc_icms")).round(2));
