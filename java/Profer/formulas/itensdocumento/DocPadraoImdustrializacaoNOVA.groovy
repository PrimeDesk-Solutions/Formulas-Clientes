...
public class DocPadraoIndustrializacaoNOVA extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Quantidade SCE
            if(abm13.abm13fcUV == null || abm13.abm13fcUV == 0) throw new ValidacaoException("Valor inválido para o campo fator de conversão para venda no cadatro do item " + abm01.abm01codigo);
    ...
    private calculaCofins(){
        if(eaa0103.eaa0103cstCofins != null){
            ...
            // CST 01 - Operação Tributável com Alíquota Básica
            if(eaa0103.eaa0103cstcofins.aaj12codigo == "01" ){
                cstValido = true;
            ...
            // CST 02 - Operação Tributável com Alíquota Diferenciada
            if(eaa0103.eaa0103cstcofins.aaj12codigo == "02"){
                cstValido = true;
            ...
            if(eaa0103.eaa0103cstcofins.aaj12codigo == "03"){
            ...
            // CST 06 - Operação Tributável a Alíquota Zero
            if(eaa0103.eaa0103cstcofins.aaj12codigo == "06" ){
                cstValido = true;
            ...
            // CST 49 - Outras Operações de Saída
            if(eaa0103.eaa0103cstcofins.aaj12codigo == "04" || eaa0103.eaa0103cstcofins.aaj12codigo == "05" || eaa0103.eaa0103cstcofins.aaj12codigo == "07" || eaa0103.eaa0103cstcofins.aaj12codigo == "08" ||
               eaa0103.eaa0103cstcofins.aaj12codigo == "09" || eaa0103.eaa0103cstcofins.aaj12codigo == "49" ){
