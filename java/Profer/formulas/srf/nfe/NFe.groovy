...
//							}
					...
					if(cstIcms != null) {
						...
						if((cst.equals("41") || cst.equals("60")) && getCampo("245.20-N26","vBCSTRet") != null && !jsonEaa0103.getBigDecimal(getCampo("245.20-N26","vBCSTRet")).equals(0)) {
						...
						}else if(cst.equals("00") || cst.equals("000") ) {
							...
							ICMS51.addNode("modBC", configItem != null && configItem.abm0101fiscal != null ? configItem.abm0101fiscal.abm12modBcIcms : null, false);
			...
			if(cstPis != null) {
				...
				if((getCampo("245a.03-NA03","vBCUFDest") != null && !jsonEaa0103.getBigDecimal(getCampo("245a.03-NA03","vBCUFDest")).equals(0)) ||
					...
					if(idDest == 2 && eaa0102.eaa0102consFinal == 0 && indIEDest == 9 && !temISS){
