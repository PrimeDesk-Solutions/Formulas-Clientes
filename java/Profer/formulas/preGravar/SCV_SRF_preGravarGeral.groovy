package Profer.formulas.preGravar
...
public class SCV_SRF_preGravarGeral extends FormulaBase{
    ...
    private definirDataPrimeiraUltimaCompra(Eaa01 eaa01){
	   ...
	   if(jsonAbe01.size() == 0){
           getSession().connection.prepareStatement("UPDATE abe01 SET abe01json = '{}' WHERE abe01id = " + abe01.abe01id).execute();
        }
        
        // Define a data da primeira venda do cliente
        if(jsonAbe01.get("primeira_venda") == null){
					
            String data = '"'+txtData.replace("-","") + '"'

            String sql = "UPDATE abe01 SET abe01json = jsonb_set(abe01json, '{primeira_venda}', '"+data+"', true) WHERE abe01id = " + abe01.abe01id;
        ...
        if(abb01.abb01data == dataAtual){
            ...
            String sql = "UPDATE abe01 SET abe01json = jsonb_set(abe01json, '{ultima_venda}', '"+data+"', true) WHERE abe01id = " + abe01.abe01id;
    ...
    private definirMaiorFaturaCliente(){
        ...
        if(eaa01.eaa01totDoc > jsonAbe01.getBigDecimal_Zero("valor_fatura_venda")){
            ...
            String sql1 = "UPDATE abe01 SET abe01json = jsonb_set(abe01json, '{numero_fatura_venda}', '"+numDoc.toString()+"', true) WHERE abe01id = " + abe01.abe01id;

            // Data maior faturamento
            String sql2 = "UPDATE abe01 SET abe01json = jsonb_set(abe01json, '{data_fatura_venda}', '"+txtData+"', true) WHERE abe01id = " + abe01.abe01id;

            String sql3 = "UPDATE abe01 SET abe01json = jsonb_set(abe01json, '{valor_fatura_venda}', '"+valorDoc.toString()+"', true) WHERE abe01id = " + abe01.abe01id;
