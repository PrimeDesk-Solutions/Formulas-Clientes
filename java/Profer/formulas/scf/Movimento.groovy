...
//		}
		...
		if(mapJson.getBigDecimal_Zero("juros") > 0) juros = mapJson.getBigDecimal_Zero("juros");
		if(mapJson.getBigDecimal_Zero("multa") > 0) multa = mapJson.getBigDecimal_Zero("multa");
