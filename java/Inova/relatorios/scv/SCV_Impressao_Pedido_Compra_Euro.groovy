...
public class SCV_Impressao_Pedido_Compra_Euro extends RelatorioBase {
    @Override
    public String getNomeTarefa() {
        return "SCV - Impressão Pedido Compra Euro";
    }
    @Override
    ...
    public DadosParaDownload executar() {
        ...
        adicionarParametro("StreamSub1", carregarArquivoRelatorio("SCV_Pedido_Compra_Euro_S1"));

        return gerarPDF("SCV_Pedido_Compra_Euro", dsPrincipal);
    }
