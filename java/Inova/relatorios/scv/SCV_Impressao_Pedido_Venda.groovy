...
public class SCV_Impressao_Pedido_Venda extends RelatorioBase {
    ...
    public String getNomeTarefa() {
        return "SCV - Impressão Pedido Venda";
    }
    @Override
    ...
    public DadosParaDownload executar() {
        ...
        adicionarParametro("StreamSub1", carregarArquivoRelatorio("SCV_Pedido_Venda_S1"));

        return gerarPDF("SCV_Pedido_Venda", dsPrincipal);
    }
...
//meta-sis-eyJkZXNjciI6IlNDViAtIEltcHJlc3PDo28gUGVkaWRvIFZlbmRhIiwidGlwbyI6InJlbGF0b3JpbyJ9