...
public class SCV_Impressao_Pedido_Compra_Importacao_Nacional extends RelatorioBase {
    @Override
    public String getNomeTarefa() {
        return "SCV - Impressão Pedido Compra Importação Nacional";
    }
    @Override
    ...
    public DadosParaDownload executar() {
        ...
        adicionarParametro("StreamSub1", carregarArquivoRelatorio("SCV_Pedido_Compra_Importacao_Nacional_S1"));

        return gerarPDF("SCV_Pedido_Compra_Importacao_Nacional", dsPrincipal);
    }
