...
public class SRF_RevendaMaterialNacional extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            jsonEaa0103.put("bc_comissao", (eaa0103.eaa0103total - jsonEaa0103.getBigDecimal_Zero("desconto")).round(2));
