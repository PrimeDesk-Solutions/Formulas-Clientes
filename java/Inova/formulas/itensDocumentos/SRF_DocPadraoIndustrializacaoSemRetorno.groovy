...
public class SRF_DocPadraoIndustrializacaoSemRetorno extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Qtde SCE
            if (abm13.abm13fcUV == 0) throw new ValidacaoException("Fator de conversão de uso para venda no cadastro do item" + abm01.abm01codigo + " - " + abm01.abm01descr + " não é válido. ")
            ...
            if(eaa0103.eaa0103retInd == 1) jsonEaa0103.put("desconto", BigDecimal.ZERO);
            ...
            if(aaj15_cfop.aaj15codigo == '5124' || aaj15_cfop.aaj15codigo == '6124'  || aaj15_cfop.aaj15codigo == '5125' || aaj15_cfop.aaj15codigo == '6125'){
                eaa0103.eaa0103totFinanc = eaa0103.eaa0103totDoc;
                jsonEaa0103.put("icms_outras", eaa0103.eaa0103totDoc);
                jsonEaa0103.put("bc_ipi", eaa0103.eaa0103totDoc);
            }else{
    ...
    private void calcularIPI() {
        ...
        if (jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != -1) {
            ...
            jsonEaa0103.put("bc_ipi", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto"));
