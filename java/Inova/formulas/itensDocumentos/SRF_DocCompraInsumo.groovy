...
public class SRF_DocCompraInsumo extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if(jsonEaa0103.getBigDecimal_Zero("icms_st") > 0 ){
                eaa0103.eaa0103totDoc = eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("icms_st");
    ...
    private calculaPIS() {
        if (jsonAbm0101.getBigDecimal_Zero("aliq_pis") > 0) {
            ...
            // BC PIS
            jsonEaa0103.put("bc_pis", eaa0103.eaa0103totDoc + jsonEaa0103.getBigDecimal_Zero("frete_dest") + jsonEaa0103.getBigDecimal_Zero("seguro") + jsonEaa0103.getBigDecimal_Zero("outras_despesas") - jsonEaa0103.getBigDecimal_Zero("desconto"));
