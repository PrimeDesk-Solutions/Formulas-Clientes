package Inova.formulas.itensdocumento;
...
public class SRF_ImportacaoXmlUsoConsumo extends FormulaBase {
    ...
    private void calcularItem() {
        if(eaa0103.eaa0103qtComl > 0){
            ...
            // Total Documento
            eaa0103.eaa0103totDoc = eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("ipi_sped") + jsonEaa0103.getBigDecimal_Zero("icms_st_sped") + jsonEaa0103.getBigDecimal_Zero("frete_dest") - jsonEaa0103.getBigDecimal_Zero("desconto");
    ...
    private void definirCFOP(Boolean dentroEstado) {
        ...
        if(eaa0103.eaa0103csosn != null && eaa0103.eaa0103csosn.aaj14codigo == "0500") cfop = "1407";

        if(eaa0103.eaa0103cstIcms != null){
            if(eaa0103.eaa0103cstIcms == "060" || eaa0103.eaa0103cstIcms == "160" || eaa0103.eaa0103cstIcms == "260"){
                cfop = "1407";
            }
        }
