...
public class SRF_DocCompraInsumoImportacaoAliqFixa60DHL extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            jsonEaa0103.put("outras_despesas", jsonEaa0103.getBigDecimal_Zero("desp_acess_rat"));
...
// total de IBS
    ...
    private void calcularImpostoImportacao(){
        ...
        jsonEaa0103.put("aliq_importacao", new BigDecimal(60));
    ...
    private void calcularICMS(Integer contribICMS) {
        ...
        if (jsonEaa0103.getBigDecimal_Zero("aliq_icms") != -1 && jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_icms") > 0) {
            ...
            def bcICMS = ((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("ipi") + jsonEaa0103.getBigDecimal_Zero("imposto_importacao") + jsonEaa0103.getBigDecimal_Zero("frete_dest")) / 0.83);
