...
public class SRF_Docexportacao extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            eaa0103.eaa0103unit = jsonAbm0101.getBigDecimal_Zero("ultimo_preco").round(2)
            ...
            if(jsonAbm0101.getBigDecimal_Zero("medida_tributavel") > 0){
                jsonEaa0103.put("qtd_tributavel", (eaa0103.eaa0103qtComl_Zero * jsonAbm0101.getBigDecimal_Zero("medida_tributavel")).round(2));
            }else{
            ...
            // Unitário Tributável
            if(jsonAbm0101.getBigDecimal_Zero("medida_tributavel") > 0){
                jsonEaa0103.put("unit_tributavel", eaa0103.eaa0103unit / jsonAbm0101.getBigDecimal_Zero("medida_tributavel"));
            }else{
    ...
    private void calcularIPI() {
        ...
        if (jsonEaa0103.getBigDecimal_Zero("aliq_ipi") != -1) {
            ...
            jsonEaa0103.put("bc_ipi", eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("frete_dest") - jsonEaa0103.getBigDecimal_Zero("desconto"));
