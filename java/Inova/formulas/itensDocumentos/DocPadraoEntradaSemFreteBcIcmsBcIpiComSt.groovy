...
public class DocPadraoEntradaSemFreteBcIcmsBcIpiComSt extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            if (jsonEaa0103.getBigDecimal_Zero("aliq_ipi") == 0) {
                jsonEaa0103.put("ipi_outras", eaa0103.eaa0103totDoc - jsonEaa0103.getBigDecimal_Zero("aliq_ipi"));
