...
public class SRF_DocComplementoImportacao extends FormulaBase {
    ...
    public void executar() {
        ...
        abe30 = eaa01.eaa01cp != null ? getSession().get(Abe30.class, eaa01.eaa01cp.abe30id) : null;
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            eaa0103.eaa0103qtComl = BigDecimal.ONE;
            eaa0103.eaa0103qtUso = BigDecimal.ZERO;
            eaa0103.eaa0103unit = BigDecimal.ZERO;

            // Total do item
            eaa0103.eaa0103total = jsonEaa0103.getBigDecimal_Zero("outras_despesas");

            // Total do Documento sem ST
            eaa0103.eaa0103totDoc = jsonEaa0103.getBigDecimal_Zero("outras_despesas");

            jsonEaa0103.put("ipi_outras", jsonEaa0103.getBigDecimal_Zero("outras_despesas"));

            jsonEaa0103.put("icms_outras", jsonEaa0103.getBigDecimal_Zero("outras_despesas"));
