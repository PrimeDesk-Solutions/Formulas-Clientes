...
public class SRF_DocCompraInsumoImportacaoAliqFixa60DespAcess extends FormulaBase {
...
// total de IBS
    ...
    private void calcularICMS(Integer contribICMS) {
        ...
        if (jsonEaa0103.getBigDecimal_Zero("aliq_icms") != -1 && jsonAbm1001_UF_Item.getBigDecimal_Zero("aliq_icms") > 0) {
            ...
            def bcICMS = ((eaa0103.eaa0103total + jsonEaa0103.getBigDecimal_Zero("ipi") + jsonEaa0103.getBigDecimal_Zero("imposto_importacao") + jsonEaa0103.getBigDecimal_Zero("frete_dest")) / 0.83) * 0.94;
