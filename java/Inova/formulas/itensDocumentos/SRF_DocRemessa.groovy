...
public class SRF_DocRemessa extends FormulaBase {
    ...
    private void calcularItem() {
        ...
        if (eaa0103.eaa0103qtComl > 0) {
            ...
            // Unitário Industrialização
            if(abm1301 != null){
                jsonEaa0103.put("unit_industrializacao", eaa0103.eaa0103unit / (eaa0103.eaa0103qtUso / eaa0103.eaa0103qtComl_Zero));
                jsonEaa0103.put("unit_industrializacao", jsonEaa0103.getBigDecimal_Zero("unit_industrializacao").round(2));
            }else{
                jsonEaa0103.put("unit_industrializacao", BigDecimal.ZERO);
            }
