...
public class SCE_CompraInsumoImportacao extends FormulaBase {
    SCEUtils sceUtils;
    private Bcc01 bcc01;
    ...
    public void executar() {
        ...
        bcc01.bcc01custo = jsonBcc01.getBigDecimal_Zero("total_item_estoque") -
                            jsonBcc01.getBigDecimal_Zero("icms") +
                            jsonBcc01.getBigDecimal_Zero("imposto_importacao") +
        ...
        jsonAbm0101.put("ultima_importacao", bcc01.bcc01central.abb01num);
        ...
        if(jsonBcc01.getBigDecimal_Zero("unitario_estoque") > 0 )
            jsonBcc01.put("preco_diverso_ultimo", jsonBcc01.getBigDecimal_Zero("unitario_estoque"));


        // Custo Simples
        if(jsonBcc01.getBigDecimal_Zero("custo_unitario") > 0){
            jsonBcc01.put("preco_livre", jsonBcc01.getBigDecimal_Zero("custo_unitario") + (jsonBcc01.getBigDecimal_Zero("ipi") / bcc01.bcc01qt) + (jsonBcc01.getBigDecimal_Zero("icms") / bcc01.bcc01qt))
        }else{
