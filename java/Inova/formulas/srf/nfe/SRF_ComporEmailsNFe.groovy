...
class SRF_ComporEmailsNFe extends FormulaBase {
    ...
    private String comporCorpoMsg(Aaa16 aaa16, Eaa01 eaa01, Abe01 abe01, Abb01 abb01, Long eaa0114id) {
        ...
        if(aaa16.getAaa16tipo().equals("2")) {
            ...
            strCorpo.append("<p>ATENÇÃO,</a>");
            strCorpo.append("<p>Atentar-se aos boletos enviados para cobrança. SEMPRE verifique o remetente, a Silcon só</a>");
            strCorpo.append("<p>envia envia e-mails através do silconitatiba.com, caso seja um remetente diferente, NÃO</a>");
            strCorpo.append("<p>realizar o pagamento do mesmo e entrar em contato com setor de cobrança.</a>");
