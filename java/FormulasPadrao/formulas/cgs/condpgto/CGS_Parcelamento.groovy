package FormulasPadrao.formulas.cgs.condpgto
...
public class CGS_Parcelamento extends FormulaBase {
    ...
    public void executar() {
        ...
        if (abe3001s != null && abe3001s.size() > 0) {
            ...
            for (Abe3001 abe3001 : abe3001s) {
                ...
                jsonEaa0113.put("desconto", jsonAbe30.getBigDecimal_Zero("desconto_cond_taxa") * -1);
